...
#
# Env:
#   NIGHT_SHIFT_WATCHDOG_TO   recipient (default: commander@gositeme.com)
#   NIGHT_SHIFT_WATCHDOG_LOG  append log (default: $LAW/night-shift-watchdog.log)
#
# Cron example (gositeme user, every 5 minutes):
...
TO="${NIGHT_SHIFT_WATCHDOG_TO:-commander@gositeme.com}"
