...
═══════════════════════════════════════════════════════════════════════════════
  ...
  Based on Debian Trixie (13) with the Linux 6.12 kernel, Alfred Linux ships
...
═══════════════════════════════════════════════════════════════════════════════
  ...
  • Kingdom welcome dialog on first boot (zenity)
  • System MOTD with Psalm 23:1 and build summary
