...
<!-- SECTION 6: AGPL -->
<div class="section">
    <h2><span class="num">06</span> KCL-1.0 &mdash; Freedom That Cannot Be Revoked</h2>
    ...
    <p>Alfred Linux is licensed under <strong>KCL-1.0</strong> &mdash; the strongest copyleft license in existence:</p>
    <div class="evidence">
        <div class="label">What KCL-1.0 guarantees</div>
        <ul>
...
<div class="section">
    ...
    <p>157 build hooks. Kernel 7.0. Zero telemetry. Voice-first AI. Post-quantum encryption. Omahon Seal. KCL-1.0. Built by one man and his AI, from Quebec, for the entire world.</p>
