...
<div class="inner">
	...
	<div id="portfolio_filter_wrapper" class="masonry gallery five_cols portfolio-content section content clearfix wide" data-columns="5" data-gutter="0" data-filter="<?php echo esc_attr($filter); ?>" data-next-action="photography_portfolio_grid" data-type="grid" data-layout="wide" data-page-id="<?php echo esc_attr($current_page_id); ?>">
	...
	?>
	<div class="element grid classic5_cols masonry <?php echo esc_attr(photography_get_hover_effect('portfolio')); ?> <?php echo esc_attr($portfolio_item_set); ?>" data-type="<?php echo esc_attr($portfolio_item_set); ?>">
	
		<div class="one_fifth gallery5 static filterable gallery_type animated<?php echo esc_attr($key+1); ?> portfolio_type <?php echo esc_attr($tg_portfolio_grid_info_style); ?>" data-id="post-<?php echo esc_attr($key+1); ?>">
		<?php 
