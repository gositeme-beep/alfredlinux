...
wp_enqueue_script("photography-script-gallery-masonry", get_template_directory_uri()."/js/custom/gallery-masonry.js", false, THEMEVERSION, true);
?>
...
<div class="inner">
	...
	?>
	<div class="element grid classic3_cols masonry <?php echo esc_attr(photography_get_hover_effect()); ?>">
