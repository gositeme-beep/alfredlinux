...
<div class="inner">
	...
	<div id="portfolio_filter_wrapper" class="masonry gallery four_cols portfolio-content section content clearfix wide" data-columns="4" data-gutter="0" data-filter="<?php echo esc_attr($filter); ?>" data-next-action="photography_portfolio_grid" data-type="grid" data-layout="wide" data-page-id="<?php echo esc_attr($current_page_id); ?>">
	...
	?>
	<div class="element grid classic4_cols masonry <?php echo esc_attr(photography_get_hover_effect('portfolio')); ?> <?php echo esc_attr($portfolio_item_set); ?>" data-type="<?php echo esc_attr($portfolio_item_set); ?>">
	
		<div class="one_fourth gallery4 static filterable gallery_type animated<?php echo esc_attr($key+1); ?> portfolio_type <?php echo esc_attr($tg_portfolio_grid_info_style); ?>" data-id="post-<?php echo esc_attr($key+1); ?>">
		<?php 
