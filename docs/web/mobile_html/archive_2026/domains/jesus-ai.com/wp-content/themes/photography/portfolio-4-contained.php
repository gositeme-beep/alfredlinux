...
<div class="inner">
	...
	<div id="portfolio_filter_wrapper" class="masonry gallery four_cols portfolio-content section content clearfix" data-columns="4" data-gutter="30" data-filter="<?php echo esc_attr($filter); ?>" data-next-action="photography_portfolio_grid" data-type="grid" data-layout="contain" data-page-id="<?php echo esc_attr($current_page_id); ?>">
