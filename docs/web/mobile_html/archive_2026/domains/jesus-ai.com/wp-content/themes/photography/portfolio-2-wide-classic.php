...
<div class="inner">
	...
	<div id="portfolio_filter_wrapper" class="masonry gallery two_cols portfolio-content section content clearfix wide" data-columns="2" data-gutter="0" data-filter="<?php echo esc_attr($filter); ?>" data-next-action="photography_portfolio_classic" data-type="grid" data-layout="wide" data-page-id="<?php echo esc_attr($current_page_id); ?>">
