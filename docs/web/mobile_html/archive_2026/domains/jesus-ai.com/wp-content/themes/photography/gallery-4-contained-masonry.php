...
<div class="inner">
	...
	<div id="portfolio_filter_wrapper" class="masonry gallery four_cols portfolio-content section content clearfix" data-columns="4" data-gutter="30" data-filter="<?php echo esc_attr($filter); ?>" data-next-action="photography_portfolio_grid" data-type="masonry" data-layout="contain" data-page-id="<?php echo esc_attr($current_page_id); ?>">
	...
	<?php
	    ...
	    foreach($all_photo_arr as $key => $photo_id)
	    {
	        ...
	        if(!empty($photo_id))
	        {
	        	...
	        	$mobile_image_url = wp_get_attachment_image_src($photo_id, 'large', true);
	...
	?>
	<div class="element masonry classic4_cols <?php echo esc_attr(photography_get_hover_effect()); ?>">
