...
class WF301_setup extends WF301
{
    ...
    static function create_custom_tables()
    {
        ...
        $wf301_linkhero = "CREATE TABLE `" . $wpdb->wf301_linkhero . "` (
            ...
            `href_text` varchar(500) DEFAULT NULL,
            `redirects` text,
            ...
            `adult` text,
            PRIMARY KEY (`id`),
            UNIQUE KEY `job_id_parent_href` (`job_id`,`parent`,`href`)
            ) AUTO_INCREMENT=0 DEFAULT CHARSET=utf8";
        dbDelta($wf301_linkhero);
