...
$page_canonical = 'https://gositeme.com/mine';
...
<section class="mine-section">
    ...
    <p class="section-sub">GSM isn't just points — it's a real token on the Solana blockchain with real utility.</p>
    ...
    <div class="how-grid">
        ...
        <div class="how-card">
            ...
            <h3>Trade on DEX</h3>
            <p>Swap GSM for SOL, USDC, or any Solana token on Jupiter DEX. Real liquidity, real value.</p>
        </div>
        <div class="how-card">
...
<section class="mine-section">
    ...
    <div class="faq-list">
        ...
        <div class="faq-item">
            ...
            <div class="faq-a">Yes. GSM is an SPL (Solana Program Library) token on the Solana mainnet blockchain. It has a fixed supply of 1 billion tokens, can be traded on Jupiter DEX, transferred between wallets, and verified on-chain. It's as real as any Solana token.</div>
        </div>
    </div>
</section>
