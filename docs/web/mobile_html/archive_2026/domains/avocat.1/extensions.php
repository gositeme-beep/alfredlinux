...
$page_description = 'Access Alfred AI from Chrome, VS Code, your terminal, or any platform. 1,220+ AI tools everywhere you work.';
$page_canonical   = 'https://gositeme.com/extensions.php';
$page_og_title    = 'Alfred Everywhere — Chrome, VS Code, CLI & More';
$page_og_description = 'Access Alfred AI from Chrome, VS Code, your terminal, or any platform. 1,220+ AI tools everywhere you work.';
$page_twitter_description = 'Alfred Everywhere: Chrome extension, VS Code, CLI, Slack, Discord. 1,220+ AI tools wherever you work.';
...
<section class="ext-hero">
    <div class="ext-container">
        ...
        <p class="ext-hero-sub" data-aos="fade-up" data-aos-delay="100">
            Use Alfred AI from Chrome, VS Code, your terminal, or any platform. 1,220+ tools wherever you work.
        </p>
        ...
        <div class="ext-cards-grid">
            ...
            <div class="ext-card" data-aos="fade-up" data-aos-delay="100">
                ...
                <p class="ext-card-desc">
                    ...
                    documentation generation, and inline chat — all trained on 1,220+ tools.
                </p>
                <ul class="ext-card-features">
            ...
            <div class="ext-card" data-aos="fade-up" data-aos-delay="400">
                ...
                <p class="ext-card-desc">
                    ...
                    and empower your community with 1,220+ tools.
                </p>
                <ul class="ext-card-features">
                    <li>Slash commands</li>
...
<section class="ext-cta">
    <div class="ext-container">
        ...
        <p class="ext-cta-sub" data-aos="fade-up" data-aos-delay="100">
            Get your API key and start using 1,220+ AI tools on every platform you work with.
        </p>
