...
.as-page-btn:hover { border-color: var(--as-blue); }
.as-page-btn.current { background: var(--as-blue); color: #fff; border-color: var(--as-blue); }
...
<div class="as-universe">
    ...
    <div class="as-security-bar">
        ...
        <div class="as-sec-right">
            <span class="as-sec-badge encrypted"><i class="fas fa-shield-alt"></i> AES-256 + Kyber-768</span>
