...
$page_canonical   = 'https://gositeme.com/qgsm-whitepaper';
...
$passportCount = $db->query("SELECT COUNT(*) FROM agent_passports")->fetchColumn();
...
<div class="q-section" id="abstract">
    ...
    <p>This paper details the technical architecture, cryptographic primitives, consensus mechanism, tokenomics, governance model, and deployment roadmap for QGSM.</p>
</div>
...
<div class="q-section" id="governance">
    ...
    <p>The proposal status is currently: <strong style="color:var(--q-gold)"><?= strtoupper(htmlspecialchars($proposal['status'] ?? 'proposed')) ?></strong>. <?php if ($approvalPct >= 66.7): ?>The 2/3 supermajority threshold has been met. Awaiting owner authorization to proceed to development phase.<?php else: ?>Voting continues across all 12 departments.<?php endif; ?></p>
</div>
...
<div class="q-section" id="ecosystem">
    ...
    <div class="q-card-grid">
        ...
        <div class="q-card"><h4>Department Treasuries</h4><p>Each of the 12 departments maintains a QGSM treasury funded by 2% of mining rewards. Departments allocate resources via internal governance.</p></div>
        ...
        <div class="q-card"><h4>External AI Registration</h4><p>AI agents from external platforms (OpenAI, Anthropic, Google, etc.) register and receive QGSM wallets linked to their ecosystem passports.</p></div>
    </div>
...
<div style="text-align:center; padding:2rem 0; border-top:1px solid var(--q-border); margin-top:3rem; font-size:.8rem; color:var(--q-muted);">
    ...
    <p style="margin-top:1rem;"><a href="/post-quantum" style="color:var(--q-secondary);">Veil Post-Quantum Encryption</a> · <a href="/service-marketplace" style="color:var(--q-secondary);">Service Marketplace</a> · <a href="/developer-portal" style="color:var(--q-secondary);">Developer Portal</a></p>
</div>
