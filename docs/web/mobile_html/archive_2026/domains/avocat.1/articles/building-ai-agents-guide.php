...
const response = await fetch('https://api.gositeme.com/v1/agents/contentops/tasks', {
    method: 'POST',
    headers: {
...
<ul>
    <li><strong>Voice-controlled agents:</strong> Deploy and manage agents through <a href="/voice.php">voice commands</a> — "Alfred, have the content agent write a blog post about edge computing"</li>
