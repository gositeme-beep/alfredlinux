...
<body>
        ...
        <aside class="sidebar" id="dashSidebar">
            ...
            <div class="sidebar-section">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li><a href="/docs/commander-briefing.php" style="color:#f5c542;"><i class="fas fa-clipboard-list" style="color:#f5c542;"></i> Briefing</a></li>
                    <li><a href="/docs/letter-to-future-me.php" style="color:#f5c542;"><i class="fas fa-scroll" style="color:#f5c542;"></i> My Letter</a></li>
                </ul>
            </div>
    ...
    <script src="/assets/js/dashboard.js?v=20260309"></script>
