...
$pageDescription = "Secure .gositeme, .qgsm, and .gsm top-level domains on the Handshake decentralized DNS.";
$adminOnly = true;
...
<div class="hns-page">
    ...
    <div class="hns-domains" id="targetDomains">
        <div class="hns-card loading" id="card-gositeme">
            <div class="hns-card-name">.<span>gositeme</span></div>
    ...
    <div class="hns-cost" id="costEstimate" style="display:none">
        ...
        <div class="hns-cost-grid">
            <div class="hns-cost-item">
                <div class="hns-cost-name">.gositeme</div>
                <div class="hns-cost-value" id="cost-gositeme">—</div>
        ...
        <div class="hns-options">
            ...
            <div class="hns-option">
                ...
                <ul class="hns-steps">
                    ...
                    <li>Search for <strong>gositeme</strong> and <strong>qgsm</strong> in Bob Wallet</li>
            ...
            <div class="hns-option">
                ...
                <ul class="hns-steps">
                    ...
                    <li>Fill out their <strong>TLD Inquiry Form</strong> requesting .gositeme and .qgsm</li>
    ...
    <div class="hns-option" style="margin-bottom: 40px">
        ...
        <p style="color:#94a3b8;font-size:14px;line-height:1.7;margin:0">
            ...
            For names that have never been auctioned (.gositeme) or expired (.qgsm), you'll likely be the only bidder.
        </p>
    </div>
...
async function loadDomains() {
    try {
        ...
        ['gositeme', 'qgsm', 'gsm'].forEach(name => {
