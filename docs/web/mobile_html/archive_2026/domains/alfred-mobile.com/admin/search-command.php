    ...
    <div class="sc-panel" id="panel-departments">
        ...
        <div class="sc-grid-3">
            ...
            <div class="dept-card">
                ...
                <h4>Security / Veil</h4>
                <p><strong style="color:#fff;">Encrypted Index</strong> — Kyber-1024 encrypted search index at rest</p>
        ...
        <div class="sc-card">
            ...
            <table class="sc-table">
                ...
                <tbody>
                    ...
                    <tr><td>Post-quantum encryption</td><td style="color:var(--sc-red);">None</td><td style="color:var(--sc-green);font-weight:700;">Kyber-1024</td><td>Security</td></tr>
