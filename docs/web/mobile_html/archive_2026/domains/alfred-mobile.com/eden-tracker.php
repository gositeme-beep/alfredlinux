...
<div class="mc">
    ...
    <div class="failsafe-section">
        ...
        <div class="warn-text">
            ...
            <code>/home/gositeme/.vault/ssh-credentials.enc</code> — Alfred can always retrieve it for you.
...
document.getElementById('sshPass').textContent = <?= json_encode(
    (function() use ($db) {
        // Decrypt from vault
        require_once '/home/gositeme/.vault/key-loader.php';
        try { $key = getVaultKeyFromTmpfs(); } catch (Exception $e) { return '(vault key not found)'; }
        $vaultFile = '/home/gositeme/.vault/ssh-credentials.enc';
