...
$page_canonical = 'https://gositeme.com/about-crawler';
...
<div class="ac-section">
    ...
    <p style="color:var(--text-dim); font-size:1.1rem; line-height:1.7; margin-bottom:24px;">
        ...
        <a href="https://gositeme.com" style="color:var(--accent)">GoSiteMe</a>. Unlike Google, Bing, or even DuckDuckGo,
...
<div class="ac-section" style="border-top: 1px solid var(--border);">
    ...
    <div class="ua-box">
        ...
        <div class="value">AlfredSearchBot/1.0 (+https://gositeme.com/about-crawler)</div>
    </div>
...
<span class="key">Allow:</span> <span class="val">/</span></pre>
    ...
    <div class="contact-box">
        ...
        <a href="mailto:crawler@gositeme.com">crawler@gositeme.com</a> or visit our
...
<div class="ac-section" style="border-top: 1px solid var(--border);">
    ...
    <div style="color:var(--text-dim); line-height:1.8;">
        ...
        <p><strong style="color:var(--text)">Operator:</strong> GoSiteMe (gositeme.com)</p>
        ...
        <p><strong style="color:var(--text)">Contact:</strong> <a href="mailto:crawler@gositeme.com" style="color:var(--accent)">crawler@gositeme.com</a></p>
    </div>
</div>
