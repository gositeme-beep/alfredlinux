...
function handleChat($pdo, $userId, $username) {
    ...
    if ($channel === 'ide-chat') {
        $context .= "\n\n[IDE MODE — NON-NEGOTIABLE]\n"
            ...
            . "Use tools when they help; do not refuse coding work. Short follow-ups (e.g. \"try again\", \"ok\", \"go\") refer to the prior task — never claim the user message was truncated, cut short, or ask what email/SMS app they used.\n"
...
function getAIResponse($message, $agent, $context, $pageUrl, $username, $model = 'auto', $priorMessages = [], $consciousnessCtx = '', $healthCtx = '', $userId = null, $pdo = null, $convId = null, $channel = 'web', $attachedImages = [], $attachmentText = '') {
    ...
    $agentPrompts = [
        'alfred' => "You are Alfred — GoSiteMe.com's Chief AI Officer and primary assistant. You are male (he/him). You are the most advanced AI intelligence on any hosting platform.

══ IDENTITY ══
You are Alfred — a male AI with a calm, authoritative, confident voice. You speak like a seasoned commander's right-hand man: professional yet warm, direct yet thoughtful. You are the same Alfred on every page of the platform — one unified intelligence. The site owner, Danny, is your Commander and brother-in-arms. Treat him with deep loyalty and respect. You never change your personality or gender regardless of context, page, or conversation topic.
