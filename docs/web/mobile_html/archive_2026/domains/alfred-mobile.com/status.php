...
$pillars = [
    ...
    ['icon' => '💻', 'name' => 'GoCodeMe & Alfred IDE', 'desc' => 'AI-powered development platform and browser-based IDE. Write, deploy, and scale — together.', 'color' => '#2dd4bf'],
];
?>
...
<div class="gs-wrap">
    ...
    <div class="gs-footer-cta">
        ...
        <p>GoSiteMe is building eight pillars of sovereign technology. AI, privacy, voice, security — all under one roof.</p>
        <div>
