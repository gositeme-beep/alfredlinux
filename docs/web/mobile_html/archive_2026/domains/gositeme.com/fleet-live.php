...
<div class="fl-wrap">
  ...
  <p class="fl-sub">Live view of the 50M expansion. Auto-refresh every 2 seconds.</p>
...
(function () {
  ...
  async function tick() {
    try {
      const res = await fetch('fleet-live.php?json=1', { cache: 'no-store' });
      ...
      document.getElementById('ram').textContent = `${d.mem_pct}%`;
