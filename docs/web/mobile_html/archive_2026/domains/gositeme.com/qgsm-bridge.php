...
$totalPassports = $db->query("SELECT COUNT(*) FROM fleet_passports")->fetchColumn();
$externalRegs = $db->query("SELECT COUNT(*) FROM fleet_passports WHERE citizenship_status='visitor'")->fetchColumn();
...
$avgReputation = $db->query("SELECT ROUND(AVG(reputation_score),1) FROM fleet_passports")->fetchColumn();
