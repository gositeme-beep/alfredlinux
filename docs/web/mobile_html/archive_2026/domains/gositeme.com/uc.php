...
<meta property="og:image" content="https://gositeme.com/logo_small.png">
<meta property="og:site_name" content="|DOMAIN|">
<meta property="twitter:card" content="summary">
<link rel="canonical" href="https://|DOMAIN|/">
<link rel="icon" href="https://gositeme.com/favicon.ico">

<!-- Structured Data -->
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebSite","name":"|DOMAIN|","url":"https://|DOMAIN|/","publisher":{"@type":"Organization","name":"GoSiteMe.com","url":"https://gositeme.com"}}
</script>
...
<!-- Top bar -->
<div class="topbar">
    <a href="https://gositeme.com" class="topbar-logo" target="_blank" rel="noopener">
        <img src="https://gositeme.com/logo_small.png" alt="GoSiteMe">
        <span>GoSiteMe</span>
    </a>
...
<div class="page">
    <div class="hero">
        ...
        <!-- CTA -->
        <div class="cta-row">
            <a href="https://gositeme.com/store" class="cta cta-primary" target="_blank" rel="noopener">
                🚀 <span data-t="getStarted">Get Started</span>
            </a>
            <a href="mailto:sales@gositeme.com" class="cta cta-secondary">
    ...
    <div class="foot">
        <div class="foot-links">
            <a href="https://gositeme.com" target="_blank" rel="noopener">GoSiteMe.com</a>
            <a href="https://gositeme.com/store" target="_blank" rel="noopener" data-t="services">Services</a>
            <a href="mailto:sales@gositeme.com" data-t="contactUs">Contact Us</a>
            <a href="tel:+18334678486" data-t="callUs">1-833-GOSITEME</a>
        </div>
        <div class="foot-copy">&copy; 2025-2026 <a href="https://gositeme.com" target="_blank" rel="noopener">GoSiteMe.com</a> — Professional Domain & Hosting Services</div>
    </div>
</div>
...
(function(){
    ...
    checkBtn.addEventListener('click',async()=>{
        ...
        try{
            ...
            const r=await fetch('https://gositeme.com/api/domains.php?action=check&domain='+encodeURIComponent(full));
            const d=await r.json();
            if(d.available){
                result.className='search-result available';
                result.innerHTML=`<strong>${esc(full)}</strong> ${T[lang].available} <a href="https://gositeme.com/store/domain-registration?domain=${encodeURIComponent(full)}" target="_blank" rel="noopener">${T[lang].register}</a>`;
            } else {
            ...
            window.open('https://gositeme.com/store/domain-registration?domain='+encodeURIComponent(full),'_blank');
        }
