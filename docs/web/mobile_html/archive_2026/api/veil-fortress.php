...
function handleCryptoHealth(): void {
    ...
    $health = [
        'encryption_stack' => [
            'layer_1' => ['name' => 'Kyber-768 KEM', 'type' => 'post-quantum', 'status' => 'active', 'nist' => 'FIPS 203 (ML-KEM)', 'security_level' => '128-bit PQ'],
            ...
            'layer_6' => ['name' => 'Dilithium PQ Signatures', 'type' => 'post-quantum_sig', 'status' => 'active', 'basis' => 'CRYSTALS-Dilithium (ML-DSA)', 'security_level' => '128-bit PQ'],
...
function handleFortressStatus(): void {
    veil_respond(['ok' => true, 'fortress' => [
        ...
        'layers' => 10,
        'algorithms' => [
            'key_exchange' => ['Kyber-768 (ML-KEM)', 'ECDH P-256'],
