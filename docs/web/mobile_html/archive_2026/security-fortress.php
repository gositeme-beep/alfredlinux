...
$totalPassports = $db->query("SELECT COUNT(*) FROM fleet_passports WHERE is_verified=1")->fetchColumn();
...
$classifiedClearance = $db->query("SELECT COUNT(*) FROM fleet_passports WHERE clearance_level='classified'")->fetchColumn();
?>
