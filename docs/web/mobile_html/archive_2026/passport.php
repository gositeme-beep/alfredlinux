 ...
 * 
 * Accessible at:
 *   - https://gositeme.com/passport.php
...
// Account-level pages always live on gositeme.com
$accountBase = 'https://gositeme.com';
...
<head>
    ...
    <meta property="og:image" content="https://gositeme.com/assets/images/alfred-icon-512.png">
    ...
    <meta name="twitter:image" content="https://gositeme.com/assets/images/alfred-icon-512.png">
    ...
    <div class="passport-content">
        ...
        <div class="step" id="step2">
            ...
            <div class="contract-scroll" id="contractScroll">
                ...
                <p>MetaDome is governed democratically. All major decisions are made through consultation and voting across 12 sovereign departments. As a newcomer, you have observer status. As your contribution and reputation grow, so does your governance weight.</p>
                ...
                <blockquote>
                    ...
                    <p style="font-style:normal;font-size:.75rem;color:var(--md-green);margin-top:.5rem;">— Ratified unanimously by all 12 departments, Consultation #70</p>
                </blockquote>
            </div>
...
function showLoginFromPassport() {
    window.location.href = ACCOUNT_BASE + '/login.php?redirect=' + encodeURIComponent(window.location.href);
}
</script>
<?php
$awVer = '9.6.0';
