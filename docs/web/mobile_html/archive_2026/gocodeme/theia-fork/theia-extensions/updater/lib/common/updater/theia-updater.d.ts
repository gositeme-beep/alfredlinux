...
export declare const TheiaUpdaterPath = "/services/theia-updater";
export declare const TheiaUpdater: unique symbol;
...
export declare const TheiaUpdaterClient: unique symbol;
...
//# sourceMappingURL=theia-updater.d.ts.map