...
export class TheiaIDEGettingStartedWidget extends GettingStartedWidget {
    ...
    protected renderHelp(): React.ReactNode {
        return <div className='gs-section'>
            ...
            <div className='gs-action-container'>
                <a role='button' tabIndex={0} onClick={() => this.doOpenExternalLink('https://gositeme.com/whmcs/knowledgebase')}>Documentation</a>
            </div>
            <div className='gs-action-container'>
                <a role='button' tabIndex={0} onClick={() => this.doOpenExternalLink('https://gositeme.com/whmcs/submitticket.php')}>Submit a Support Ticket</a>
            </div>
        </div>;
    }
    ...
    protected renderNews(): React.ReactNode {
        return <div className='gs-section'>
            <h3 className='gs-section-header'>
                {'🚀 AI Support in GoCodeMe is available! ✨'}
            </h3>
            <div className='gs-action-container'>
                <a role='button' style={{ fontSize: 'var(--theia-ui-font-size2)' }} tabIndex={0}
                   onClick={() => (this as any).doOpenAIChatView()}
                >Open the AI Chat View now to get started! ✨</a>
            </div>
        </div>;
    }
