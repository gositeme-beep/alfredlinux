                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="quickad_settings_general">
                                                        <form method="post" action="ajax_sidepanel.php?action=SaveSettings" id="#quickad_settings_general">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="admin_allergies">Enable/disable Allergies</label>
                                                                <select name="admin_allergies" id="admin_allergies" class="form-control">
                                                                    <option value="1" <?php if(get_option("admin_allergies", 1) == '1'){ echo "selected"; } ?>>Enable</option>
                                                                    <option value="0" <?php if(get_option("admin_allergies", 1) == '0'){ echo "selected"; } ?>>Disable</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="admin_send_order_notification">Send New Order Notification to Restaurants</label>
                                                                <select name="admin_send_order_notification" id="admin_send_order_notification" class="form-control">
                                                                    <option value="1" <?php if(get_option("admin_send_order_notification", 1) == '1'){ echo "selected"; } ?>>Yes</option>
                                                                    <option value="0" <?php if(get_option("admin_send_order_notification", 1) == '0'){ echo "selected"; } ?>>No</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="cron_exec_time">Cron job run time (In seconds)</label>
                                                    ...
                                                    <div class="tab-pane" id="whatsapp_ordering">
                                                        <form method="post" action="ajax_sidepanel.php?action=SaveSettings" id="#whatsapp_ordering">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <input placeholder="random value" name="quickorder_purchase_key" type="text" class="form-control" value="">
                                                                </div>
                                                            </div>
