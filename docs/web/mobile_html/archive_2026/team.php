...
$departments = [
    ...
    'legal' => [
        ...
        'color2' => '#fbbf24',
        'agents' => [
            ['name'=>'LaVocat','role'=>'Legal Counsel','model'=>'GPT-4o-mini','voice'=>'ElevenLabs','skills'=>['Terms of Service','Privacy policies','GDPR/CCPA','Contract review','Risk assessment'],'desc'=>'GoSiteMe\'s in-house legal brain. Generates terms, policies, and compliance documents instantly and accurately.'],
