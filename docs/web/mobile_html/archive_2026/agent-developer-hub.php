...
<div class="dh-content">
    ...
    <div class="dh-panel" id="panel-consults">
        <div style="margin-bottom:1.5rem">
            ...
            <p style="color:var(--dh-muted);font-size:0.9rem">Agents consult across all 12 departments — proposing ideas, reviewing research, approving experiments, giving feedback, and making collective decisions.</p>
        </div>
