...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'checkout') {
    ...
    try {
        ...
        $session = \Stripe\Checkout\Session::create([
            ...
            'mode' => 'subscription',
            'success_url' => 'https://gositeme.com/discord-billing?success=1&plan=' . urlencode($plan) . '&uid=' . urlencode($discordId),
            'cancel_url' => 'https://gositeme.com/discord-billing?cancelled=1&plan=' . urlencode($plan) . '&uid=' . urlencode($discordId),
            'metadata' => [
                'discord_id' => $discordId,
                'discord_plan' => $plan,
                'source' => 'discord-billing',
...
<div class="footer">
    <p>Powered by <a href="https://gositeme.com">GoSiteMe</a> • Payments secured by Stripe</p>
    <p style="margin-top:8px;">Need help? DM Alfred on <a href="https://discord.gg/gositeme">Discord</a></p>
