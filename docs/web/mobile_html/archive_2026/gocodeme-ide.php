...
$ALLOWED_ROOTS = [
    ...
    '/home/gositeme/.vault',
    '/home/gositeme/domains/gositeme.com',
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    switch ($action) {
        case 'list_dir':
            $dir = $_POST['path'] ?? '/home/gositeme/domains/gositeme.com/public_html';
        ...
        case 'save_file':
            ...
            $backup = null;
            if (file_exists($file)) {
                $backupDir = '/home/gositeme/.vault/ide-backups';
...
<div class="gcm-wrap">
    <div class="gcm-topbar">
        <div class="brand">&#9883; <span>GoCodeMe IDE</span></div>
    ...
    <div class="gcm-main">
        <div class="gcm-sidebar">
            ...
            <div class="gcm-roots">
                <button class="gcm-root-btn" onclick="GCM.nav('/home/gositeme/domains/gositeme.com/public_html')">&#127968; public_html</button>
                <button class="gcm-root-btn" onclick="GCM.nav('/home/gositeme/.vault')">&#128272; vault</button>
                <button class="gcm-root-btn" onclick="GCM.nav('/home/gositeme/domains/gositeme.com')">&#128194; domain</button>
            </div>
...
const GCM = {
    ...
    tabs: [],
    activeTab: null,
    curPath: '/home/gositeme/domains/gositeme.com/public_html',
    chatOpen: false,
    chatMessages: [],
    ...
    async sendChat() {
        ...
        let context = 'GoCodeMe IDE - Browser code editor.';
        if (GCM.activeTab !== null && GCM.tabs[GCM.activeTab]) {
            const tab = GCM.tabs[GCM.activeTab];
