...
<div class="article-cta">
    ...
    <a href="/alfred-voice-live/" class="btn" style="background:transparent;border:1px solid rgba(108,92,231,0.4);margin-left:12px;"><i class="fas fa-play"></i> See Voice Demo</a>
</div>
...
<pre><code>curl -X POST https://gositeme.com/api/v1/voice/agents \
