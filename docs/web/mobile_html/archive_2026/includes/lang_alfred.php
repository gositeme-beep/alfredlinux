...
if (!isset($LANG_STRINGS)) $LANG_STRINGS = ['en' => [], 'fr' => []];
...
$LANG_STRINGS['en'] = array_merge($LANG_STRINGS['en'], [
    ...
    'alf_addon_whitelabel' => 'Remove GoCodeMe branding. Add your logo, colors, and domain. Perfect for agencies.',
    ...
    'alf_faq9_a'           => 'Yes. GoCodeMe editor works in any modern browser — phone, iPad, laptop. Alfred from anywhere.',
    ...
    'alf_faq12_a'          => 'Built into your GoCodeMe editor browser session. Click the microphone, speak naturally — "Set up SSL on mysite.com" — and Alfred executes it. No extensions. No plugins. Just your browser and your voice.',
...
$LANG_STRINGS['fr'] = array_merge($LANG_STRINGS['fr'], [
    ...
    'alf_addon_whitelabel' => 'Supprimez la marque GoCodeMe. Ajoutez votre logo, couleurs et domaine. Idéal pour les agences.',
    ...
    'alf_faq9_a'           => 'Oui. L\'éditeur GoCodeMe fonctionne dans tout navigateur moderne — téléphone, iPad, portable. Alfred depuis n\'importe où.',
    ...
    'alf_faq12_a'          => 'Intégrées à votre session GoCodeMe dans le navigateur. Cliquez sur le microphone, parlez naturellement — « Configure le SSL sur monsite.com » — et Alfred l\'exécute. Aucune extension requise.',
    ...
    // ═══ v6.0.0 FRENCH — Commercial scenes ═══
    ...
    // ═══ v6.0.0 FRENCH — Superpowers section ═══
    'alf_super_label'      => 'Version 6.0 — La plateforme 250 outils',
    'alf_super_h2'         => 'Six superpouvoirs fondamentaux. 12 nouvelles catégories.<br>Rien d\'autre n\'approche.',
    'alf_super_sub'        => 'Nous n\'avons pas juste ajouté des outils — nous avons ajouté des disciplines entières. E-Commerce, SEO, DevOps, Design, Authentification, Données, Contenu, Accessibilité, Succès client, Intelligence projet, Planification et Communication. 69 nouveaux outils dans 12 nouvelles catégories. 401 au total.',
...
$ALFRED_TOOL_CATS = [
    ...
    [
        ...
        'tools' => [
            ...
            ['Copywrite','Rédiger','Generate professional marketing copy for any channel.','Générez du texte marketing professionnel pour tout canal.','"Write landing page copy for GoCodeMe"','"Rédige le texte de la page d\'accueil pour GoCodeMe"', false],
