    ...
    <!-- Footer -->
    <footer class="footer" role="contentinfo" aria-label="<?php echo $current_lang === 'fr' ? 'Pied de page' : 'Site footer'; ?>">
        <div class="container">
            <div class="footer-grid">
                <div class="footer-brand">
                    ...
                    <div class="footer-social">
                        ...
                        <a href="https://x.com/gositeme" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)"><i class="fab fa-x-twitter"></i></a>
                ...
                <div class="footer-col">
                    ...
                    <ul>
                        ...
                        <li><a href="/gocodeme.php" class="footer-gocodeme"><i class="fas fa-download" aria-hidden="true"></i> <?php echo L('hero_download_gocodeme'); ?></a></li>
                ...
                <div class="footer-col">
                    ...
                    <ul>
                        ...
                        <li><a href="/post-quantum.php"><i class="fas fa-atom" aria-hidden="true"></i> Post-Quantum</a></li>
                    </ul>
                </div>
            ...
            <div class="footer-explore" style="margin-top: 2rem; padding-top: 1.5rem; border-top: 1px solid rgba(255,255,255,0.08); text-align: center;">
                <p style="font-size: 0.9rem; color: var(--text-muted); margin-bottom: 0.5rem;"><?php echo L('footer_explore'); ?>: <a href="<?php echo htmlspecialchars(billing_link('store/ai-domain-hosting-connected-with-ai-editor')); ?>">AI development platform</a> &middot; <a href="<?php echo htmlspecialchars(billing_link('store/token-packs')); ?>">token packs</a> &middot; <a href="<?php echo htmlspecialchars(billing_link('store/ai-domain-hosting-connected-with-ai-editor')); ?>">domain registration</a> &middot; <a href="<?php echo htmlspecialchars(billing_link('store/ssl-certificates')); ?>">SSL certificates</a> &middot; <a href="/gocodeme.php">GoCodeMe editor</a> &middot; <a href="/editor/">build website online</a> &middot; <a href="<?php echo htmlspecialchars(billing_link('contact.php')); ?>">24/7 support</a></p>
                <p style="font-size: 0.85rem; color: var(--text-muted);">Best AI development platform <?php echo date('Y'); ?> &middot; <a href="/alfred.php">AI coding assistant</a> &middot; <a href="/gocodeme.php">cloud IDE</a> &middot; <a href="<?php echo htmlspecialchars(billing_link('store/ai-domain-hosting-connected-with-ai-editor')); ?>">AI hosting</a> &middot; <a href="<?php echo htmlspecialchars(billing_link('store/ai-domain-hosting-connected-with-ai-editor')); ?>">buy domain</a> &middot; <a href="/alfred.php#addons">power-up add-ons</a> &middot; <a href="/voice-products.php">AI voice agents</a></p>
            </div>
            
            <div class="footer-bottom">
                <p>© <?php echo date('Y'); ?> GoSiteMe.com. <?php echo L('footer_rights'); ?></p>
                <a href="#main" class="back-to-top" aria-label="<?php echo $html_lang === 'fr' ? 'Retour en haut' : 'Back to top'; ?>"><i class="fas fa-chevron-up" aria-hidden="true"></i></a>
    ...
    <div class="modal-overlay" id="loginModal">
        <div class="modal-box" style="position: relative;">
            ...
            <div style="text-align:center; margin: 16px 0 8px;">
                <a href="https://gositeme.com/middleware/dashboard" style="color: var(--cyan); font-size: 0.9rem; font-weight: 600; text-decoration: none;">
                    <i class="fas fa-external-link-alt" style="margin-right: 6px;"></i> <?php echo ($current_lang === 'fr') ? 'Ouvrir l\'éditeur directement' : 'Open Editor Directly'; ?>
                </a>
            </div>
    ...
    <script>
        ...
        window.addEventListener('load', function() {
            if (typeof AOS !== 'undefined') {
                // Remove safety fallback so AOS can animate properly
