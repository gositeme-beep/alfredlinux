...
<div class="container">
    <div class="grid">
        ...
        <div class="card">
            ...
            <p>A fail-over mesh network that dynamically reroutes critical IP traffic through decentralized Omegon nodes when conventional ISP gateways drop offline.</p>
        </div>
        <div class="card">
