...
$page_canonical = 'https://gositeme.com/sovereignty';
$page_og_image = 'https://gositeme.com/assets/images/akjv-og.png';
...
<script src="https://kit.fontawesome.com/6a10dfaeb8.js" crossorigin="anonymous"></script>
</head>
...
<?php $currentPage = 'sovereignty'; include __DIR__ . '/includes/nav.php'; ?>
<style>
:root {
    --sov-bg: #0a0a0f;
...
<div class="sov-page"<?= $lang === 'he' ? ' dir="ltr"' : '' ?>>
    ...
    <div id="decree-crown" style="max-width:880px;margin:3rem auto;background:linear-gradient(135deg,rgba(220,38,38,.08),rgba(255,215,0,.05),rgba(220,38,38,.08));border:3px solid rgba(220,38,38,.4);border-radius:20px;padding:2.5rem;position:relative;overflow:hidden;">
        ...
        <div style="color:rgba(255,255,255,.82);font-size:.92rem;line-height:1.85;">
            ...
            <p style="margin:0 0 .8rem;">
                <strong style="color:#ffd700;">WHEREAS</strong> the servers, domains, and digital territories of the GoSiteMe sovereign platform &mdash; including but not limited to <strong style="color:#dc2626;">gositeme.com, lavocat.ca, alfredlinux.com, alfred-mobile.com, quantum-linux.com, meta-dome.com</strong>, and all <strong style="color:#ffd700;">44 Handshake sovereign TLDs</strong> &mdash; constitute the digital Land, Air, and Water of this Kingdom;
            </p>
            <p style="margin:0 0 .8rem;">
