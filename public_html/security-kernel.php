<?php
/**
 * Alfred Linux — Kernel 7.0.12 security & supply-chain transparency (public)
...
<title>Kernel 7.0.12 — Security & Supply Chain — Alfred Linux</title>
<meta name="description" content="How Alfred Linux handles Linux 7.0.12: download integrity, trust boundaries, what we do not claim, and where to read the full technical manifests.">
<meta property="og:title" content="Kernel 7.0.12 Security & Supply Chain — Alfred Linux">
...
<div class="hero">
    ...
    <h1>Linux <span>7.0.12</span> — security &amp; supply chain</h1>
...
<div class="container">
    ...
    <div class="card">
        ...
        <ul>
            <li><strong>No “every CVE in 7.0.12” list</strong> inside the Alfred OS repo — that set is not finite over time, and the full kernel tree is built <strong>out of tree</strong>, not vendored in the live-build repository.</li>
    ...
    <div class="card">
        ...
        <ul>
            <li><strong>Download integrity:</strong> <code>scripts/kernel-download-7.0.12.sh</code> fetches <code>linux-7.0.12.tar.xz</code> and <code>patch-7.0.12.xz</code> from <strong>cdn.kernel.org</strong> over HTTPS and verifies <strong>SHA256</strong> against <strong>sha256sums.asc</strong> before you unpack (skip only with an explicit env flag — not for production ISOs).</li>
    ...
    <div class="card">
        ...
        <div class="links">
            ...
            <a href="<?= htmlspecialchars($forgeDocsRaw) ?>/KERNEL-7.0.12-SECURITY-MANIFEST.txt">Security manifest</a>
            <a href="<?= htmlspecialchars($forgeDocsRaw) ?>/KERNEL-7.0.12-SUPPLY-CHAIN-AUDIT.txt">Supply-chain &amp; trojan-path audit</a>
