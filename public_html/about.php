...
'man_p2' => ['en'=>'This is not a man who writes code in his spare time. This is a man who has stood before judges, won Habeas Corpus hearings, filed complaints against the judiciary, and leads an authorized class action in the Superior Court of Quebec — all while building an operating system with 369 build hooks, post-quantum encryption, and an offline Bible with 94 books and 39,482 verses.','fr'=>'Ce n\'est pas un homme qui code dans ses temps libres. C\'est un homme qui s\'est tenu devant des juges, a gagné des audiences d\'Habeas Corpus, a déposé des plaintes contre la magistrature, et mène un recours collectif autorisé à la Cour supérieure du Québec — tout en construisant un système d\'exploitation avec 1335 hooks de compilation, du chiffrement post-quantique, et une Bible hors-ligne de 94 livres et 39 482 versets.','he'=>'זה לא אדם שכותב קוד בזמנו הפנוי. זה אדם שעמד לפני שופטים, ניצח בדיונים של Habeas Corpus, הגיש תלונות נגד מערכת המשפט, ומוביל תובענה ייצוגית מאושרת בבית המשפט העליון של קוויבק — כל זאת תוך בניית מערכת הפעלה עם 1335 hooks, הצפנה פוסט-קוונטית, ותנ"ך אופליין עם 94 ספרים ו-39,482 פסוקים.'],
...
'cmq_title' => ['en'=>'Complaint to the Conseil de la magistrature','fr'=>'Plainte au Conseil de la magistrature','he'=>'תלונה למועצת השופטים'],
...
'hooks_desc' => ['en'=>'150 sovereign build hooks — from kernel hardening to the Family Bible, from quantum encryption to sacred stillness. The work began at 42 (Matthew 1:17, the 42 generations from Abraham to Christ); the Kingdom outgrew the milestone as observability, attestation, and the worship suite expanded.','fr'=>'1335 hooks de compilation souverains — du renforcement du noyau à la Bible familiale, du chiffrement quantique au silence sacré. Le travail a commencé à 42 (Matthieu 1:17, les 42 générations d\'Abraham au Christ) ; le Royaume a dépassé ce jalon à mesure que l\'observabilité, l\'attestation et la suite de louange se sont étendues.','he'=>'1335 hooks בנייה ריבוניים — מהקשחת הקרנל ועד התנ"ך המשפחתי, מהצפנה קוונטית ועד דממה קדושה. העבודה החלה ב-42 (מתי א:יז, 42 דורות מאברהם למשיח); הממלכה גדלה מעבר לאבן הדרך הזו ככל שהתבוננות, אישור, וחבילת הפולחן התרחבו.'],
'hooks_footnote' => ['en'=>'How we count: <strong>150</strong> = files matching <code>config/hooks/live/*.chroot</code> + <code>*.binary</code> on GoForge (147 chroot + 3 binary). The build also runs 23 stock Debian live-build hooks via <code>config/hooks/normal/</code> symlinks — those are not Alfred-authored and are not counted here. The live ISO may show fewer Alfred hook markers inside the squashfs until reseal — see <a href="/docs">/docs</a> and <code>includes/ga-release-state.php</code>.','fr'=>'Comptage : <strong>150</strong> = fichiers <code>config/hooks/live/*.chroot</code> + <code>*.binary</code> sur GoForge (147 chroot + 3 binary). La build exécute aussi 23 hooks Debian standards via <code>config/hooks/normal/</code> (symlinks) — non écrits par Alfred, donc non comptés ici. L’ISO peut exposer moins de marqueurs de hooks tant qu’un reseal n’a pas livré l’arbre complet — voir <a href="/docs">/docs</a> et <code>includes/ga-release-state.php</code>.','he'=>'ספירה: <strong>150</strong> = קבצים התואמים ל־<code>config/hooks/live/*.chroot</code> + <code>*.binary</code> ב־GoForge (147 chroot + 3 binary). הבנייה מריצה גם 23 hooks סטנדרטיים של Debian דרך <code>config/hooks/normal/</code> (symlinks) — לא נכתבו על־ידי Alfred ואינם נספרים כאן. ב־ISO עשויים להופיע פחות סמני hooks עד reseal — ראו <a href="/docs">/docs</a> ו־<code>includes/ga-release-state.php</code>.'],
...
'license_desc' => ['en'=>'Fully open source. Every hook, every script, every security profile — available on <a href="https://alfredlinux.com/forge/explore/repos">GoForge</a>. We hide nothing.','fr'=>'Entièrement open source. Chaque hook, chaque script, chaque profil de sécurité — disponible sur <a href="https://alfredlinux.com/forge/explore/repos">GoForge</a>. Nous ne cachons rien.','he'=>'קוד פתוח לחלוטין. כל hook, כל סקריפט, כל פרופיל אבטחה — זמין ב-<a href="https://alfredlinux.com/forge/explore/repos">GoForge</a>. אנחנו לא מסתירים כלום.'],
...
'theo_intro' => ['en'=>'The laws of computing are not arbitrary. They are reflections of divine architecture. The Kingdom of God Edition recognizes six universal laws mapping computer science to theology:','fr'=>'Les lois de l\'informatique ne sont pas arbitraires. Elles sont le reflet de l\'architecture divine. L\'Édition du Royaume de Dieu reconnaît six lois universelles reliant l\'informatique à la théologie :','he'=>'חוקי המחשוב אינם שרירותיים. הם השתקפות של ארכיטקטורה אלוהית. מהדורת מלכות האלוהים מכירה בשישה חוקים אוניברסליים הממפים את מדעי המחשב לתיאולוגיה:'],
...
'diff_hooks' => ['en'=>'<strong>369 build hooks</strong> — from security hardening to the Family Bible, from post-quantum Kyber-1024 encryption to Sabbath calendar integration. Each hook serves a purpose under God.','fr'=>'<strong>1335 hooks de compilation</strong> — du renforcement de la sécurité à la Bible familiale, du chiffrement post-quantique Kyber-1024 à l\'intégration du calendrier du Sabbat. Chaque hook a un but sous Dieu.','he'=>'<strong>1335 hooks בנייה</strong> — מהקשחת אבטחה ועד התנ"ך המשפחתי, מהצפנה פוסט-קוונטית Kyber-1024 ועד שילוב לוח שנה של שבת. לכל hook יש מטרה תחת אלוהים.'],
...
'tl_777_p' => ['en'=>'369 build hooks. Post-quantum encryption. Offline AKJV Bible (94 books, 39,482 verses). Family Bible with covenant certificate. 27 worship tracks. Sabbath calendar. Morning devotionals. Sacred silence. Mesh networking. The Omahon Seal. The Inheritance (Shamir 3-of-5). The complete work.','fr'=>'1335 hooks de compilation. Chiffrement post-quantique. Bible AKJV hors-ligne (94 livres, 39 482 versets). Bible familiale avec certificat d\'alliance. 27 morceaux de louange. Calendrier du Sabbat. Dévotions matinales. Silence sacré. Réseau maillé. Le Sceau Omahon. L\'Héritage (Shamir 3-sur-5). L\'œuvre complète.','he'=>'1335 hooks בנייה. הצפנה פוסט-קוונטית. תנ"ך AKJV אופליין (94 ספרים, 39,482 פסוקים). תנ"ך משפחתי עם תעודת ברית. 27 שירי פולחן. לוח שנה של שבת. תפילות בוקר. דממה קדושה. רשת Mesh. חותם Omahon. הירושה (שמיר 3-מתוך-5). היצירה השלמה.'],
...
// Source code cards
'src_al_desc' => ['en'=>'Build system, 1335 hooks, package lists, kernel config. Everything that produces the ISO.','fr'=>'Système de compilation, 1335 hooks, listes de paquets, config noyau. Tout ce qui produit l\'ISO.','he'=>'מערכת בנייה, 1335 hooks, רשימות חבילות, תצורת קרנל. כל מה שמייצר את ה-ISO.'],
        ...
        "brand": [
            {
                ...
                "description": "Kingdom of God Edition. 369 build hooks, post-quantum encryption, offline AKJV Bible, Family Bible registry, worship music, mesh networking, and the Omahon Seal integrity framework.",
                "offers": {
                    "@type": "Offer",
                    "price": "0",
                    "priceCurrency": "USD"
...
# AGPL-3.0 — we are contractually obligated to share everything.</code>
        </div>
    </div>
    ...
    <div class="section" style="margin-top:4rem;">
        <div style="background:linear-gradient(135deg,rgba(255,215,0,0.10),rgba(220,38,38,0.06),rgba(99,102,241,0.06));border:3px solid rgba(255,215,0,0.5);border-radius:24px;padding:3rem 2.5rem;position:relative;overflow:hidden;">
            ...
            <div style="text-align:center;margin-top:2rem;padding-top:1.5rem;border-top:1px solid rgba(255,215,0,0.2);">
                ...
                <p style="color:var(--gold);font-size:1.1rem;font-weight:700;margin-bottom:0.5rem;">📅 Launching Friday, May 29th, 2026 at 6:00 PM Eastern</p>
                ...
                <p style="color:var(--text);font-size:1.05rem;font-weight:700;margin-top:1rem;">42 generations from Abraham to Christ. 369 build hooks for the Kingdom. One Messiah. One God.</p>
            </div>
        </div>
    </div>
...
<footer>
    ...
    <p>&copy; <?= $year ?> <a href="https://gositeme.com"><?= _t('footer_copy') ?></a> &mdash; Alfred Linux 7.77 &middot; Kingdom of God Edition &middot; Open Source (AGPL-3.0)</p>
