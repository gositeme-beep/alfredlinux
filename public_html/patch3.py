...
# 3. Erase the entire Integrity Verification section cleanly
pattern = r"<!-- ── Integrity Verification ───────────────────── -->\s*<section class=\"how-it-works\" style=\"border-top:1px solid var\(--border\);\">(.*?)</section>"
