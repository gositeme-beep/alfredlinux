...
$page_canonical = 'https://alfredlinux.com/bible';
$page_og_image = 'https://alfredlinux.com/assets/images/akjv-og.png';
        ...
        <div style="color:rgba(255,255,255,.82);font-size:.9rem;line-height:1.85;">
            ...
            <div style="margin-bottom:1.5rem;">
                ...
                <div style="font-size:.84rem;color:rgba(255,255,255,.75);line-height:1.8;">
                    ...
                    <p style="margin:0;">
                        <strong style="color:#ffd700;">→</strong> <strong>Full Ecosystem File Scan</strong> — Every PHP, HTML, and JS file across gositeme.com, lavocat.ca, and shared/bible was scanned for forbidden naming patterns. No corruption remains outside of legitimate historical context (WHEREAS clauses and SSA detection patterns).
                    </p>
                </div>
            </div>
