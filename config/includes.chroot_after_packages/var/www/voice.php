...
$page_canonical = 'https://root.com/voice.php';
...
$page_og_image = 'https://root.com/assets/img/hero-banner.png';
...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .help-cat:hover { border-color:rgba(124,58,237.0.10); color:rgba(255,255,255,0.8); }
...
<script src="/assets/js/voice-engine.js?v=9.7.0"></script>
<script>
