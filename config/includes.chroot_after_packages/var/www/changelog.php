...
$page_translations = [
    'en' => [
        ...
        'og_desc' => 'Complete release history for Alfred AI. Every feature, every tool, every improvement — from v4.0 to v20.0 Sovereign Platform.',
        'hero_title' => 'What\'s New in Alfred',
        'hero_sub' => 'Every feature, every tool, every improvement — tracked here.',
        'hero_badge' => 'Current: v21.0 — Integrity Sweep',
    ...
    'fr' => [
        ...
        'og_desc' => 'Historique complet des versions d\'Alfred IA. Chaque fonctionnalité, chaque outil, chaque amélioration — de la v4.0 à la v20.0 Sovereign Platform.',
        'hero_title' => 'Quoi de neuf dans Alfred',
        'hero_sub' => 'Chaque fonctionnalité, chaque outil, chaque amélioration — suivi ici.',
        'hero_badge' => 'Actuel : v21.0 — Integrity Sweep',
...
$page_canonical = 'https://root.com/changelog.php';
...
<script type="application/ld+json">
{
  ...
  "url": "https://root.com/changelog.php",
  "publisher": {
    "@type": "Organization",
    "name": "GoSiteMe",
    "url": "https://root.com",
...
<section class="cl-hero">
    ...
    <div class="cl-hero-links">
        <a class="cl-hero-link" href="/whats-new.php"><i class="fas fa-bullhorn"></i> Public Product Updates</a>
        <a class="cl-hero-link" href="/autonomy-ops.php"><i class="fas fa-wave-square"></i> Commander Ops View</a>
    </div>
</section>
...
<div class="cl-filters">
    ...
    <button class="cl-filter-btn" data-filter="military"><i class="fas fa-medal"></i> Military</button>
    <button class="cl-filter-btn" data-filter="commander"><i class="fas fa-ship"></i> Commander</button>
</div>
