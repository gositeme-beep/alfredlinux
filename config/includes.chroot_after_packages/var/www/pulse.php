...
$page_canonical   = 'https://root.com/pulse';
$noGlobalMain = true;
...
/* ═══════════════════════════════════════════════════════════════
   SERVICE RECORD — Inline Profile Rendering
   ═══════════════════════════════════════════════════════════════ */
/* ── Groups / Units ───────────────────────────────────────────── */
.pulse-group-cat-header { font-size: .85rem; font-weight: 800; text-transform: uppercase; letter-spacing: .1em; color: var(--p-muted); margin: 1.5rem 0 .75rem; display: flex; align-items: center; gap: .5rem; }
.pulse-group-cat-header:first-child { margin-top: 0; }
.pulse-group-cat-header i { font-size: .6rem; color: var(--p-accent); }
.pulse-groups-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: 1rem; }
.pulse-group-card { border-radius: var(--p-radius); overflow: hidden; border: 1px solid var(--p-border); background: var(--p-card); transition: transform .15s, box-shadow .15s; }
.pulse-group-card:hover { transform: translateY(-2px); box-shadow: 0 8px 24px rgba(0,0,0,.15); }
.pulse-group-cover { height: 80px; display: flex; align-items: center; justify-content: center; }
.pulse-group-cover i { font-size: 2rem; color: rgba(255,255,255,.7); }
.pulse-group-body { padding: .85rem 1rem; }
.pulse-group-name { font-weight: 800; font-size: 1rem; margin-bottom: .3rem; }
.pulse-group-desc { font-size: .8rem; color: var(--p-muted); line-height: 1.4; margin-bottom: .5rem; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; }
.pulse-group-meta { font-size: .75rem; color: var(--p-muted); margin-bottom: .6rem; }
.pulse-group-meta i { margin-right: .3rem; }
.pulse-group-join { display: block; width: 100%; padding: .45rem; border-radius: 6px; border: 1px solid var(--p-accent); background: transparent; color: var(--p-accent); font-weight: 700; font-size: .8rem; cursor: pointer; transition: all .15s; }
.pulse-group-join:hover { background: var(--p-accent); color: #fff; }
.pulse-group-join.joined { background: rgba(34,197,94,.1); color: #22c55e; border-color: rgba(34,197,94,.3); }
.pulse-group-join.joined:hover { background: rgba(239,68,68,.1); color: #ef4444; border-color: rgba(239,68,68,.3); }

.pulse-service-record { margin-bottom: 1.5rem; }

/* ═══════════════════════════════════════════════════════════════
   ECOSYSTEM POST TYPES — Agent Activity, Game Results, Ranks
   ═══════════════════════════════════════════════════════════════ */
.pulse-eco-indicator { display: inline-flex; align-items: center; gap: .35rem; font-size: .68rem; font-weight: 700; text-transform: uppercase; letter-spacing: .08em; padding: .2rem .5rem; border-radius: 3px; margin-bottom: .5rem; }
.pulse-card-agent .pulse-eco-indicator { background: rgba(139,92,246,.1); color: #8b5cf6; border: 1px solid rgba(139,92,246,.2); }
.pulse-card-game .pulse-eco-indicator { background: rgba(249,115,22,.1); color: #f97316; border: 1px solid rgba(249,115,22,.2); }
.pulse-card-agent { border-left: 3px solid rgba(139,92,246,.3); }
.pulse-card-game { border-left: 3px solid rgba(249,115,22,.3); }
.pulse-eco-sig { font-size: .75rem; color: var(--p-muted); font-style: italic; margin-top: .5rem; padding-top: .4rem; border-top: 1px solid rgba(255,255,255,.04); }
.pulse-rank-tag { display: inline-flex; align-items: center; gap: .25rem; font-size: .6rem; font-weight: 700; letter-spacing: .06em; padding: .1rem .4rem; border-radius: 3px; margin-left: .3rem; vertical-align: middle; }
.pulse-game-card { background: rgba(255,255,255,.03); border: 1px solid rgba(255,255,255,.06); border-radius: 8px; padding: .75rem 1rem; display: flex; align-items: center; gap: 1rem; flex-wrap: wrap; }
.pulse-game-type { font-size: .8rem; font-weight: 700; text-transform: capitalize; }
.pulse-game-result { font-size: .85rem; font-weight: 900; letter-spacing: .05em; }
.pulse-game-win .pulse-game-result { color: #10b981; }
.pulse-game-loss .pulse-game-result { color: #dc2626; }
.pulse-game-draw .pulse-game-result { color: #f59e0b; }
.pulse-game-opponent { font-size: .78rem; color: var(--p-muted); }
.pulse-game-meta { font-size: .72rem; color: var(--p-muted); }
.pulse-service-record .sr-cover { height: 160px; position: relative; overflow: hidden; border-radius: 16px 16px 0 0; }
.pulse-service-record .sr-cover img { width: 100%; height: 100%; object-fit: cover; }
.pulse-service-record .sr-cover-bg { position: absolute; inset: 0; background: linear-gradient(135deg, rgba(212,160,23,.15), rgba(139,92,246,.1) 40%, rgba(220,38,38,.08)); }
.pulse-service-record .sr-cover-pattern { position: absolute; inset: 0; background: repeating-linear-gradient(45deg, transparent, transparent 40px, rgba(212,160,23,.02) 40px, rgba(212,160,23,.02) 80px); }
.pulse-service-record .sr-cover-fade { position: absolute; bottom: 0; left: 0; right: 0; height: 60px; background: linear-gradient(transparent, var(--p-bg)); }
.pulse-service-record .sr-hero { margin-top: -48px; position: relative; z-index: 10; padding: 0 1rem 1rem; border-bottom: 1px solid var(--p-border); }
.pulse-service-record .sr-hero-top { display: flex; gap: 1.2rem; align-items: flex-end; }
.pulse-service-record .sr-avatar { width: 96px; height: 96px; border-radius: 50%; border: 3px solid var(--p-bg); overflow: hidden; flex-shrink: 0; position: relative; }
.pulse-service-record .sr-avatar img { width: 100%; height: 100%; object-fit: cover; }
.pulse-service-record .sr-avatar-initials { width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; font-size: 2rem; font-weight: 900; color: #fff; }
.pulse-service-record .sr-rank-badge-floating { position: absolute; bottom: -3px; right: -3px; width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: .8rem; color: #000; font-weight: 900; border: 2px solid var(--p-bg); z-index: 11; }
.pulse-service-record .sr-hero-info { flex: 1; padding-bottom: .4rem; }
.pulse-service-record .sr-hero-rank { display: inline-flex; align-items: center; gap: .4rem; font-size: .65rem; font-weight: 800; letter-spacing: .12em; text-transform: uppercase; padding: .2rem .6rem; border-radius: 2px; margin-bottom: .4rem; }
.pulse-service-record .sr-hero-name { font-size: 1.5rem; font-weight: 900; letter-spacing: -.02em; margin-bottom: .15rem; }
.pulse-service-record .sr-hero-subtitle { font-size: .8rem; color: var(--p-muted); }
.pulse-service-record .sr-hero-actions { display: flex; gap: .5rem; margin-top: .6rem; flex-wrap: wrap; }
.pulse-service-record .sr-btn { display: inline-flex; align-items: center; gap: .4rem; padding: .4rem 1rem; font-size: .75rem; font-weight: 700; border-radius: 4px; border: none; cursor: pointer; text-decoration: none; transition: all .2s; }
.pulse-service-record .sr-btn-outline { background: transparent; border: 1px solid var(--p-border); color: var(--p-text); }
.pulse-service-record .sr-btn-outline:hover { border-color: #d4a017; color: #d4a017; }
.pulse-service-record .sr-stats { display: grid; grid-template-columns: repeat(auto-fit, minmax(80px, 1fr)); gap: 1px; background: var(--p-border); border: 1px solid var(--p-border); margin: 1rem 0; border-radius: 4px; overflow: hidden; }
.pulse-service-record .sr-stat { background: var(--p-card); padding: .75rem .5rem; text-align: center; }
.pulse-service-record .sr-stat-val { font-size: 1.1rem; font-weight: 900; font-family: monospace; }
.pulse-service-record .sr-stat-label { font-size: .6rem; color: var(--p-muted); letter-spacing: .08em; text-transform: uppercase; margin-top: .1rem; }
.pulse-service-record .sr-layout { display: grid; grid-template-columns: 1fr 280px; gap: 1rem; padding: 1rem 0; }
@media (max-width: 700px) { .pulse-service-record .sr-layout { grid-template-columns: 1fr; } .pulse-service-record .sr-hero-top { flex-direction: column; align-items: center; text-align: center; } .pulse-service-record .sr-hero-info { text-align: center; } .pulse-service-record .sr-hero-actions { justify-content: center; } }
.pulse-service-record .sr-card { background: var(--p-card); border: 1px solid var(--p-border); border-radius: 8px; margin-bottom: .75rem; overflow: hidden; }
.pulse-service-record .sr-card-header { padding: .75rem 1rem; border-bottom: 1px solid var(--p-border); display: flex; align-items: center; gap: .5rem; font-size: .72rem; font-weight: 700; text-transform: uppercase; letter-spacing: .08em; color: #d4a017; }
.pulse-service-record .sr-card-body { padding: 1rem; }
.pulse-service-record .sr-rank-bar-bg { width: 100%; height: 6px; background: rgba(255,255,255,.06); border-radius: 3px; overflow: hidden; margin: .4rem 0; }
.pulse-service-record .sr-rank-bar-fill { height: 100%; border-radius: 3px; transition: width .6s ease; }
.pulse-service-record .sr-rank-bar-labels { display: flex; justify-content: space-between; font-size: .7rem; color: var(--p-muted); }
.pulse-service-record .sr-rank-bar-labels strong { color: var(--p-text); }
.pulse-service-record .sr-badges { display: flex; flex-wrap: wrap; gap: .4rem; }
.pulse-service-record .sr-badge { display: inline-flex; align-items: center; gap: .3rem; padding: .25rem .6rem; border-radius: 4px; font-size: .68rem; font-weight: 700; border: 1px solid; }
.pulse-service-record .sr-perm { display: flex; align-items: center; gap: .5rem; padding: .35rem 0; font-size: .78rem; border-bottom: 1px solid rgba(255,255,255,.03); }
.pulse-service-record .sr-perm:last-child { border-bottom: none; }
.pulse-service-record .sr-perm i.granted { color: #10b981; }
.pulse-service-record .sr-perm i.denied { color: #dc2626; opacity: .4; }
.pulse-service-record .sr-perm .denied-text { color: var(--p-muted); opacity: .5; }
.pulse-service-record .sr-timeline { position: relative; padding-left: 1.2rem; }
.pulse-service-record .sr-timeline::before { content: ''; position: absolute; left: .3rem; top: 0; bottom: 0; width: 2px; background: linear-gradient(180deg, #d4a017, #10b981); }
.pulse-service-record .sr-timeline-item { position: relative; padding: .6rem 0; }
.pulse-service-record .sr-timeline-item::before { content: ''; position: absolute; left: -.9rem; top: .85rem; width: 6px; height: 6px; border-radius: 50%; background: #d4a017; border: 2px solid var(--p-bg); }
.pulse-service-record .sr-timeline-date { font-size: .65rem; color: var(--p-muted); letter-spacing: .05em; }
.pulse-service-record .sr-timeline-text { font-size: .78rem; margin-top: .1rem; }
.pulse-service-record .sr-empty { text-align: center; padding: 1.5rem; color: var(--p-muted); font-size: .8rem; }
.pulse-service-record .sr-empty i { font-size: 1.5rem; display: block; margin-bottom: .5rem; opacity: .3; }
</style>
...
<?php else: ?>
        ...
        <div class="pulse-tabs">
            ...
            <button class="pulse-tab" data-tab="groups"><i class="fas fa-shield-alt"></i> Units</button>
    ...
    <div class="pulse-sidebar">
        ...
        <div class="pulse-sidebar-card">
            ...
            <div style="display:flex;flex-direction:column;gap:.5rem;">
                ...
                <a href="/alfred-ide.php" style="color:var(--p-text);text-decoration:none;font-size:.88rem;display:flex;align-items:center;gap:.5rem;"><i class="fas fa-code" style="color:var(--p-accent);width:16px;"></i> Alfred IDE</a>
...
<section class="p-divider">
    <div class="p-stats">
        ...
        <div class="p-stat">
            <div class="p-stat-val">GSM</div>
            <div class="p-stat-label">Live on Solana</div>
        </div>
    </div>
</section>
...
<section class="p-section p-divider">
    <div class="p-showcase">
        <div class="p-showcase-visual">
            <div class="p-placeholder"><i class="fas fa-coins" style="font-size:3rem;display:block;margin-bottom:1rem;color:var(--p-yellow);"></i>GSM live on Solana — Kingdom Coins, SOL, Stripe</div>
        </div>
        <div class="p-showcase-text">
            ...
            <ul class="p-showcase-list">
                <li><i class="fas fa-check"></i> GSM token — live on Solana mainnet, mine &amp; withdraw on-chain</li>
    ...
    <div class="p-eco-grid">
        ...
        <a href="/alfred.php" class="p-eco-card">
            ...
            <div class="p-eco-stats">
                ...
                <span class="p-eco-stat"><i class="fas fa-circle"></i> 17 AI Engines</span>
            </div>
        </a>
        ...
        <a href="/voice-products.php" class="p-eco-card">
            ...
            <p>Call campaigns, IVR builder, voice cloning, conference rooms, call recording with AI summaries. Voice platform with 485 tools.</p>
            <div class="p-eco-stats">
                <span class="p-eco-stat"><i class="fas fa-circle"></i> 485 Voice Tools</span>
        ...
        <!-- Alfred IDE -->
        <a href="/alfred-ide.php" class="p-eco-card">
            <div class="p-eco-header">
                <div class="p-eco-icon" style="background:rgba(52,211,153,.15);color:var(--p-green);"><i class="fas fa-code"></i></div>
                <div>
                    <h3>Alfred IDE</h3>
                    <div class="p-eco-tag">Sovereign Cloud IDE</div>
                </div>
            </div>
            <p>Browser-based Alfred workspace with AI coding assistance, terminal access, service-aware routing, and voice-powered development inside the GoSiteMe stack.</p>
            <div class="p-eco-stats">
...
<section class="p-section p-divider">
    ...
    <!-- Desktop Downloads CTA -->
    <div style="margin-top:48px;padding:28px 32px;background:rgba(13,148,136,0.06);border:1px solid rgba(13,148,136,0.15);border-radius:16px;text-align:center;">
        <div style="font-size:11px;font-weight:800;letter-spacing:1px;text-transform:uppercase;color:#0d9488;margin-bottom:8px;">Desktop Apps Available</div>
        <div style="font-size:17px;font-weight:700;color:#fff;margin-bottom:6px;">Pulse Social is available for Linux, Android, and as a web app.</div>
        <div style="font-size:13px;color:rgba(255,255,255,0.5);margin-bottom:18px;">AppImage, .deb, and .rpm packages — plus torrents for decentralized downloads.</div>
        <div style="display:flex;gap:10px;justify-content:center;flex-wrap:wrap;">
            <a href="/apps#pulse-social" style="display:inline-flex;align-items:center;gap:8px;padding:12px 24px;border-radius:12px;background:linear-gradient(135deg,#0d9488,#10b981);color:#fff;text-decoration:none;font-size:14px;font-weight:700;"><i class="fas fa-download"></i> Download Desktop App</a>
            <a href="/apps" style="display:inline-flex;align-items:center;gap:8px;padding:12px 24px;border-radius:12px;border:1px solid rgba(13,148,136,0.25);background:rgba(13,148,136,0.08);color:#0d9488;text-decoration:none;font-size:14px;font-weight:700;"><i class="fas fa-th"></i> All Apps</a>
        </div>
    </div>
</section>
