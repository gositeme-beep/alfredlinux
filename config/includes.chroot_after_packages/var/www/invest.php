...
$page_description = 'Join GoSiteMe\'s growth journey. 13,000+ AI tools, 89 categories, voice AI, and a full hosting platform. Early-stage investment opportunity with transparent returns.';
$page_canonical = 'https://root.com/invest';
$page_og_title = 'Invest in GoSiteMe — Early Stage AI Platform Opportunity';
$page_og_description = 'GoSiteMe is building Canada\'s most comprehensive AI platform. 13,000+ tools, voice AI, 35 industries. See our traction and invest.';
...
<script type="application/ld+json">
{
  ...
  "@type": "FAQPage",
  "mainEntity": [
    {"@type":"Question","name":"What is GoSiteMe?","acceptedAnswer":{"@type":"Answer","text":"GoSiteMe is Canada's most comprehensive AI platform, offering 13,000+ tools across 89 categories, voice AI, hosting, and developer APIs."}},
...
<section class="inv-hero" id="inv-hero">
  ...
  <div class="inv-hero-content">
    ...
    <p class="inv-hero-sub">
      GoSiteMe is building Canada's most comprehensive AI platform — 13,000+ tools, 89 categories, voice AI, 
    ...
    <div class="inv-ps-grid inv-animate">
      ...
      <div>
        ...
        <div class="inv-ps-card">
          ...
          <p>13,000+ AI tools across 35 industries — legal, medical, real estate, marketing, finance, education, and more. All accessible from a single dashboard.</p>
        </div>
        <div class="inv-ps-card">
          <div class="inv-ps-icon">🎯</div>
  ...
  <div class="inv-container">
    ...
    <div class="inv-traction-grid">
      <div class="inv-traction-card inv-animate">
        ...
        <div class="inv-traction-value" id="met-tools">13,000+</div>
  ...
  <div class="inv-container">
    ...
    <div class="inv-timeline inv-animate">
      ...
      <div class="inv-timeline-item completed">
        ...
        <div class="inv-timeline-title">13,000+ Tools & 35 Verticals</div>
        <div class="inv-timeline-desc">Expanded to 13,000+ AI tools spanning 89 categories, marketplace, and white-label capabilities.</div>
        <span class="inv-timeline-status inv-status-done">Completed</span>
      </div>
      <div class="inv-timeline-item completed">
        <div class="inv-timeline-marker"></div>
  ...
  <div class="inv-container">
    ...
    <div class="inv-founder inv-animate">
      ...
      <div class="inv-founder-letter">
        ...
        <p>
          What you see today — 13,000+ AI tools, 89 categories, a voice AI platform, 504 API endpoints, GPU servers, 
