...
$page_canonical = 'https://root.com/help';
$noGlobalMain = true;
...
<p>Log in to your account at <a href="/dashboard">root.com/dashboard</a>. If you don\'t have an account yet, <a href="/pricing.php">sign up for a plan</a> first.</p>
...
<pre><code>&lt;script src="https://root.com/assets/js/alfred-widget.js"
...
<pre><code>curl -X POST https://root.com/api/v1/chat \
...
<h4>Base URL</h4>
<pre><code>https://root.com/api/v1/</code></pre>
...
<pre><code>curl https://root.com/api/v1/agents \
...
<h4>Node.js</h4>
<pre><code>npm install @root/alfred-sdk</code></pre>
<pre><code>const Alfred = require(\'@root/alfred-sdk\');
...
<h4>Python</h4>
<pre><code>pip install root-alfred</code></pre>
<pre><code>from root_alfred import Alfred
...
<h4>PHP</h4>
<pre><code>composer require root/alfred-sdk</code></pre>
...
<div class="help-callout help-callout-info"><i class="fas fa-info-circle"></i> <strong>Note:</strong> Contact your account manager or email <a href="mailto:enterprise@root.com">enterprise@root.com</a> for setup assistance.</div>'
            ],
            [
                'id'      => 'en-team-rbac',
...
<li>Set the ACS (Assertion Consumer Service) URL in your IdP: <code>https://root.com/api/oauth/saml/callback</code></li>
...
<pre><code>CNAME  ai.yourcompany.com  →  whitelabel.root.com</code></pre>
    ...
    <main class="help-main" id="helpMain">
        ...
        <div class="help-contact">
            ...
            <div class="help-contact-options">
                <a href="mailto:support@root.com" class="help-contact-card">
                    <i class="fas fa-envelope" aria-hidden="true"></i>
                    <h4>Email Support</h4>
                    <p>support@root.com<br>Response within 24 hours</p>
                </a>
