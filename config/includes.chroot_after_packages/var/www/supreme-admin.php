...
$page_canonical = 'https://root.com/supreme-admin';
...
<div class="sc-wrap">
  ...
  <div class="sc-panel" id="panel-tools">
    <div class="sc-grid sc-grid-4" style="margin-bottom:20px">
      ...
      <div class="sc-card sc-kpi"><div class="num">11,000+</div><div class="label">Multi-App Hub Tools</div><div class="sub">850 app integrations</div></div>
      <div class="sc-card sc-kpi"><div class="num">85</div><div class="label">Voice Platform Tools</div><div class="sub">267 voice commands</div></div>
    </div>
    ...
    <div class="sc-card">
      ...
      <div style="display:flex;gap:10px;margin-bottom:12px">
        ...
        <select id="toolProvider" class="sc-btn sc-btn-sm sc-btn-outline" style="padding:6px 10px" onchange="filterTools()">
          ...
          <option value="composio">Multi-App Hub (11K+)</option>
          <option value="vapi">Voice Platform (85)</option>
        </select>
      </div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-top:16px">
      ...
      <div class="sc-card">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:12px">
          ...
          <button class="sc-btn" onclick="healService('meilisearch')" style="font-size:.78rem"><i class="fas fa-search"></i> Search</button>
          ...
          <button class="sc-btn" onclick="healService('ollama')" style="font-size:.78rem"><i class="fas fa-robot"></i> Local AI</button>
        </div>
  ...
  <div class="sc-panel" id="panel-agentos">
    ...
    <div class="sc-grid sc-grid-3" id="aosPanelGrid">
      ...
      <div class="sc-card" style="border-left:3px solid #7c5ce7;cursor:pointer" onclick="location.href='/alfred-tools.php'">
        ...
        <p style="font-size:.8rem;color:#888;margin:0 0 8px">Master tool registry — 850+ MCP tools, 400 native PHP tools, multi-app hub & voice platform integrations, tool search & execution</p>
        <div style="display:flex;gap:6px;flex-wrap:wrap">
      ...
      <div class="sc-card" style="border-left:3px solid #3b82f6;cursor:pointer" onclick="location.href='/call-campaigns.php'">
        ...
        <p style="font-size:.8rem;color:#888;margin:0 0 8px">Voice agent campaigns — outbound/inbound call flows, voice platform integration, campaign analytics, voice cloning</p>
        <div style="display:flex;gap:6px;flex-wrap:wrap">
