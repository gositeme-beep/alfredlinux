...
$page_canonical = 'https://root.com/ecosystem';
    ...
    <div class="ec-container">
        ...
        <div class="ec-section">
            ...
            <div class="ec-hub">
                ...
                <div class="ec-node" style="--accent: var(--ec-blue);">
                    ...
                    <h3>Alfred Search</h3>
                    <p>Sovereign search engine with AI-powered instant answers, deep research mode, voice input, and encrypted query logging. Your own search index + web crawler.</p>
                ...
                <div class="ec-node">
                    ...
                    <h3>Veil Protocol</h3>
                    <p>10-layer encryption fortress: Kyber-1024 + AES-256-GCM + ECDH + Double Ratchet + steganographic obfuscation. Post-quantum E2E encryption for all communications.</p>
                    <span class="ec-node-status ec-status-live"><i class="fas fa-circle" style="font-size:6px;"></i> Live</span>
                ...
                <div class="ec-node">
                    ...
                    <p>NIST ML-KEM (Kyber-1024) key encapsulation + Dilithium signatures. Harvest-now-decrypt-later attacks neutralized. Future-proof security today.</p>
                    <span class="ec-node-status ec-status-live"><i class="fas fa-circle" style="font-size:6px;"></i> Live</span>
                    <br><a href="/veil/" class="ec-node-link"><i class="fas fa-arrow-right"></i> Learn more</a>
                </div>
                ...
                <div class="ec-node">
                    ...
                    <p>Our own web crawler with robots.txt compliance, quality scoring, and search indexing. Building a sovereign web index independent of Google, Bing, or any third party.</p>
                    <span class="ec-node-status ec-status-live"><i class="fas fa-circle" style="font-size:6px;"></i> Live</span>
                ...
                <div class="ec-node">
                    ...
                    <h3>Alfred AI</h3>
                    <p>Self-hosted local AI running on the server, plus cloud AI fallback chain. AI-powered search, voice transcription, page summarization — no data leaves your server.</p>
                    <span class="ec-node-status ec-status-live"><i class="fas fa-circle" style="font-size:6px;"></i> Live</span>
                ...
                <div class="ec-node">
                    ...
                    <p>GSM is live on Solana mainnet. Earn tokens by searching and contributing compute power. Browser mining with 80/20 split — you keep 80%. Instant, low-fee on-chain transfers. Like Brave BAT, but better.</p>
                    <span class="ec-node-status ec-status-live"><i class="fas fa-circle" style="font-size:6px;"></i> Live</span>
                ...
                <div class="ec-node">
                    ...
                    <p>50M+ AI agents researching genetics, nutrition, longevity, cannabis science, natural compounds, mental health, and ancient knowledge. Ask any health question.</p>
                    <span class="ec-node-status ec-status-live"><i class="fas fa-circle" style="font-size:6px;"></i> Live</span>
                ...
                <div class="ec-node">
                    ...
                    <h3>Alfred IDE</h3>
                    <p>Official GoSiteMe browser IDE with Alfred built in. Sovereign sign-in, terminal, Git, workspace launch, and service-aware developer access.</p>
                    <span class="ec-node-status ec-status-live"><i class="fas fa-circle" style="font-size:6px;"></i> Live</span>
                    <br><a href="/alfred-ide.php" class="ec-node-link"><i class="fas fa-arrow-right"></i> Launch Alfred IDE</a>
                </div>

                <!-- GoForge -->
                <div class="ec-node">
                    <div style="position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,#6366f1,#8b5cf6);opacity:0.6;"></div>
                    <div class="ec-node-icon" style="background:rgba(99,102,241,0.1);color:#6366f1;"><i class="fas fa-code-branch"></i></div>
                    <h3>GoForge</h3>
                    <p>Sovereign source code hosting. Self-hosted Git platform with 8 public repositories — Alfred Linux build system, Commander, AI agent runtime, and more.</p>
                    <span class="ec-node-status ec-status-live"><i class="fas fa-circle" style="font-size:6px;"></i> Live</span>
                    <br><a href="https://alfredlinux.com/forge/explore/repos" class="ec-node-link" target="_blank"><i class="fas fa-arrow-right"></i> Browse Repos</a>
                </div>
            </div>
        </div>
        ...
        <div class="ec-section">
            ...
            <div class="ec-timeline">
                <div class="ec-tl-item done">
                    ...
                    <div class="ec-tl-desc">AES-256-GCM + Kyber-1024 + ECDH + Double Ratchet + steganographic obfuscation. Zero-knowledge server design.</div>
                </div>
                <div class="ec-tl-item done">
                    <div class="ec-tl-date">Completed</div>
                ...
                <div class="ec-tl-item done">
                    ...
                    <div class="ec-tl-desc">AI-powered sovereign search with instant-search index, web crawler, encrypted logging, voice input, cost tracking.</div>
                </div>
                <div class="ec-tl-item done">
                    <div class="ec-tl-date">Completed</div>
                ...
                <div class="ec-tl-item done">
                    <div class="ec-tl-date">Completed</div>
                    <div class="ec-tl-title">Health Research Pipeline — 50M+ Agents</div>
                    <div class="ec-tl-desc">12 research divisions, 50M+ AI agents researching genetics, nutrition, longevity, cannabis, ancient knowledge, and more.</div>
                </div>
                <div class="ec-tl-item done">
                    <div class="ec-tl-date">Completed</div>
        ...
        <div class="ec-cta">
            ...
            <div style="margin-top:24px;display:flex;gap:20px;justify-content:center;flex-wrap:wrap;">
                ...
                <a href="/veil/" style="font-size:13px;color:var(--ec-muted);"><i class="fas fa-atom" style="margin-right:4px;"></i> Veil</a>
                ...
                <a href="/alfred-ide.php" style="font-size:13px;color:var(--ec-muted);"><i class="fas fa-laptop-code" style="margin-right:4px;"></i> Alfred IDE</a>
