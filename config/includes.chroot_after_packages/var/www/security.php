...
<div class="hero">
    ...
    <p class="sub"><strong>38 Security Modules, The Omahon Seal.</strong> Named after the breath of God. 6 runtime integrity modules: Boot Seal, Watchman, Vault, Shell Guard, Secure Erase, and Sovereign Attestation. 38 active hardening profiles. Your system is sealed — incorruptible.</p>
...
<div class="container">
    ...
    <section id="hardening">
        ...
        <p>
            What runs on first boot, before the user touches anything. Alfred Linux 7.77 GA ships <strong>38 security modules</strong> across 4 hooks — including the Omahon Seal (6 runtime integrity modules) — more out-of-box hardening than any mainstream desktop Linux.
        </p>
    ...
    <section id="gaps">
        ...
        <p>
            Radical honesty. Even with 38 security modules, Ubuntu has advantages we can't match today.
        </p>
...
Status:  Final GA ISO not published on alfredlinux.com yet — see /download for current honesty policy.</pre>
        ...
        ?>
        <pre>SHA-512: 8e47a62c6955322cf578b20b867dab3bdd2afaf03433bee530d91916a8979391e0972c6bb2b0e3cf2b2ae478cb8de70469c4d6612c04f8dcdaf8c1741f46b5ae
...
<footer>
    <p style="font-style:italic;color:#94a3b8;font-size:.85rem;margin:0 0 0.5rem;">&ldquo;The grass withereth, the flower fadeth: but the word of our God shall stand for ever.&rdquo; &mdash; <a href="https://root.com/bible/read/isaiah/40" style="color:#facc15;text-decoration:none;">Isaiah 40:8</a> (AKJV)</p>
    &copy; <?= $year ?> <a href="https://root.com">GoSiteMe Inc.</a> &mdash; Alfred Linux &middot; Open Source (AGPL-3.0)
</footer>
