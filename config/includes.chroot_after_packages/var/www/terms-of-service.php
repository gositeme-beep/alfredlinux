...
<div class="tos-container">
    ...
    <div class="highlight-box">
        ...
        Email: <a href="mailto:legal@root.com">legal@root.com</a><br>
    ...
    <ul>
        <li><strong>"Platform"</strong> &mdash; The Alfred IDE AI development environment, including the web-based IDE, desktop applications, mobile applications, AI assistant (Alfred), all integrated tools, APIs, SDKs, and associated documentation.</li>
    ...
    <p>You are solely responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account. You must immediately notify us at <a href="mailto:security@root.com">security@root.com</a> of any unauthorized access or security breach. We are not liable for any losses arising from unauthorized use of your account, whether or not you were aware of such use.</p>
    ...
    <ul>
        <li>Web-based AI development environment (Alfred IDE)</li>
        <li>AI assistant (Alfred) with access to 13,000+ tools across 17 AI engines</li>
    ...
    <p>Submit a refund request via email to <a href="mailto:support@root.com">support@root.com</a> or through your client area support ticket. Refunds are processed within 5&ndash;10 business days to the original payment method.</p>
    ...
    <ul>
        ...
        <li>Modifying or flashing Robotic Device or IoT Device firmware to remove safety constraints or licensing restrictions</li>
    </ul>
    ...
    <p>Use of our Platform to control Robotic Devices in commercial, industrial, healthcare, agricultural, or public-facing environments requires a separate Enterprise Agreement. Contact <a href="mailto:enterprise@root.com">enterprise@root.com</a> for enterprise robotics terms.</p>

    <h3>9.4 IoT Device Data</h3>
    <ul>
        <li>IoT Devices connected to our Platform may transmit sensor data, device health diagnostics, environmental data, location data, and other hardware information to our servers for device maintenance and safety purposes. <strong>This is not user surveillance telemetry</strong> — it is mechanical health data (battery, temperature, motor status). See our <a href="/privacy-policy.php">Privacy Policy</a> for details.</li>
    ...
    <p>If you believe content on our platform or App Store infringes your copyright, submit a DMCA takedown notice to <a href="mailto:legal@root.com">legal@root.com</a> including: (a) identification of the copyrighted work; (b) identification of the infringing material and its location; (c) your contact information; (d) a statement of good-faith belief; (e) a statement of accuracy under penalty of perjury; and (f) your physical or electronic signature.</p>
    ...
    <p>Unless you notify us in writing to the contrary, you grant GoSiteMe a non-exclusive, royalty-free license to use your name, logo, and trademarks in customer lists, marketing materials, case studies, press releases, and investor presentations for the purpose of identifying you as a GoSiteMe customer. You may revoke this license at any time by providing written notice to <a href="mailto:legal@root.com">legal@root.com</a>, and GoSiteMe will remove your identifying information from future materials within 30 days, though previously published materials need not be recalled.</p>
    ...
    <p>Enterprise Customers processing personal data through our Services may request a separate Data Processing Agreement (DPA) compliant with GDPR, PIPEDA, CCPA/CPRA, and other applicable privacy frameworks. Contact <a href="mailto:privacy@root.com">privacy@root.com</a>.</p>
    ...
    <p>We comply with the Children's Online Privacy Protection Act (COPPA). We do not knowingly collect personal information from children under 13 without verifiable parental consent. If you believe a child under 13 has provided personal information, contact us immediately at <a href="mailto:privacy@root.com">privacy@root.com</a>.</p>
    ...
    <p>We are committed to complying with applicable data protection and privacy laws in all jurisdictions where we operate. If you have jurisdiction-specific inquiries, contact <a href="mailto:privacy@root.com">privacy@root.com</a>.</p>
    ...
    <p>Before initiating any formal dispute resolution, you agree to first contact us at <a href="mailto:legal@root.com">legal@root.com</a> and attempt to resolve the dispute informally for at least sixty (60) days.</p>
    ...
    <p>Subject to these Terms, we grant you a limited, non-exclusive, non-transferable, revocable license to download, install, and use our desktop applications (including Alfred IDE Desktop, Alfred Desktop) and mobile applications (including GoSiteMe Mobile, Alfred IDE Mobile) on devices you own or control, solely for your personal or internal business use in accordance with your subscription plan.</p>
    ...
    <p>If you experience accessibility barriers or require accommodations, please contact us at <a href="mailto:accessibility@root.com">accessibility@root.com</a>. We will make reasonable efforts to provide the information or service you need through an accessible alternative.</p>
    ...
    <p>Government agencies requiring specific compliance standards (FedRAMP, StateRAMP, SOC 2, ISO 27001, or equivalent) should contact <a href="mailto:enterprise@root.com">enterprise@root.com</a> to discuss compliance documentation and available configurations.</p>
    ...
    <p>Notices to GoSiteMe must be sent to <a href="mailto:legal@root.com">legal@root.com</a> and are deemed received upon confirmed delivery. Legal process may be served at our registered address. Legal notices sent by any method other than email to our legal department or registered mail to our physical address are not valid.</p>
    ...
    <ol>
        <li>Contact GoSiteMe Support at <a href="mailto:hardware@root.com">hardware@root.com</a> or call 1-833-GOSITEME with your proof of purchase and description of the defect</li>
    ...
    <p>GoSiteMe Hardware is designed and tested to comply with applicable product safety standards for the markets in which it is sold. Applicable certifications and compliance marks will be listed on the product packaging, in the product documentation, and at <a href="/robots">root.com/robots</a>. These may include, as applicable:</p>
    <ul>
    ...
    <p>GoSiteMe Hardware is accompanied by a comprehensive User Safety Manual. You are responsible for reading and following all safety instructions, warnings, and operating guidelines before use. The Safety Manual is also available digitally at <a href="/docs">root.com/docs</a>.</p>
    ...
    <p>GoSiteMe Hardware contains electronic components and lithium batteries that must not be disposed of in regular household waste. Dispose of GoSiteMe Hardware in accordance with local electronic waste (e-waste) regulations. GoSiteMe offers a take-back program &mdash; contact <a href="mailto:hardware@root.com">hardware@root.com</a> for free recycling of end-of-life units. For EU customers: GoSiteMe complies with the Waste Electrical and Electronic Equipment Directive (WEEE 2012/19/EU) producer obligations.</p>
    ...
    <p>GoSiteMe commits to maintaining availability of genuine spare parts for GoSiteMe Hardware for a minimum of <strong>5 years</strong> from the date GoSiteMe discontinues sale of the applicable hardware model, or as required by applicable law (whichever is longer). Spare parts may be purchased through <a href="mailto:hardware@root.com">hardware@root.com</a> or designated retail partners.</p>

    <h3>62.2 Authorized Repair</h3>
    <p>Warranty repairs and complex repairs (motor replacement, board replacement, structural repair) must be performed by GoSiteMe or an Authorized Service Provider. A network of Authorized Service Providers will be published at <a href="/support">root.com/support</a>.</p>
    ...
    <p>GoSiteMe maintains product liability insurance with coverage limits appropriate for a consumer robotics manufacturer. Details of insurance coverage are available upon written request to <a href="mailto:legal@root.com">legal@root.com</a> by Enterprise Customers and regulatory authorities.</p>
    ...
    <ol>
        ...
        <li>Report the incident to GoSiteMe at <a href="mailto:safety@root.com">safety@root.com</a> or call 1-833-GOSITEME within 24 hours</li>
    ...
    <p>GoSiteMe may offer preventive maintenance service plans including periodic inspections, cleaning, calibration, and software optimization. Service plan tiers and pricing are published at <a href="/robots">root.com/robots</a>.</p>

    <hr>

    <h2>66. Trade-In &amp; Upgrade Program</h2>
    <p>GoSiteMe may offer a trade-in program allowing Purchasers to trade in older GoSiteMe Hardware models for credit toward new models. Trade-in values are determined by GoSiteMe based on model, age, and condition. All traded-in units undergo secure data destruction (factory reset and certified data wiping) before refurbishment, recycling, or disposal. Trade-in program terms and current values are published at <a href="/robots">root.com/robots</a>.</p>
    ...
    <p>GoSiteMe publishes a cryptographically signed Warrant Canary at <a href="/security">root.com/security</a>, updated no less frequently than quarterly. The Warrant Canary affirms the following:</p>
    <ol type="a">
    ...
    <p>Each Warrant Canary publication is signed with GoSiteMe's public cryptographic key (published at <a href="/security">root.com/security</a>) and includes a timestamp and recent news headline to prove currency.</p>
    ...
    <ol type="a">
        ...
        <li>Alfred OS device diagnostics, MQTT communications, and geofencing data are encrypted end-to-end and are never shared with governmental authorities absent valid, specific, non-bulk legal process.</li>
    </ol>
    ...
    <p>User data &mdash; including communications, files, AI interactions, device diagnostics, device configurations, and all other data generated through the GoSiteMe ecosystem &mdash; belongs exclusively to the User who created it. GoSiteMe is a custodian, not an owner, of User data.</p>
    ...
    <p>GoSiteMe will <strong>never</strong> sell, license, rent, share, trade, barter, or otherwise monetize User data, communications, AI interactions, device diagnostics, or any other User-generated content. GoSiteMe's revenue comes from services, subscriptions, and hardware sales &mdash; never from User data.</p>
    ...
    <div class="highlight-box">
        ...
        Phone: 1-833-GOSITEME (1-833-467-4836)<br>
        Legal: <a href="mailto:legal@root.com">legal@root.com</a><br>
        Privacy: <a href="mailto:privacy@root.com">privacy@root.com</a><br>
        Security: <a href="mailto:security@root.com">security@root.com</a><br>
        Hardware Support: <a href="mailto:hardware@root.com">hardware@root.com</a><br>
        Safety Reporting: <a href="mailto:safety@root.com">safety@root.com</a><br>
        General Support: <a href="mailto:support@root.com">support@root.com</a><br>
        Live Chat: Available 24/7 at <a href="https://root.com">root.com</a><br>
