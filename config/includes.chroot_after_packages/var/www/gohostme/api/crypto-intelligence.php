...
function getDashboard($db) {
    ...
    try {
        ...
        $signalCount = $db->query("SELECT COUNT(*) FROM crypto_signals")->fetchColumn();
        $latestSignals = $db->query("SELECT * FROM crypto_signals ORDER BY created_at DESC LIMIT 5")->fetchAll();
    }
