<?php
/**
 * Alfred IDE API — Project Management
 * ──────────────────────────────────
 * Handles project CRUD for the Games Maker and Alfred IDE editor.
...
function createProject(array $body): void {
    ...
    // Build the workspace URL — launches Alfred IDE for this project
