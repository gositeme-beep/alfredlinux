...
// Uses COUNT + OFFSET instead of ORDER BY RAND() (avoids full table scan on large fleet tables)
...
function generateBiodomeArticle(array $params): array {
    ...
    $biodomeTopics = [
        ...
        // ── AGENT ECOSYSTEM ──────────────────────────────
        'agent-ecosystem' => [
            ['title' => 'The GoSiteMe Agent Architecture: 51M+ Agents in Fleet Registry', 'tags' => ['agent architecture', 'GoSiteMe', 'multi-agent', 'ecosystem'], 'dept' => 'engineering'],
        ...
        'gositeme' => [
            ...
            ['title' => 'Alfred IDE: Building a Browser-Based Development Environment', 'tags' => ['Alfred IDE', 'IDE', 'browser', 'development'], 'dept' => 'engineering'],
            ...
            ['title' => 'The Nine Pillars: GoSiteMe\'s Core Value Proposition', 'tags' => ['nine pillars', 'value', 'mission', 'platform'], 'dept' => 'marketing'],
...
function generateBiodomeContent(string $title, string $categorySlug, array $tags): array {
    ...
    $html .= "<p>Within the GoSiteMe platform, $primaryTag plays a significant role in the broader agent ecosystem. With tens of millions of agents in the fleet registry and active profiles across departments, the platform leverages $primaryTag concepts in several key areas:</p>\n";
    $html .= "<ul>\n";
...
echo json_encode($result, gositeme_json_public_encode_flags() | JSON_PRETTY_PRINT);
