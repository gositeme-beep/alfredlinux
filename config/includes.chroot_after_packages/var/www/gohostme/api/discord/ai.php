...
function handleAlfred(array $data): void {
    ...
    $sysPrompt = ($personas[$persona] ?? $personas['alfred'])
        ...
        . " User: $globalName."
        . " GoSiteMe offers: Web Hosting (\$15-\$99/mo), AI-Powered IDE (Alfred IDE), Voice AI, Phone Systems, Domains, SSL, GPU Servers, Metaverse."
    ...
    switch ($subCmd) {
        case 'run':
            ...
            followUp($appId, $token, '', [
                ...
                actionRow(
                    btn(5, '💻 Alfred IDE', 'https://gositeme.com/alfred-ide.php'),
