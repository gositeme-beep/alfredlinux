...
$GAME_CONNECTIONS = [
    ...
    ['id' => 'office',        'name' => 'Virtual Office',        'path' => '/vr/office/',        'agents' => ['agent-signal','agent-berean'],     'activities' => ['learning','reasoning','teaching'],           'gospel_hook' => 'Alfred IDE meets Bible study — developers building for the Kingdom. Agent Berean leads deep scripture dives. Where technology serves the Gospel mission.'],
