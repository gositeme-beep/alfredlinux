...
case 'seed':
    ...
    $tools = [
        ...
        ['gosm-voice', 'GoSiteMe Voice', 'Crystal-clear AI voice calls', 'Voice calling platform with AI receptionist, call recording, IVR builder, and voice cloning.', 'voice', 'calling', 'internal', '/alfred-voice-live/', '📞', 'paid', 'From $9.99/mo', '["Voice Calls","AI Receptionist","Call Recording","IVR Builder","Voice Cloning"]', '["voice","phone","calling"]', 1, 1],
        ['gosm-gocode', 'Alfred IDE', 'AI-powered code editor in the cloud', 'Full IDE with AI code completion, multi-language support, terminal, and deployment.', 'development', 'ide', 'internal', '/alfred-ide.php', '💻', 'freemium', 'Free tier available', '["Code Editor","AI Completion","Terminal","Multi-Language","Git"]', '["ide","coding","development"]', 1, 1],
