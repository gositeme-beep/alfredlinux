 ...
 * Every button is a direct GoSiteMe billing cart link (Stripe + PayPal live).
 *
 * Public copy is intentionally reconciled with the maturity ladder:
 * prefer honest milestones over hype.
 */
...
$alfredPayAccountPath = '/pay/account/';
$alfredPayLoginUrl = '/login?redirect=' . rawurlencode($alfredPayAccountPath);
$alfredPayGoogleUrl = '/api/auth.php?action=google-login&redirect=' . rawurlencode($alfredPayAccountPath);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<meta name="description" content="GoHostMe combines enterprise-style cloud hosting with AI voice, call center, and office automation products, plus industry packages — sold with clear roadmap milestones. 18 global regions. VPS from $29.99/mo. GPU servers with NVIDIA A10. GoHostMe panel included on eligible plans. By GoSiteMe.">
...
<meta property="og:title" content="GoHostMe — Hosting + AI, Shipped With Integrity">
<meta property="og:description" content="Cloud hosting plus AI products and industry solutions — with a public roadmap so you know what is live today vs what we are building next.">
...
.pay-bridge {
    max-width: 860px; margin: 24px auto 0; text-align: left;
    background: linear-gradient(135deg, rgba(6,182,212,0.12), rgba(99,102,241,0.14), rgba(168,85,247,0.12));
    border: 1px solid rgba(129,140,248,0.28); border-radius: 16px; padding: 18px 20px;
    box-shadow: 0 18px 60px rgba(0,0,0,0.25);
}
.pay-bridge-label {
    display: inline-block; margin-bottom: 8px; padding: 5px 10px; border-radius: 999px;
    background: rgba(8,14,28,0.55); border: 1px solid rgba(255,255,255,0.1);
    color: var(--gold); font-size: 0.7rem; font-weight: 800; letter-spacing: 1px; text-transform: uppercase;
}
.pay-bridge p { color: #c1cae0; margin: 0; font-size: 0.96rem; }
.pay-bridge-actions { display: flex; flex-wrap: wrap; gap: 10px; margin-top: 14px; }
.hero-stats {
...
/* === PLATFORM TRUTH (integrity) === */
.platform-section { padding: 56px 24px 72px; max-width: 1040px; margin: 0 auto; }
.platform-section .section-label { margin-bottom: 8px; }
.platform-hero-line { color: var(--text-dim); font-size: 0.95rem; max-width: 820px; line-height: 1.65; margin-bottom: 20px; }
.platform-card {
    background: linear-gradient(145deg, rgba(99,102,241,0.14), rgba(34,211,238,0.07));
...
.platform-card h3 { font-size: 1.2rem; color: #fff; margin-bottom: 10px; font-weight: 700; }
.platform-grid {
    display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 18px; margin-top: 22px;
}
.platform-col {
    background: rgba(10,14,26,0.55); border: 1px solid var(--border); border-radius: 14px; padding: 18px 18px 16px;
}
.platform-col h4 { font-size: 0.9rem; color: #fff; margin-bottom: 10px; font-weight: 600; }
.platform-col ul { list-style: none; font-size: 0.84rem; color: var(--text-dim); line-height: 1.65; }
.platform-col li { margin-bottom: 8px; padding-left: 14px; position: relative; }
.platform-col li::before { content: '\2022'; position: absolute; left: 0; color: var(--accent2); }
.platform-foot {
    font-size: 0.82rem; color: var(--text-dim); margin-top: 18px; line-height: 1.65; max-width: 920px;
}
.platform-actions { display: flex; flex-wrap: wrap; gap: 12px; margin-top: 18px; }
.feature-scope-note {
    font-size: 0.84rem; color: var(--text-dim); max-width: 900px; margin: 18px auto 0; text-align: center; line-height: 1.65;
}
/* === FAQ === */
...
.faq-item.open .faq-a { max-height: 2000px; padding-top: 12px; }
...
<div class="nav-inner">
    ...
    <div class="nav-links">
        ...
        <a href="/gohostme/roadmap">100-Level Roadmap</a>
        <a href="#platform-truth">Platform truth</a>
...
<!-- ============================================================ -->
<section class="hero">
    <div class="hero-eyebrow">&#128308; One North Star: Hosting + AI + Industry Apps</div>
    <h1>Cloud Hosting. AI Voice Agents. AI Call Centers. 12 Industry Solutions. One Platform.</h1>
    <p class="subtitle">GoHostMe is not generic commodity hosting. We combine serious infrastructure across 18 global regions with AI voice agents, AI call centers, AI office automation, and turn-key industry solutions — unified under one GoSiteMe account and the GoHostMe panel. We publish a public maturity roadmap because integrity matters: you should always know what is live today versus what we are still ascending toward. Powered by Canadian hydroelectricity where applicable. Pay with Stripe or PayPal.</p>
    <div class="hero-cta">
    ...
    <div class="pay-bridge">
        <span class="pay-bridge-label">Alfred Pay</span>
        <p>GoHostMe runs on one GoSiteMe account layer. Alfred Pay is the billing and customer-access hub for invoices, renewals, service lifecycle, and secure sign-in before you enter the hosting dashboard.</p>
        <div class="pay-bridge-actions">
            <a href="<?= htmlspecialchars($alfredPayLoginUrl, ENT_QUOTES) ?>" class="btn btn-gold">Sign In to Alfred Pay</a>
            <a href="<?= htmlspecialchars($alfredPayGoogleUrl, ENT_QUOTES) ?>" class="btn btn-outline">Continue with Google</a>
            <a href="/pay/" class="btn btn-cyan">What Is Alfred Pay?</a>
        </div>
    </div>
...
<!-- ============================================================ -->
<!-- PLATFORM TRUTH — shipped vs roadmap (integrity) -->
<!-- ============================================================ -->
<section class="platform-section" id="platform-truth">
    <div class="section-label">Platform truth</div>
    <h2 style="font-size:clamp(1.5rem,3vw,2rem); font-weight:800; margin-bottom:10px;">We would rather lose a sale than lie to you.</h2>
    <p class="platform-hero-line">GoHostMe is a real commercial platform with live billing, provisioning, and a growing panel. Some marketing pages in our industry imply every checkbox is finished on day one. We do not. The list below separates <strong style="color:#fff">what you can count on now</strong> from <strong style="color:#fff">what we are still building</strong> — aligned to our <a href="/gohostme/roadmap">100-level maturity ladder</a>.</p>
    <div class="platform-card">
        <span class="platform-pill">Integrity first</span>
        <h3>Live today vs ascending next</h3>
        <div class="platform-grid">
            <div class="platform-col">
                <h4>&#9989; Live / billing-backed today</h4>
                <ul>
                    <li>GoSiteMe billing-backed catalog, checkout, Stripe and PayPal</li>
                    <li>Service lifecycle in the customer account (what you paid for shows up)</li>
                    <li>GoHostMe panel entry for hosting services (SSO path where enabled)</li>
                    <li>AI and industry SKUs sold as real products (delivery varies by SKU)</li>
                    <li>Public roadmap page for expectations and ship order</li>
                </ul>
            </div>
            <div class="platform-col">
                <h4>&#128640; Ascending on the roadmap</h4>
                <ul>
                    <li>Full parity for every legacy control-panel surface (DNS/mail/files depth)</li>
                    <li>Every “266+ endpoint” story becomes true as APIs harden</li>
                    <li>Migration wizard depth and zero-downtime claims per workload type</li>
                    <li>Kubernetes, clustering, and advanced networking — where not already live for your SKU</li>
                    <li>Some free-tier flows may require staff review when fraud-prevention is enabled</li>
                </ul>
            </div>
        </div>
        <p class="platform-foot">If a feature matters to your migration, open a ticket and we will confirm it for <em>your</em> plan and region before you move production traffic. We answer to customers — and to conscience.</p>
        <div class="platform-actions">
            <a href="/gohostme/roadmap" class="btn btn-primary">Open the 100-level roadmap</a>
            <a href="/gohostme/products" class="btn btn-outline">Browse the full catalog</a>
            <a href="https://gositeme.com/cart?a=add&pid=102" class="btn btn-outline">Deploy VPS — $59.99/mo</a>
        </div>
    </div>
</section>
...
<section class="manifesto">
    ...
    <p>Many hosts stop at "here is a server." GoHostMe is built for operators who want AI products and industry workflows alongside infrastructure — managed through the GoHostMe panel and the broader GoSiteMe ecosystem. We are unusually ambitious, and we are honest about the climb: compare our <a href="#platform-truth">platform truth</a> and <a href="/gohostme/roadmap">100-level roadmap</a> before you buy.</p>
...
<section class="section" id="features">
    ...
    <p class="sub">The GoHostMe panel is included on eligible VPS, dedicated, and GPU plans at the advertised price — no separate panel license line-item. Individual tools below roll out by maturity level; see <a href="#platform-truth">platform truth</a> and the <a href="/gohostme/roadmap">roadmap</a> for depth per capability.</p>
    <div class="features-grid">
        <div class="feature-card"><div class="feature-icon">&#127760;</div><h3>Domain Management</h3><p>DNS and domain workflows we ship toward full parity; depth expands as the panel ascends the roadmap ladder.</p></div>
        <div class="feature-card"><div class="feature-icon">&#128231;</div><h3>Email Server</h3><p>SPF/DKIM/DMARC guidance plus hosted email SKUs; advanced mailbox automation follows the roadmap.</p></div>
        ...
        <div class="feature-card"><div class="feature-icon">&#128204;</div><h3>AI Migration Wizard</h3><p>Guided migrations from common panels and SSH sources; downtime window depends on workload — we confirm per ticket.</p></div>
        <div class="feature-card"><div class="feature-icon">&#129302;</div><h3>266+ REST API Endpoints</h3><p>Automation surface we are converging on; public contracts ship as endpoints graduate from internal to stable.</p></div>
        <div class="feature-card"><div class="feature-icon">&#128101;</div><h3>Multi-Server Clustering</h3><p>Multi-server operations and failover patterns roll out by SKU; ask sales for what is live for your footprint today.</p></div>
        <div class="feature-card"><div class="feature-icon">&#129497;</div><h3>Managed Kubernetes</h3><p>Managed Kubernetes is a catalog direction; availability follows the roadmap and your selected region.</p></div>
    </div>
    <p class="feature-scope-note">Capability matrix above describes our target architecture. Coverage depends on plan, region, and current ladder level — we would rather under-promise in copy than over-promise in production.</p>
</section>
...
<section class="section" id="regions" style="padding-bottom:40px;">
    ...
    <p class="sub">Deploy where your users are. Catalog coverage varies by SKU and datacenter — checkout confirms what is available for your plan. vRack-style private networking is part of our target architecture across regions.</p>
...
<section style="padding:60px 24px; max-width:1100px; margin:0 auto;" id="compare">
    ...
    <p class="sub" style="margin-bottom:32px;">We build to replace fragile stacks — with engineering discipline and honest milestones.</p>
    ...
    <p style="text-align:center; margin-top:20px; color:var(--text-dim); font-size:0.85rem;">
        <strong style="color:var(--green);">Directionally true.</strong> This table compares positioning categories, not a third-party audit of every competitor SKU. For what is live for <em>you</em> today, read <a href="#platform-truth">platform truth</a> and the <a href="/gohostme/roadmap">roadmap</a>.
    </p>
</section>
...
<section class="ai-section" id="ai-solutions">
    <div style="max-width:1200px; margin:0 auto;">
        <div class="section-label" style="text-align:center;">What Makes GoHostMe Different</div>
        ...
        <p style="text-align:center; color:var(--text-dim); max-width:650px; margin:0 auto 40px; font-size:1rem;">Few traditional hosts bundle AI voice, call center, office automation, and industry packages the way GoSiteMe does. That combination is our wedge — shipped as real SKUs, improved continuously, and documented on the roadmap.</p>
...
<section class="guarantee-section">
    ...
    <div class="guarantee-grid">
        ...
        <div class="guarantee-item">
            ...
            <p>We help migrate sites, databases, and email where supported. Downtime window depends on complexity — we plan it with you.</p>
        </div>
        <div class="guarantee-item">
            <div class="icon">&#128176;</div>
...
<section class="api-section" id="api">
    ...
    <h2 style="font-size:clamp(1.6rem,3vw,2.2rem); font-weight:700; margin-bottom:16px;">APIs and automation — converging to full coverage.</h2>
    <p class="sub">We treat APIs as a first-class product: authentication, webhooks, and stable contracts as endpoints graduate. The sample below is illustrative of the developer experience we are standardizing — verify the live contract in your account docs or support before production automation.</p>
...
<span class="comment">// { "id": "srv-abc123", "ip": "15.235.x.x", "status": "active" }</span>
    ...
    <p class="feature-scope-note" style="margin-top:16px;">Endpoint counts and paths evolve as services harden. If you need a guarantee for CI/CD today, ask us to confirm the exact routes available on your plan.</p>
...
<section class="section" id="ecosystem" style="text-align:center;">
    ...
    <p class="sub" style="margin:0 auto 32px;">GoHostMe is part of the GoSiteMe ecosystem — one account unlocks the products you subscribe to (hosting, AI, media, IDE, and more as enabled on your account).</p>
    ...
    <div class="eco-grid">
        <div class="eco-card">
            ...
            <a href="/alfred-ide.php" class="btn btn-outline" style="font-size:0.82rem;">Visit &rarr;</a>
        </div>
        <div class="eco-card">
            <div class="eco-icon">&#127918;</div>
            <h4>MetaDome</h4>
        ...
        <div class="eco-card">
            <div class="eco-icon">&#129302;</div>
            <h4>Alfred AI</h4>
            <p>50 million agents across the GoSiteMe ecosystem. 13,000+ tools. The world's largest sovereign AI fleet.</p>
...
<section class="section" id="faq">
    ...
    <div class="faq-list">
        <div class="faq-item">
            ...
            <div class="faq-a">On eligible VPS, dedicated, and GPU plans, the GoHostMe panel is included at the advertised price — there is no separate panel license fee in the cart for those SKUs. Individual panel modules mature over time; see <a href="#platform-truth">platform truth</a> and the <a href="/gohostme/roadmap">roadmap</a> for depth by capability.</div>
        </div>
        <div class="faq-item">
        ...
        <div class="faq-item">
            ...
            <div class="faq-a">Yes, for many common stacks. Migration scope, tooling, and downtime window depend on providers, size, and email/DNS complexity. Business-and-above plans include migration assistance; we schedule a plan with you rather than promising impossible universals.</div>
        </div>
        <div class="faq-item">
            <div class="faq-q">What's the difference between you and DigitalOcean / Hetzner?</div>
            <div class="faq-a">We bundle a GoSiteMe-style product catalog (hosting + AI + industries) with GoSiteMe billing-backed checkout and a single account model. Hyperscalers and specialty clouds differ by tradeoffs; we differentiate on the combined catalog and roadmap transparency — not on pretending we are AWS.</div>
        </div>
        <div class="faq-item">
        ...
        <div class="faq-item">
            ...
            <div class="faq-a">Yes — as real, billable SKUs with speech intelligence and telephony workflows designed for businesses. Exact capabilities depend on the product tier you purchase. We do not claim exclusivity; we claim integration: voice + hosting + billing under one GoSiteMe ecosystem.</div>
        </div>
        <div class="faq-item">
            <div class="faq-q">What is live in the panel versus on the roadmap?</div>
            <div class="faq-a">Billing, provisioning, and account services are production paths today. Deep legacy-style hosting automation (every DNS/mail/files edge case) is staged on our public <a href="/gohostme/roadmap">100-level roadmap</a>. Read <a href="#platform-truth">platform truth</a> before you migrate mission-critical workloads.</div>
        </div>
        <div class="faq-item">
            <div class="faq-q">Why might my order say it is waiting for review?</div>
            <div class="faq-a">For fraud prevention and platform safety, some free or high-risk flows can require a human staff confirmation before final activation. This is optional per environment — if it applies, you will see it in your account status and emails.</div>
        </div>
        <div class="faq-item">
            <div class="faq-q">Why publish a &quot;100-level&quot; ladder at all?</div>
            <div class="faq-a">Because customers deserve a compass, not a fog machine. The ladder is our internal and external alignment tool: it forces us to name what is shipped, what is next, and what &quot;done&quot; means for each capability.</div>
        </div>
        <div class="faq-item">
...
<section class="cta-section">
    ...
    <p>101+ products across the catalog. 18 global regions on the map. AI voice, call center, and industry SKUs when you need them. Check <a href="#platform-truth">platform truth</a> for live depth, then deploy when you are ready — many VPS plans provision quickly.</p>
...
<footer class="footer">
    <div class="footer-grid">
        ...
        <div>
            ...
            <a href="/alfred-ide.php">Alfred IDE — AI IDE</a>
