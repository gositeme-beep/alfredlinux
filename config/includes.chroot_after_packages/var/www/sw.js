...
self.addEventListener('fetch', event => {
  ...
  // Never intercept voice-live and middleware transport endpoints.
  // This avoids stale media/session errors and lets range requests stream correctly.
  if (url.pathname.startsWith('/alfred-voice-live/')) return;
  if (url.pathname.startsWith('/middleware/')) return;
