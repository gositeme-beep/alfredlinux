...
$page_canonical = 'https://root.com/energy-experiments.php';
...
<div class="ex-page">
    ...
    <div class="ex-search-wrap">
        ...
        <button class="ex-suggest-btn" onclick="window.open('mailto:support@root.com?subject=Experiment%20Suggestion&body=Experiment%20Name:%0AResearcher:%0ADescription:%0AFormula:%0AReferences:','_blank')"><i class="fa-solid fa-plus"></i> Suggest Experiment</button>
    </div>
