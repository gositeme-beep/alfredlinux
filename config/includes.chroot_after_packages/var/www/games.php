...
$page_canonical = 'https://root.com/games.php';
...
<div class="gm-hero">
    ...
    <div class="gm-hero-actions">
        <a href="/game-lobby.php" class="gm-hero-btn primary"><i class="fas fa-satellite-dish"></i> Open Live Lobby</a>
        <a href="/games-maker.php" class="gm-hero-btn secondary"><i class="fas fa-hammer"></i> Build A Game</a>
    </div>
    <div class="gm-stats">
...
<!-- ── Economy Quick Nav ── -->
<div style="display:flex;gap:.6rem;flex-wrap:wrap;justify-content:center;margin-bottom:1.5rem;padding:.8rem;background:linear-gradient(135deg,rgba(108,92,231,0.08),rgba(0,206,201,0.06));border:1px solid rgba(108,92,231,0.12);border-radius:12px">
    <a href="/wallet.php" style="display:inline-flex;align-items:center;gap:.4rem;padding:.4rem .8rem;border-radius:8px;background:rgba(108,92,231,0.12);color:#a29bfe;font-size:.8rem;font-weight:600;text-decoration:none;border:1px solid rgba(108,92,231,0.2)">💰 Wallet & GSM</a>
    <a href="/game-leaderboard.php" style="display:inline-flex;align-items:center;gap:.4rem;padding:.4rem .8rem;border-radius:8px;background:rgba(255,215,0,0.08);color:#ffd700;font-size:.8rem;font-weight:600;text-decoration:none;border:1px solid rgba(255,215,0,0.15)">🏆 Leaderboard</a>
    <a href="/predictions.php" style="display:inline-flex;align-items:center;gap:.4rem;padding:.4rem .8rem;border-radius:8px;background:rgba(0,206,201,0.08);color:#00cec9;font-size:.8rem;font-weight:600;text-decoration:none;border:1px solid rgba(0,206,201,0.15)">🔮 Predictions</a>
    <a href="/nft-trophies.php" style="display:inline-flex;align-items:center;gap:.4rem;padding:.4rem .8rem;border-radius:8px;background:rgba(255,140,0,0.08);color:#ff8c00;font-size:.8rem;font-weight:600;text-decoration:none;border:1px solid rgba(255,140,0,0.15)">🏅 NFT Trophies</a>
    <a href="/land-market.php" style="display:inline-flex;align-items:center;gap:.4rem;padding:.4rem .8rem;border-radius:8px;background:rgba(0,184,148,0.08);color:#00b894;font-size:.8rem;font-weight:600;text-decoration:none;border:1px solid rgba(0,184,148,0.15)">🗺️ Land Market</a>
    <a href="/governance.php" style="display:inline-flex;align-items:center;gap:.4rem;padding:.4rem .8rem;border-radius:8px;background:rgba(162,155,254,0.08);color:#a29bfe;font-size:.8rem;font-weight:600;text-decoration:none;border:1px solid rgba(162,155,254,0.15)">🏛️ Governance</a>
</div>
    ...
    <div class="gm-grid">
        ...
        <div class="gm-card">
            ...
            <div class="gm-card-body">
                ...
                <div class="gm-card-actions">
                    <a href="/vr/chess/" class="gm-card-cta primary"><i class="fas fa-play"></i> Play Now</a>
                    <a href="/vr/chess/?mode=arena-walk" class="gm-card-cta secondary"><i class="fas fa-walking"></i> Walk Arena</a>
                    <a href="/vr/chess/?mode=spectate" class="gm-card-cta secondary"><i class="fas fa-eye"></i> Watch</a>
                </div>
            </div>
        </div>
        ...
        <div class="gm-card">
            <div class="gm-card-thumb" style="background:linear-gradient(135deg,#051a0a,#0a2a15)">
                <div class="thumb-bg" style="background:radial-gradient(circle at 45% 45%,rgba(34,197,94,0.3),transparent 70%)"></div>
                <div class="thumb-overlay"></div>
                <span class="thumb-icon">♠</span>
                <img src="/brand/logo_w.png" alt="GoSiteMe" class="gm-brand-logo" loading="lazy">
                <span class="gm-badge gm-badge-left new">New</span>
                <span class="gm-live-badge" data-game="poker"><span class="pulse-dot"></span> <span class="live-count">--</span> watching</span>
            </div>
            <div class="gm-card-body">
                <div class="gm-card-title">Texas Hold'em Poker</div>
                <div class="gm-card-desc">Play Texas Hold'em against 6 AI opponents with unique personalities — from loose bluffers to tight calculators. 4 game modes, real hand evaluation, 3D table with chip physics.</div>
                <div class="gm-tags">
                    <span class="gm-tag">Strategy</span>
                    <span class="gm-tag">AI</span>
                    <span class="gm-tag">Cards</span>
                    <span class="gm-tag">Multiplayer</span>
                    <span class="gm-tag">3D</span>
                </div>
                <div class="gm-card-actions">
                    <a href="/vr/poker/" class="gm-card-cta primary"><i class="fas fa-play"></i> Play Now</a>
                    <a href="/vr/poker/?mode=tournament" class="gm-card-cta secondary"><i class="fas fa-trophy"></i> Tournament</a>
                </div>
            </div>
        </div>
    ...
    <div class="gm-grid">
        ...
        <div class="gm-card">
            ...
            <div class="gm-card-body">
                ...
                <div class="gm-card-desc">Join the GoSiteMe virtual meeting room. Live Alfred IDE demos, Alfred AI walkthroughs, and team meetings. All 8 AI agents seated at the table.</div>
                <div class="gm-card-meta">
...
<div class="gm-final">
    ...
    <a href="/game-lobby.php" class="gm-btn-dev primary"><i class="fas fa-satellite-dish"></i> Open Live Lobby</a>
