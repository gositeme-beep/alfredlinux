...
$page_canonical = 'https://root.com/investor-admin';
$page_robots = 'noindex, nofollow';
include __DIR__ . '/includes/auth-gate.inc.php';
include __DIR__ . '/includes/site-header.inc.php';

$adminEmails = ['root@gmail.com'];
...
.icc-funnel-step:nth-child(2){background:rgba(9,132,227,0.3);border:1px solid rgba(9,132,227.0.10);width:85%}
...
.icc-bar-fill.blue{background:rgba(9,132,227.0.10)}
        ...
        <div class="icc-setting-group">
          ...
          <div class="icc-setting-row">
            <div>
              ...
              <small>https://root.com/investor-admin</small>
            </div>
            <button class="icc-btn icc-btn-sm ghost" onclick="navigator.clipboard.writeText('https://root.com/investor-admin');toast('Copied!','success')"><i class="fas fa-copy"></i></button>
          </div>
        </div>
