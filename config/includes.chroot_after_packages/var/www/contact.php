...
$page_canonical = 'https://root.com/contact';
$page_og_title = 'Contact GoSiteMe — We\'re Here to Help';
$page_og_description = 'Get in touch with GoSiteMe. Support, sales, partnerships. Phone: +1 (807) 798-2850. Email: support@root.com. Or chat with Alfred AI 24/7.';
...
<section>
    <div class="contact-grid">
        ...
        <div class="contact-info">
                ...
                <a href="mailto:alfred@root.com">alfred@root.com</a> — Email Alfred<br>
            ...
            <div class="contact-card">
                ...
                <p><a href="mailto:support@root.com">support@root.com</a> — Support<br>
                <a href="mailto:sales@root.com">sales@root.com</a> — Sales & Pricing<br>
                <a href="mailto:partners@root.com">partners@root.com</a> — Partnerships</p>
            </div>
            <div class="contact-card">
...
<script type="application/ld+json">
{
    ...
    "mainEntity": {
        ...
        "contactPoint": [
            ...
            {"@type": "ContactPoint", "email": "alfred@root.com", "contactType": "AI assistant", "availableLanguage": ["English", "French"]},
            {"@type": "ContactPoint", "email": "sales@root.com", "contactType": "sales", "availableLanguage": ["English", "French"]}
        ]
    }
}
</script>
