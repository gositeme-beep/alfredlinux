...
$page_canonical = 'https://root.com/chronicles';
...
<div class="rc-wrap">
    ...
    <div class="rc-grid" data-division="crypto">
        <a href="/veil/" class="rc-card" style="--card-accent:linear-gradient(90deg,var(--rc-purple),var(--rc-cyan));">
    ...
    <div class="rc-grid" data-division="ai">
        ...
        <a href="/search.php" class="rc-card" style="--card-accent:linear-gradient(90deg,var(--rc-cyan),var(--rc-blue));">
            ...
            <p class="rc-card-abstract">A complete search engine built from scratch using instant-search indexing and AI-powered deep research — with zero tracking, AI-powered result synthesis, voice search, and deep research mode. In a world where every search engine monetizes your data, Alfred Search returns results without recording who asked or what they found.</p>
            <div class="rc-card-innovations">
                <span class="rc-innov">Instant Search</span>
    ...
    <div class="rc-grid" data-division="tools">
        <a href="/gocodeme.php" class="rc-card" style="--card-accent:linear-gradient(90deg,#00a8ff,#00d4ff);">
            <div class="rc-card-header">
                <h3 class="rc-card-title">Alfred IDE: The Impossible Architecture</h3>
                <span class="rc-card-badge badge-live">Live</span>
            </div>
