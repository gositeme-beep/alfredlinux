...
$pageDescription = "Claim your personal subdomain on root.com";
...
<div class="sd-page">
    <div class="sd-hero">
        ...
        <p>Claim your personal address on GoSiteMe — <strong>yourname.root.com</strong></p>
    </div>
    ...
    <div class="sd-claim-box">
        ...
        <div class="sd-input-row">
            ...
            <span class="sd-suffix">.root.com</span>
...
(function() {
    ...
    nameInput.addEventListener('input', () => {
        ...
        if (val.length >= 2) {
            ...
            previewUrl.textContent = 'https://' + val + '.root.com';
        } else {
    ...
    window.releaseSubdomain = async function(name) {
        if (!confirm('Release ' + name + '.root.com? This cannot be undone.')) return;
