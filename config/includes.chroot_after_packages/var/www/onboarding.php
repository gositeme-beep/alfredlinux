...
<script>
window.ONBOARDING_CSRF_TOKEN = '<?= htmlspecialchars($_SESSION['csrf_token'], ENT_QUOTES, 'UTF-8') ?>';
</script>
<script src="/assets/js/onboarding-engine.js?v=<?= urlencode((string) @filemtime(__DIR__ . '/assets/js/onboarding-engine.js')) ?>"></script>
</body>
</html>
