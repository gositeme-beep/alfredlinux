...
<div class="container">
    ...
    <div class="app-section">
        ...
        <div class="dl-grid">
            <a href="https://root.com/downloads/Alfred-Browser-3.0.0-win-x64.zip.torrent" class="dl-card">
            ...
            <a href="https://root.com/downloads/Alfred-Browser-3.0.0-mac-intel.zip.torrent" class="dl-card">
            ...
            <a href="https://root.com/downloads/Alfred-Browser-3.0.0-mac-arm64.zip.torrent" class="dl-card">
                <div class="icon" style="background:rgba(255,255,255,0.04);color:#fff;">🍎</div>
                <div class="info"><h4>macOS Apple Silicon</h4><span>.torrent · ARM64 · M-series</span></div>
                <span class="arrow">🧲</span>
            </a>
            <a href="https://root.com/downloads/Alfred-Browser-3.0.0.AppImage.torrent" class="dl-card">
            ...
            <a href="https://root.com/downloads/alfred-browser_3.0.0_amd64.deb.torrent" class="dl-card">
            ...
            <a href="https://root.com/downloads/Alfred-Browser.apk.torrent" class="dl-card">
        ...
        <a href="https://root.com/alfred-browser" class="cross-link">→ Full feature showcase & hashes</a>
    </div>
    ...
    <div class="app-section">
        ...
        <div class="dl-grid">
            <a href="https://root.com/downloads/Veil-Messenger-1.0.0.AppImage.torrent" class="dl-card">
                <div class="icon" style="background:rgba(251,191,36,0.1);color:#fbbf24;">🐧</div>
                <div class="info"><h4>Linux AppImage</h4><span>.torrent · x64 · 88 MB</span></div>
                <span class="arrow">🧲</span>
            </a>
            <a href="https://root.com/downloads/veil-messenger_1.0.0_amd64.deb.torrent" class="dl-card">
                <div class="icon" style="background:rgba(221,72,20,0.1);color:#dd4814;">🐧</div>
                <div class="info"><h4>Ubuntu / Debian</h4><span>.torrent · .deb x64</span></div>
                <span class="arrow">🧲</span>
            </a>
            <a href="https://root.com/downloads/veil-messenger-1.0.0-x86_64.rpm.torrent" class="dl-card">
            ...
            <a href="https://root.com/downloads/GoSiteMe-Veil.apk.torrent" class="dl-card">
                <div class="icon" style="background:rgba(52,211,153,0.1);color:#34d399;">📱</div>
                <div class="info"><h4>Android</h4><span>.torrent · APK · 8.0+</span></div>
                <span class="arrow">🧲</span>
            </a>
            <a href="https://root.com/veil/" class="dl-card">
    ...
    <div class="app-section">
        ...
        <div class="dl-grid">
            <a href="https://root.com/downloads/Pulse-Social-1.0.0.AppImage.torrent" class="dl-card">
                <div class="icon" style="background:rgba(251,191,36,0.1);color:#fbbf24;">🐧</div>
                <div class="info"><h4>Linux AppImage</h4><span>.torrent · x64 · 88 MB</span></div>
                <span class="arrow">🧲</span>
            </a>
            <a href="https://root.com/downloads/pulse-social_1.0.0_amd64.deb.torrent" class="dl-card">
                <div class="icon" style="background:rgba(221,72,20,0.1);color:#dd4814;">🐧</div>
                <div class="info"><h4>Ubuntu / Debian</h4><span>.torrent · .deb x64</span></div>
                <span class="arrow">🧲</span>
            </a>
            <a href="https://root.com/downloads/pulse-social-1.0.0-x86_64.rpm.torrent" class="dl-card">
                <div class="icon" style="background:rgba(239,68,68,0.1);color:#ef4444;">🐧</div>
                <div class="info"><h4>Fedora / RHEL</h4><span>.torrent · .rpm x64</span></div>
                <span class="arrow">🧲</span>
            </a>
            <a href="https://root.com/downloads/Pulse-Social.apk.torrent" class="dl-card">
                <div class="icon" style="background:rgba(52,211,153,0.1);color:#34d399;">📱</div>
                <div class="info"><h4>Android</h4><span>.torrent · APK · 8.0+</span></div>
                <span class="arrow">🧲</span>
            </a>
            <a href="https://root.com/pulse" class="dl-card">
    ...
    <div class="app-section">
        ...
        <div class="dl-grid">
            <a href="https://root.com/alfred-ide/" class="dl-card">
            ...
            <a href="https://root.com/downloads/alfred-ide/Alfred-IDE-Windows-x64.zip.torrent" class="dl-card">
                <div class="icon" style="background:rgba(59,130,246,0.1);color:#3b82f6;">🪟</div>
                <div class="info"><h4>Windows</h4><span>.torrent · x64 Portable · 194 MB</span></div>
                <span class="arrow">🧲</span>
            </a>
            <a href="https://root.com/downloads/alfred-ide/alfred-ide-2.1.0-linux-amd64.deb.torrent" class="dl-card">
                <div class="icon" style="background:rgba(221,72,20,0.1);color:#dd4814;">🐧</div>
                <div class="info"><h4>Linux .deb</h4><span>.torrent · x64 · 80 MB</span></div>
                <span class="arrow">🧲</span>
            </a>
        </div>
        <a href="https://root.com/alfred-ide.php" class="cross-link">→ Alfred IDE launch page</a>
    </div>
    ...
    <div class="notice">
        ...
        <a href="https://root.com/downloads/SHA256SUMS.txt">SHA256SUMS.txt</a>.<br><br>
...
<footer style="text-align:center;padding:1.5rem;color:#94a3b8;font-size:.85rem;border-top:1px solid rgba(255,255,255,0.06);">
    <p style="color:#94a3b8;font-style:italic;font-size:.85rem;margin:0 0 0.75rem;">&ldquo;The grass withereth, the flower fadeth: but the word of our God shall stand for ever.&rdquo; &mdash; <a href="https://root.com/bible/read/isaiah/40" style="color:#facc15;text-decoration:none;">Isaiah 40:8</a> (AKJV)</p>
    &copy; <?= date('Y') ?> <a href="https://root.com" style="color:#6366f1;text-decoration:none;">GoSiteMe Inc.</a> &mdash; Alfred Linux &middot; Open Source (AGPL-3.0)
</footer>
