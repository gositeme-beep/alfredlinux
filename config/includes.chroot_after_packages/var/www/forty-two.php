...
$blocks = [
    [
        ...
        'gen'      => [
            ...
            ['Phares',      'Genesis 38',   'פֶּרֶץ'],
            ['Esrom',       'Ruth 4:18',    'חֶצְרוֹן'],
            ['Aram',        'Ruth 4:19',    'רָם'],
            ['Aminadab',    'Ruth 4:19',    'עַמִּינָדָב'],
            ['Naasson',     'Ruth 4:20',    'נַחְשׁוֹן'],
            ['Salmon',      'Ruth 4:20',    'שַׂלְמוֹן'],
            ['Booz',        'Ruth 4:21',    'בֹּעַז'],
    ...
    [
        ...
        'gen'      => [
            ...
            ['Roboam',      '1 Kings 11:43',     'רְחַבְעָם'],
            ['Abia',        '1 Kings 14:31',     'אֲבִיָּם'],
            ['Asa',         '1 Kings 15:8',      'אָסָא'],
            ['Josaphat',    '1 Kings 15:24',     'יְהוֹשָׁפָט'],
            ['Joram',       '1 Kings 22:50',     'יְהוֹרָם'],
            ['Ozias',       '2 Kings 15:1',      'עֻזִּיָּהוּ'],
            ['Joatham',     '2 Kings 15:32',     'יוֹתָם'],
            ['Achaz',       '2 Kings 16',        'אָחָז'],
            ['Ezekias',     '2 Kings 18',        'חִזְקִיָּהוּ'],
            ['Manasses',    '2 Kings 21',        'מְנַשֶּׁה'],
            ['Amon',        '2 Kings 21:18',     'אָמוֹן'],
            ['Josias',      '2 Kings 22',        'יֹאשִׁיָּהוּ'],
            ['Jechonias',   '2 Kings 24',        'יְכָנְיָה'],
        ],
    ],
    [
        ...
        'gen'      => [
            ['Salathiel',   'Ezra 3:2',          'שְׁאַלְתִּיאֵל'],
            ['Zorobabel',   'Ezra 3:8',          'זְרֻבָּבֶל'],
            ['Abiud',       'Matthew 1:13',      'אֲבִיהוּד'],
            ['Eliakim',     'Matthew 1:13',      'אֶלְיָקִים'],
            ['Azor',        'Matthew 1:13',      'עֲזּוּר'],
            ['Sadoc',       'Matthew 1:14',      'צָדוֹק'],
            ['Achim',       'Matthew 1:14',      'אָכִים'],
            ['Eliud',       'Matthew 1:14',      'אֱלִיהוּד'],
...
<meta property="og:url"         content="https://alfredlinux.com/forty-two.php">
<style>
:root {
  --gold: #ffd700;
  --gold-dim: #c8a02b;
...
<section class="invite">
  ...
  <a href="/bible/matthew/1">Read Matthew 1</a>
  <a href="/pillars.php">The Nine Pillars</a>
</section>
