...
if (isset($_GET['emergency'])) {
    ...
    echo '<!DOCTYPE html><html><head><meta charset="utf-8"><title>New Tab</title></head><body style="margin:0;background:#fff"><script>try{localStorage.setItem("root:logout", String(Date.now()));}catch(e){}try{history.replaceState(null,"","/");}catch(e){}document.title="New Tab";window.location.replace("about:blank");</script></body></html>';
    exit;
}
echo '<!DOCTYPE html><html><head><meta charset="utf-8"><meta http-equiv="refresh" content="0;url=/login.php?logged_out=1"><title>Signing Out</title></head><body><script>try{localStorage.setItem("root:logout", String(Date.now()));}catch(e){}window.location.replace("/login.php?logged_out=1");</script></body></html>';
exit;
