...
$page_canonical   = 'https://root.com/developer-portal.php';
...
.dp-builder-card {
    ...
    padding: 20px 18px;
    text-align: left;
    transition: transform var(--dp-transition), border-color var(--dp-transition), box-shadow var(--dp-transition);
}

.dp-builder-card:hover {
    transform: translateY(-3px);
    border-color: rgba(108,92,231,.22);
    box-shadow: 0 12px 32px rgba(0,0,0,.22);
}

.dp-builder-card__label {
    display: inline-flex;
    align-items: center;
    gap: 8px;
    margin-bottom: 10px;
...
@media (max-width: 768px) {
    ...
    .dp-builder-strip { grid-template-columns: repeat(2, minmax(0, 1fr)); }
...
@media (max-width: 480px) {
    ...
    .dp-builder-strip { grid-template-columns: 1fr; }
    ...
    <section class="dp-hero" aria-labelledby="dp-hero-title">
        <div class="dp-container">
            ...
            <div class="dp-hero__actions" data-aos="fade-up" data-aos-delay="300">
                <a href="/alfred-ide.php" class="dp-btn"><i class="fas fa-code"></i> Open Alfred IDE</a>
                <a href="#api-keys" class="dp-btn"><i class="fas fa-key"></i> Get API Key</a>
                <a href="/docs/quickstart.php" class="dp-btn dp-btn--ghost"><i class="fas fa-rocket"></i> 60s Quickstart</a>
            ...
            <div class="dp-builder-strip" data-aos="fade-up" data-aos-delay="350">
                <a href="/alfred-ide.php" class="dp-builder-card">
                    <span class="dp-builder-card__label"><i class="fas fa-terminal"></i> Build</span>
                    <h3>Start In Alfred IDE</h3>
                    <p>Use the official browser IDE to write, test, and ship inside the GoSiteMe platform with Alfred built directly into the workflow.</p>
                </a>
                <a href="/sdks" class="dp-builder-card">
                    <span class="dp-builder-card__label"><i class="fas fa-laptop-code"></i> SDKs</span>
                    <h3>Install The Client Libraries</h3>
                    <p>Start quickly with the official Node.js, Python, PHP, and Game Engine SDK surfaces instead of wiring raw requests by hand.</p>
                </a>
                <a href="/extensions.php" class="dp-builder-card">
                    <span class="dp-builder-card__label"><i class="fas fa-puzzle-piece"></i> Extensions</span>
                    <h3>Bring Alfred Everywhere</h3>
                    <p>Route developers into Chrome, VS Code, CLI, and integration surfaces so the builder story extends beyond the portal page.</p>
                </a>
                <a href="/docs/getting-started" class="dp-builder-card">
                    <span class="dp-builder-card__label"><i class="fas fa-compass"></i> Onboarding</span>
                    <h3>Follow The Fastest Path</h3>
                    <p>Use the getting-started and API reference docs when you want the shortest route from key generation to first useful integration.</p>
                </a>
                <a href="https://alfredlinux.com/forge/explore/repos" class="dp-builder-card" target="_blank">
                    <span class="dp-builder-card__label"><i class="fas fa-code-branch"></i> Source</span>
                    <h3>Browse GoForge Repos</h3>
                    <p>Explore our public source code on GoForge — Alfred Linux build system, Commander extension, AI agent runtime, and more.</p>
                </a>
            </div>
            <div class="dp-hero__code" data-aos="fade-up" data-aos-delay="400">
                <div class="dp-hero__code-header">
                    ...
                    <pre id="hero-curl"><span class="c-cmd">curl</span> <span class="c-flag">-X POST</span> <span class="c-url">https://root.com/api/v1/chat</span> \
        ...
        <div class="dp-container">
            ...
            <div class="dp-api-grid">
                ...
                <article class="dp-api-card" data-aos="fade-up" data-aos-delay="475">
                    ...
                    <ul>
                        <li>6 providers: Native (170), MCP (807), External MCP (1,200+), App Hub (11,000+), Voice (85), Marketplace</li>
                ...
                <article class="dp-api-card" data-aos="fade-up" data-aos-delay="490">
                    ...
                    <ul>
                        ...
                        <li>Music (MusicGen) & TTS (F5-TTS, Alfred Premium, Cloud TTS)</li>
                    </ul>
                ...
                <article class="dp-api-card" data-aos="fade-up" data-aos-delay="498">
                    ...
                    <a href="/docs/api-reference#app-hub" class="dp-api-card__link">View Docs →</a>
                </article>
...
<span class="c-fn">print</span>(response.message)</pre>
                ...
                <div class="dp-sdk-card" data-aos="fade-up" data-aos-delay="300">
                    <div class="dp-sdk-card__header">
                        ...
                        <span class="dp-sdk-card__install">composer require root/alfred-ai</span>
        ...
        <div class="dp-container">
            ...
            <div class="dp-keys" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="dp-keys__empty">
                    ...
                    <a href="/alfred-ide-auth.php" class="dp-btn"><i class="fas fa-user-plus"></i> Create Free Account</a>
                </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <section class="dp-section" id="playground" aria-labelledby="dp-play-title">
        <div class="dp-container">
            <div class="dp-section-header">
                ...
                <p class="dp-section-sub" data-aos="fade-up" data-aos-delay="150">Test the live same-origin <code>/api/v1</code> endpoints. Enter your API key, pick a current resource, and send a request.</p>
            </div>
                ...
                <div class="dp-playground__wrap">
                    <div class="dp-playground__toolbar">
                        <select class="dp-playground__select" id="dp-pg-endpoint" aria-label="Select endpoint">
                            <option value="GET /api/v1/tools">GET /api/v1/tools</option>
                            <option value="POST /api/v1/chat" selected>POST /api/v1/chat</option>
                            <option value="GET /api/v1/agents">GET /api/v1/agents</option>
                            <option value="POST /api/v1/fleets">POST /api/v1/fleets</option>
                            <option value="POST /api/v1/agents">POST /api/v1/agents</option>
                            <option value="GET /api/v1/fleets">GET /api/v1/fleets</option>
                            <option value="POST /api/v1/voice/rooms">POST /api/v1/voice/rooms</option>
                            <option value="GET /api/v1/voice/calls">GET /api/v1/voice/calls</option>
                            <option value="GET /api/v1/usage">GET /api/v1/usage</option>
                            <option value="GET /api/v1/marketplace">GET /api/v1/marketplace</option>
                        </select>
    ...
    <section class="dp-cta" aria-labelledby="dp-cta-title">
        <div class="dp-container">
            ...
            <div data-aos="fade-up" data-aos-delay="200">
                <a href="/alfred-ide-auth.php" class="dp-btn"><i class="fas fa-rocket"></i> Get Started Free</a>
            </div>
        </div>
    </section>
