...
$isAlfredSearchHost = in_array($host, ['alfred-search.com', 'www.alfred-search.com'], true);
...
$page_canonical = $isAlfredSearchHost ? 'https://' . $host . '/' : 'https://root.com/search';
...
<script type="application/ld+json">
{
  ...
  "url": "https://root.com/search.php",
  "description": "Zero-tracking AI search engine with 7 search modes. No cookies, no profiles, no data selling.",
  "offers": { "@type": "Offer", "price": "0", "priceCurrency": "USD" },
  "author": { "@type": "Organization", "name": "GoSiteMe", "url": "https://root.com" },
  "featureList": ["Zero Tracking", "7 Search Modes", "AI-Powered Results", "No Cookies", "No Profile Building", "Privacy by Design"]
}
</script>
    ...
    <div class="as-main">
        ...
        <div class="as-landing" id="asLanding">
            ...
            <div class="as-ecosystem">
                ...
                <a href="/veil/" class="as-eco-link"><i class="fas fa-atom"></i> Veil</a>
