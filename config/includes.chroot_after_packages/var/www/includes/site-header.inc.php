...
if (!isset($page_canonical)) $page_canonical = 'https://root.com/';
if (!isset($page_og_url)) $page_og_url = $page_canonical;
if (!isset($page_og_image)) $page_og_image = 'https://root.com/assets/hero-banner.png';
...
$canonical_no_query = rtrim(preg_replace('#\?.*$#', '', $page_canonical), '/') ?: 'https://root.com';
?>
<!DOCTYPE html>
<html lang="<?php echo htmlspecialchars($html_lang, ENT_QUOTES, 'UTF-8'); ?>" dir="<?php echo htmlspecialchars($html_dir, ENT_QUOTES, 'UTF-8'); ?>">
<head>
    <meta charset="UTF-8">
    ...
    <link rel="sitemap" type="application/xml" title="Sitemap" href="https://root.com/sitemap.xml">
    <link rel="alternate" type="application/rss+xml" title="GoSiteMe News" href="https://root.com/announcements/rss">
    
    <!-- Language alternates for SEO (EN/FR/HE) — ?lang= matches switcher + cookie handler -->
    <link rel="alternate" hreflang="en" href="<?php echo htmlspecialchars($canonical_no_query); ?>?lang=en">
    <link rel="alternate" hreflang="fr" href="<?php echo htmlspecialchars($canonical_no_query); ?>?lang=fr">
    <link rel="alternate" hreflang="he" href="<?php echo htmlspecialchars($canonical_no_query); ?>?lang=he">
    <link rel="alternate" hreflang="x-default" href="<?php echo htmlspecialchars($canonical_no_query); ?>?lang=en">
...
<?php if (!empty($page_og_image_width)): ?>
    <meta property="og:image:width" content="<?php echo (int)$page_og_image_width; ?>">
    <meta property="og:image:height" content="<?php echo (int)$page_og_image_height; ?>">
<?php endif; ?>
    ...
    .mob-auth-strip{display:flex;gap:10px;padding:0 0 14px;margin:0 0 4px;border-bottom:1px solid rgba(255,255,255,.1);}
    .mob-auth-strip .btn{flex:1;width:auto!important;margin-top:0!important;min-height:46px;font-size:.92rem;}
    .lang-switcher--nav{display:inline-flex;align-items:center;gap:1px;padding:3px 5px;border-radius:999px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);font-size:.7rem;font-weight:800;letter-spacing:.04em;}
    .lang-switcher--nav .lang-switcher__link{color:rgba(255,255,255,.78);text-decoration:none;padding:4px 8px;border-radius:999px;white-space:nowrap;}
    .lang-switcher--nav .lang-switcher__link:hover{color:#fff;background:rgba(125,0,255,.22);}
    .lang-switcher--nav .lang-switcher__cur{color:#0a0a14;background:linear-gradient(135deg,#7D00FF,#00d4ff);padding:4px 9px;border-radius:999px;cursor:default;white-space:nowrap;}
    .lang-switcher--mob{display:flex;flex-wrap:wrap;gap:8px;padding:8px 0 4px;font-size:.88rem;font-weight:600;}
    .lang-switcher--mob a{color:var(--cyan);text-decoration:none;}
    .lang-switcher--mob a:hover{text-decoration:underline;}
    ...
    $schema_website = [
        ...
        'url' => 'https://root.com',
        'description' => $page_description,
        'publisher' => ['@type' => 'Organization', 'name' => 'GoSiteMe', 'logo' => ['@type' => 'ImageObject', 'url' => 'https://root.com/brand/logo.png']],
        'inLanguage' => ['en', 'fr'],
        'potentialAction' => ['@type' => 'SearchAction', 'target' => ['@type' => 'EntryPoint', 'urlTemplate' => 'https://root.com/?s={search_term_string}'], 'query-input' => 'required name=search_term_string']
    ];
    $schema_software = [
        '@context' => 'https://schema.org',
        ...
        'description' => 'Official GoSiteMe browser IDE. Alfred built in, sovereign sign-in, Git and terminal access, service-aware workspaces, and the live path into the GoSiteMe development platform.',
        'offers' => ['@type' => 'AggregateOffer', 'lowPrice' => '5', 'highPrice' => '199', 'priceCurrency' => 'USD', 'url' => 'https://root.com/cart?a=add&pid=18', 'offerCount' => '12'],
    ...
    $schema_nav = [
        ...
        'itemListElement' => [
            ['@type' => 'ListItem', 'position' => 1, 'item' => ['@type' => 'SiteNavigationElement', 'name' => 'Alfred IDE', 'url' => 'https://root.com/alfred-ide.php']],
            ['@type' => 'ListItem', 'position' => 2, 'item' => ['@type' => 'SiteNavigationElement', 'name' => 'Alfred Browser', 'url' => 'https://root.com/alfred-browser.php']],
            ['@type' => 'ListItem', 'position' => 3, 'item' => ['@type' => 'SiteNavigationElement', 'name' => 'Alfred Search', 'url' => 'https://root.com/search.php']],
            ['@type' => 'ListItem', 'position' => 4, 'item' => ['@type' => 'SiteNavigationElement', 'name' => 'Alfred AI Assistant', 'url' => 'https://root.com/alfred.php']],
            ['@type' => 'ListItem', 'position' => 5, 'item' => ['@type' => 'SiteNavigationElement', 'name' => 'Domain Registration', 'url' => 'https://root.com/store/hosting']],
            ['@type' => 'ListItem', 'position' => 6, 'item' => ['@type' => 'SiteNavigationElement', 'name' => 'Pricing', 'url' => 'https://root.com/pricing.php']],
            ['@type' => 'ListItem', 'position' => 7, 'item' => ['@type' => 'SiteNavigationElement', 'name' => 'Contact & Support', 'url' => 'https://root.com/contact']]
        ]
    ];
    ?>
...
<?php
$__bodyClass = isset($body_class) ? trim((string)$body_class) : '';
$__bodyClassAttr = $__bodyClass !== '' ? ' class="' . htmlspecialchars($__bodyClass, ENT_QUOTES, 'UTF-8') . '"' : '';
?>
<body<?php echo $__bodyClassAttr; ?>>
    <?php
    $showBrowserAnnouncement = false;
    $browserAnnouncementDismissKey = 'browserLaunchBanner_20260402';
    $browserAnnouncementLead = $current_lang === 'fr'
        ? 'Alfred Browser est en ligne.'
        : ($current_lang === 'he'
            ? 'דפדפן Alfred זמין.'
            : 'Alfred Browser is live.');
    $browserAnnouncementBody = $current_lang === 'fr'
        ? 'Téléchargements stables pour Windows et macOS. Aperçu Linux v4.0.0 disponible maintenant.'
        : ($current_lang === 'he'
            ? 'הורדות יציבות ל-Windows ו-macOS. תצוגה מקדימה ללינוקס v4.0.0 זמינה כעת.'
            : 'Stable Windows and macOS downloads are out now. Linux Preview v4.0.0 is live.');
    $browserAnnouncementCta = $current_lang === 'fr'
        ? 'Télécharger maintenant'
        : ($current_lang === 'he'
            ? 'הורד עכשיו'
            : 'Download now');
    ?>
    <?php if ($showBrowserAnnouncement): ?>
    <div class="urgency-banner" id="urgencyBanner">
        <p>
            <i class="fas fa-globe"></i>
            <strong><?php echo htmlspecialchars($browserAnnouncementLead); ?></strong>
            <?php echo htmlspecialchars($browserAnnouncementBody); ?>
            <span class="countdown">Stable v4.0.0</span>
            <a href="/alfred-browser.php#downloads" data-browser-track="1" data-browser-action="open_download_hub" data-browser-context="sitewide_banner" data-browser-label="sitewide_banner_download_hub" style="color: #fff; margin-left: 12px; text-decoration: underline;"><?php echo htmlspecialchars($browserAnnouncementCta); ?></a>
        </p>
        <button onclick="document.body.classList.add('banner-hidden');localStorage.setItem('<?php echo $browserAnnouncementDismissKey; ?>','1');" style="position:absolute;right:12px;top:50%;transform:translateY(-50%);background:none;border:none;color:rgba(255,255,255,.7);cursor:pointer;font-size:1.1rem;padding:4px 8px;" aria-label="Dismiss">&times;</button>
    </div>
    <script>if(localStorage.getItem('<?php echo $browserAnnouncementDismissKey; ?>')==='1')document.body.classList.add('banner-hidden');</script>
    <?php endif; ?>

    <!-- Skip to main content (WCAG 2.4.1) -->
    <a href="#main" class="skip-link"><?php echo htmlspecialchars(L('a11y_skip_to_main'), ENT_QUOTES, 'UTF-8'); ?></a>
    ...
    <!-- Navigation -->
    <header>
    <nav class="navbar" id="navbar" role="navigation" aria-label="<?php echo htmlspecialchars(L('a11y_main_nav'), ENT_QUOTES, 'UTF-8'); ?>">
        <div class="container">
            <a href="/" class="logo">
                <span class="logo-flip" aria-hidden="true">
                    <span class="logo-flip-inner">
                        ...
                        <span class="logo-flip-back"><img src="/brand/gocodeme-icon.svg" alt="Alfred IDE" style="height:32px;width:32px;border-radius:8px;"><span style="font-size:.85rem;font-weight:700;background:linear-gradient(135deg,#10b981,#34d399);-webkit-background-clip:text;-webkit-text-fill-color:transparent;margin-left:6px;">Alfred IDE</span></span>
                    </span>
                </span>
            ...
            <ul class="nav-links">
                <li class="mega-trigger" data-mega="products">
                    <a href="/alfred-ide.php" class="nav-gocodeme"><i class="fas fa-wand-magic-sparkles" style="margin-right:6px"></i><?php echo L('nav_gocodeme_editor'); ?> <i class="fas fa-chevron-down mega-chev"></i></a>
                </li>
                ...
                <li>
                    <a href="/kingdom.php" style="color:#f39c12;font-weight:700;"><i class="fas fa-crown" style="margin-right:4px;"></i>Kingdom Architecture</a>
                </li>
                <li>
                    <a href="/new-jerusalem.php" style="color:#8e44ad;font-weight:700;"><i class="fas fa-cube" style="margin-right:4px;"></i>Spatial OS</a>
                </li>
                <li>
                    <a href="/bible" style="color:#ffd700;font-weight:700;"><i class="fas fa-book-bible" style="margin-right:4px;"></i>Bible</a>
                </li>
                <li>
                    <a href="/apps" style="color:#34d399;font-weight:700;"><i class="fas fa-download" style="margin-right:4px;"></i>Apps</a>
                </li>
                <li>
                    <a href="/alfred-browser.php#downloads" style="color:#7dd3fc;font-weight:700;"><i class="fas fa-globe" style="margin-right:4px;"></i>Browser</a>
                </li>
                <li>
                ...
                <li class="mega-trigger" data-mega="universe">
                    <a href="/universe.php" style="background:linear-gradient(135deg,#7c5ce7,#22d3ee);-webkit-background-clip:text;-webkit-text-fill-color:transparent;font-weight:700;"><i class="fas fa-atom" style="margin-right:4px;-webkit-text-fill-color:#7c5ce7;"></i>Universe <i class="fas fa-chevron-down mega-chev" style="-webkit-text-fill-color:#7c5ce7;"></i></a>
                </li>
            ...
            <div class="nav-cta">
                ...
                <!-- GSM Balance Badge -->
                <a href="/blockchain.php" id="gsmBalanceBadge" style="display:inline-flex;align-items:center;gap:6px;margin-right:14px;padding:4px 12px;background:rgba(0,212,255,0.08);border:1px solid rgba(0,212,255,0.15);border-radius:999px;color:#00d4ff;text-decoration:none;font-size:0.8rem;font-weight:700;font-family:monospace;transition:all 0.2s;" onmouseenter="this.style.borderColor='rgba(0,212,255,0.4)';this.style.background='rgba(0,212,255,0.12)'" onmouseleave="this.style.borderColor='rgba(0,212,255,0.15)';this.style.background='rgba(0,212,255,0.08)'">
                    <span style="font-size:0.75rem;">◈</span>
                    <span id="gsmBalanceVal">—</span>
                    <span style="font-size:0.65rem;font-weight:600;opacity:0.7;">GSM</span>
                </a>
                <script>
                (function(){
                    fetch('/api/solana-blockchain.php?action=balance',{credentials:'same-origin'})
                      .then(function(r){return r.json()})
                      .then(function(d){
                        if(d.success){
                          var el=document.getElementById('gsmBalanceVal');
                          if(el) el.textContent=Number(d.data.gsm).toLocaleString(undefined,{maximumFractionDigits:0});
                        }
                      }).catch(function(){});
                })();
                </script>
                ...
                <span class="lang-switcher lang-switcher--nav" role="navigation" aria-label="Language / Langue / שפה">
                    <?php if ($current_lang === 'en'): ?>
                    <span class="lang-switcher__cur" aria-current="true">EN</span>
                    <?php else: ?>
                    <a class="lang-switcher__link" href="<?php echo htmlspecialchars(lang_switch_href('en'), ENT_QUOTES, 'UTF-8'); ?>" rel="nofollow">EN</a>
                    <?php endif; ?>
                    <?php if ($current_lang === 'fr'): ?>
                    <span class="lang-switcher__cur" aria-current="true">FR</span>
                    <?php else: ?>
                    <a class="lang-switcher__link" href="<?php echo htmlspecialchars(lang_switch_href('fr'), ENT_QUOTES, 'UTF-8'); ?>" rel="nofollow">FR</a>
                    <?php endif; ?>
                    <?php if ($current_lang === 'he'): ?>
                    <span class="lang-switcher__cur" aria-current="true" title="עברית">HE</span>
                    <?php else: ?>
                    <a class="lang-switcher__link" href="<?php echo htmlspecialchars(lang_switch_href('he'), ENT_QUOTES, 'UTF-8'); ?>" rel="nofollow" title="עברית">HE</a>
                    <?php endif; ?>
                </span>
                ...
                <div class="nav-user-wrap" style="position:relative;display:inline-block;">
                    ...
                    <div id="navUserDropdown" style="display:none;position:absolute;right:0;top:calc(100% + 8px);width:220px;background:#12121e;border:1px solid rgba(255,255,255,0.08);border-radius:12px;box-shadow:0 12px 36px rgba(0,0,0,0.5);z-index:9999;overflow:hidden;padding:6px 0;">
                        ...
                        <a href="/alfred-ide.php" style="display:flex;align-items:center;gap:10px;padding:10px 16px;color:#e0e0e0;text-decoration:none;font-size:0.85rem;transition:background 0.15s;" onmouseenter="this.style.background='rgba(255,255,255,0.04)'" onmouseleave="this.style.background='none'"><i class="fas fa-code" style="width:16px;text-align:center;color:#10b981;"></i> Alfred IDE</a>
    ...
    <div class="mega-panel" id="mega-products">
        <div class="mega-cols mega-cols-3">
            <div>
                ...
                <a href="/alfred-ide/" class="mega-item"><i class="fas fa-globe" style="color:#06b6d4"></i><div><div class="mi-t">Launch Alfred IDE</div><div class="mi-d">Open the live browser IDE</div></div></a>
                <a href="/alfred-ide.php" class="mega-item"><i class="fas fa-bolt" style="color:#a78bfa"></i><div><div class="mi-t">Official Launch</div><div class="mi-d">Overview, access paths, and workspace details</div></div></a>
                <a href="/alfred-browser.php#downloads" class="mega-item"><i class="fas fa-globe" style="color:#38bdf8"></i><div><div class="mi-t">Alfred Browser</div><div class="mi-d">Desktop downloads and sovereign browsing</div></div></a>
                <a href="/sovereign-browser.php" class="mega-item"><i class="fas fa-crown" style="color:#fbbf24"></i><div><div class="mi-t">Sovereign Browser</div><div class="mi-d">Brand front door for the sovereign web</div></div></a>
                <a href="/sovereign-domains.php" class="mega-item"><i class="fas fa-earth-americas" style="color:#34d399"></i><div><div class="mi-t">Sovereign Domains</div><div class="mi-d">176 TLDs &middot; Free .com &middot; Own your name forever</div></div></a>
                <a href="/apps" class="mega-item"><i class="fas fa-download" style="color:#34d399"></i><div><div class="mi-t">All Apps & Downloads</div><div class="mi-d">Browser, Veil, Pulse, IDE — every platform</div></div></a>
            ...
            <div>
                ...
                <a href="/game-lobby.php" class="mega-item"><i class="fas fa-satellite-dish" style="color:#14F195"></i><div><div class="mi-t">Live Lobby</div><div class="mi-d">Play now — live worlds &amp; AI agents</div></div></a>
    ...
    <div class="mega-panel" id="mega-hosting">
        <div class="mega-cols mega-cols-2">
            ...
            <div>
                ...
                <a href="/pay/store-dedicated.php" class="mega-item"><i class="fas fa-server" style="color:#fbbf24"></i><div><div class="mi-t">Dedicated Servers</div><div class="mi-d">Bare-metal OVH servers, monthly</div></div></a>
    ...
    <div class="mega-panel" id="mega-resources">
        <div class="mega-cols mega-cols-3">
            <div>
                ...
                <a href="/founder.php" class="mega-item"><i class="fas fa-user-astronaut" style="color:#00D4FF"></i><div><div class="mi-t">Meet the Founder</div><div class="mi-d">Danny William Perez</div></div></a>
            ...
            <div>
                ...
                <a href="/gsm-tour" class="mega-item"><i class="fas fa-route" style="color:#9945FF"></i><div><div class="mi-t">GSM Tour</div><div class="mi-d">The bridge from the old world into the Kingdom</div></div></a>
    ...
    <!-- Mega Panel: Universe -->
    <div class="mega-panel" id="mega-universe">
        <div class="mega-cols mega-cols-3">
            <div>
                <div class="mega-heading">Core Pillars</div>
                <a href="/pulse.php" class="mega-item"><i class="fas fa-bolt" style="color:#3b82f6"></i><div><div class="mi-t">Pulse</div><div class="mi-d">Social network — feed, agents, games, crypto</div></div></a>
                <a href="/veil/" class="mega-item"><i class="fas fa-shield-halved" style="color:#8b5cf6"></i><div><div class="mi-t">Veil</div><div class="mi-d">Quantum-encrypted messaging</div></div></a>
                <a href="/alfred.php" class="mega-item"><i class="fas fa-robot" style="color:#c084fc"></i><div><div class="mi-t">Alfred AI</div><div class="mi-d">50M+ agents · 13,000+ tools</div></div></a>
                <a href="/search.php" class="mega-item"><i class="fas fa-magnifying-glass" style="color:#22d3ee"></i><div><div class="mi-t">Alfred Search</div><div class="mi-d">Sovereign AI search engine</div></div></a>
            </div>
            <div>
                <div class="mega-heading">Software</div>
                <a href="/alfred-browser.php" class="mega-item"><i class="fas fa-globe" style="color:#38bdf8"></i><div><div class="mi-t">Alfred Browser</div><div class="mi-d">Sovereign Chromium — PQ encrypted</div></div></a>
                <a href="https://alfredlinux.com" class="mega-item"><i class="fab fa-linux" style="color:#34d399"></i><div><div class="mi-t">Alfred Linux</div><div class="mi-d">v7.77 GA — Sovereign desktop OS</div></div></a>
                <a href="/alfred-ide.php" class="mega-item"><i class="fas fa-code" style="color:#00d4ff"></i><div><div class="mi-t">Alfred IDE</div><div class="mi-d">Browser IDE with Alfred built in</div></div></a>
                <a href="/voice-products.php" class="mega-item"><i class="fas fa-phone-volume" style="color:#10b981"></i><div><div class="mi-t">Voice AI</div><div class="mi-d">29 AI voice products à la carte</div></div></a>
            </div>
            <div>
                <div class="mega-heading">Worlds & More</div>
                <a href="/vr/experiences/" class="mega-item"><i class="fas fa-gem" style="color:#DAA520"></i><div><div class="mi-t">VR Worlds</div><div class="mi-d">14 worlds — Chess Masters, concerts</div></div></a>
                <a href="https://meta-dome.com" class="mega-item"><i class="fas fa-earth-americas" style="color:#a855f7"></i><div><div class="mi-t">MetaDome</div><div class="mi-d">VR civilization — 50M+ AI agents</div></div></a>
                <a href="/health-research.php" class="mega-item"><i class="fas fa-dna" style="color:#10b981"></i><div><div class="mi-t">Health Research</div><div class="mi-d">50K agents — genomics &amp; longevity</div></div></a>
                <a href="/universe.php" class="mega-item" style="border-top:1px solid rgba(255,255,255,.06);margin-top:.5rem;padding-top:.75rem;"><i class="fas fa-atom" style="color:#7c5ce7"></i><div><div class="mi-t" style="background:linear-gradient(135deg,#7c5ce7,#22d3ee);-webkit-background-clip:text;-webkit-text-fill-color:transparent;">Explore Full Universe →</div><div class="mi-d">All apps, tools, worlds & services</div></div></a>
            </div>
        </div>
    </div>
    ...
    <div class="mobile-menu" id="mobileMenu">
        <button class="mobile-menu-close" id="mobileClose" aria-label="<?php echo htmlspecialchars(L('a11y_close_menu'), ENT_QUOTES, 'UTF-8'); ?>">
            <i class="fas fa-times"></i>
        </button>

        <div class="mob-auth-strip" role="navigation" aria-label="<?php echo htmlspecialchars(L('a11y_account_nav'), ENT_QUOTES, 'UTF-8'); ?>">
            <?php if (empty($_SESSION['logged_in'])): ?>
            <a href="/login" class="btn btn-outline"><i class="fas fa-user"></i> <?php echo L('nav_login'); ?></a>
            <a href="/register" class="btn btn-primary"><i class="fas fa-rocket"></i> <?php echo L('nav_get_started'); ?></a>
            <?php else: ?>
            <a href="/dashboard.php" class="btn btn-primary"><i class="fas fa-tachometer-alt"></i> <?php echo htmlspecialchars(L('a11y_dashboard_btn'), ENT_QUOTES, 'UTF-8'); ?></a>
            <a href="/my-account" class="btn btn-outline"><i class="fas fa-id-card"></i> <?php echo htmlspecialchars(L('a11y_my_account_btn'), ENT_QUOTES, 'UTF-8'); ?></a>
            <?php endif; ?>
        </div>
        ...
        <div class="mob-accordion">
            ...
            <div class="mob-accordion-panel">
                <a href="/alfred-ide/"><i class="fas fa-globe"></i> Launch Alfred IDE</a>
                <a href="/alfred-ide.php"><i class="fas fa-bolt"></i> Official Launch Page</a>
                ...
                <a href="/game-lobby.php" style="color:#14F195;"><i class="fas fa-satellite-dish"></i> Live Lobby</a>
        ...
        <!-- Mobile Accordion: Browser & Search -->
        <div class="mob-accordion">
            <button class="mob-accordion-btn"><i class="fas fa-globe"></i> Browser &amp; Search <i class="fas fa-chevron-down mob-chev"></i></button>
            <div class="mob-accordion-panel">
                <a href="/apps" style="color:#34d399;font-weight:700;"><i class="fas fa-th"></i> All Apps & Downloads</a>
                <a href="/alfred-browser.php#downloads" style="color:#7dd3fc;"><i class="fas fa-download"></i> Alfred Browser Downloads</a>
                <a href="/search.php" style="color:#f472b6;"><i class="fas fa-magnifying-glass"></i> Alfred Search</a>
                <a href="/sovereign-browser.php" style="color:#fbbf24;"><i class="fas fa-crown"></i> Sovereign Browser</a>
                <a href="/sovereign-domains.php" style="color:#34d399;"><i class="fas fa-earth-americas"></i> Sovereign Domains</a>
            </div>
        </div>
        ...
        <div class="mob-accordion">
            ...
            <div class="mob-accordion-panel">
                <a href="/gsm-tour" style="color:#9945FF;"><i class="fas fa-route"></i> GSM Tour</a>
        ...
        <!-- Mobile: AKJV Bible -->
        <a href="/kingdom.php" style="color:#f39c12;font-weight:700;display:block;padding:14px 24px;font-size:1rem;border-bottom:1px solid rgba(255,255,255,.05);"><i class="fas fa-crown" style="margin-right:8px;"></i> Kingdom Architecture</a>
        <a href="/new-jerusalem.php" style="color:#8e44ad;font-weight:700;display:block;padding:14px 24px;font-size:1rem;border-bottom:1px solid rgba(255,255,255,.05);"><i class="fas fa-cube" style="margin-right:8px;"></i> Spatial OS</a>
        <a href="/bible" style="color:#ffd700;font-weight:700;display:block;padding:14px 24px;font-size:1rem;"><i class="fas fa-book-bible" style="margin-right:8px;"></i> AKJV Bible — Operation Divine Scroll</a>
        ...
        <div class="lang-switcher--mob" role="navigation" aria-label="Language / Langue / שפה">
            <span style="color:var(--text-muted);min-width:5rem;"><?php echo htmlspecialchars(L('a11y_language_label'), ENT_QUOTES, 'UTF-8'); ?>:</span>
            <a href="<?php echo htmlspecialchars(lang_switch_href('en'), ENT_QUOTES, 'UTF-8'); ?>" rel="nofollow"<?php echo $current_lang === 'en' ? ' style="font-weight:800;color:#fff;"' : ''; ?>>English (EN)</a>
            <span style="color:rgba(255,255,255,.2);">·</span>
            <a href="<?php echo htmlspecialchars(lang_switch_href('fr'), ENT_QUOTES, 'UTF-8'); ?>" rel="nofollow"<?php echo $current_lang === 'fr' ? ' style="font-weight:800;color:#fff;"' : ''; ?>>Français (FR)</a>
            <span style="color:rgba(255,255,255,.2);">·</span>
            <a href="<?php echo htmlspecialchars(lang_switch_href('he'), ENT_QUOTES, 'UTF-8'); ?>" rel="nofollow" title="עברית"<?php echo $current_lang === 'he' ? ' style="font-weight:800;color:#fff;"' : ''; ?>>עברית (HE)</a>
        </div>
    </div>
    ...
    (function(){
        ...
        var cmdOverlay=document.getElementById('cmdOverlay'),
            ...
            cmdActive=-1;
        var PAGES=[
            {t:'Alfred IDE',u:'/alfred-ide.php',i:'fa-wand-magic-sparkles',c:'Platform',k:'alfred ide official launch browser workspace code'},
            {t:'Launch Alfred IDE',u:'/alfred-ide/',i:'fa-globe',c:'Platform',k:'launch browser ide sign in workspace'},
            {t:'All Apps & Downloads',u:'/apps',i:'fa-th',c:'Platform',k:'apps downloads all browser veil pulse ide desktop mobile android linux windows mac appimage deb rpm'},
            {t:'Alfred Browser Downloads',u:'/alfred-browser.php#downloads',i:'fa-download',c:'Platform',k:'alfred browser download windows mac linux desktop sovereign'},
            {t:'Sovereign Browser',u:'/sovereign-browser.php',i:'fa-crown',c:'Platform',k:'sovereign browser web dns domains'},
            {t:'Sovereign Domains',u:'/sovereign-domains.php',i:'fa-earth-americas',c:'Platform',k:'sovereign domains register tld free com namespace registry'},
            ...
            {t:'Alfred Search',u:'/search.php',i:'fa-magnifying-glass',c:'AI Core',k:'alfred search sovereign search engine zero tracking'},
            ...
            {t:'Live Lobby',u:'/game-lobby.php',i:'fa-satellite-dish',c:'Experiences',k:'live lobby play now agents worlds'},
            ...
            {t:'Meet the Founder',u:'/founder.php',i:'fa-user-astronaut',c:'Company',k:'founder danny perez story vision'},
            ...
            {t:'Post-Quantum Encryption',u:'/veil/',i:'fa-atom',c:'Company',k:'post quantum encryption veil kyber'},
            ...
            {t:'GSM Tour \u2014 Bridge Into The Kingdom',u:'/gsm-tour',i:'fa-route',c:'Finance',k:'gsm tour bridge token solana kingdom economy funnel'},
            ...
            {t:'Constitution & Supreme Law',u:'/constitution.php',i:'fa-scroll',c:'Sovereign State',k:'constitution articles bill of rights amendments supreme law'},
            {t:'Senate',u:'/senate.php',i:'fa-landmark-dome',c:'Sovereign State',k:'senate bills legislation vote committee session'},
            {t:'Treasury & Central Bank',u:'/treasury.php',i:'fa-vault',c:'Sovereign State',k:'treasury bonds budget taxes GSM economy reserves'},
            {t:'Civil Affairs',u:'/civil-affairs.php',i:'fa-people-group',c:'Sovereign State',k:'civil affairs citizen registry complaints humanitarian aid census'},
            {t:'Homeland Security',u:'/homeland.php',i:'fa-shield-virus',c:'Sovereign State',k:'homeland security threat advisory watchlist incidents borders emergencies'},
            {t:'Diplomacy',u:'/diplomacy.php',i:'fa-handshake',c:'Sovereign State',k:'diplomacy treaties ambassadors foreign affairs'},
            {t:'National Guard',u:'/national-guard.php',i:'fa-flag-usa',c:'Sovereign State',k:'national guard units drills activations reserve'},
            {t:'Strategic Command',u:'/stratcom.php',i:'fa-chess-knight',c:'Sovereign State',k:'stratcom campaigns war plans objectives strategy'},
            {t:'Intelligence',u:'/intelligence.php',i:'fa-satellite-dish',c:'Sovereign State',k:'intelligence reports threats classified intel'},
            {t:'PsyOps',u:'/psyops.php',i:'fa-brain',c:'Sovereign State',k:'psyops morale campaigns psychological operations'},
            {t:'Chain of Command',u:'/chain-of-command.php',i:'fa-sitemap',c:'Sovereign State',k:'chain command orders reports hierarchy'},
            {t:'Military HQ',u:'/military-hq.php',i:'fa-building-shield',c:'Sovereign State',k:'military hq headquarters operations'},
            {t:'Military Court',u:'/military-court.php',i:'fa-gavel',c:'Sovereign State',k:'military court martial cases tribunal'},
            {t:'Territory',u:'/territory.php',i:'fa-map',c:'Sovereign State',k:'territory control map battles resources claims'},
            {t:'Supreme Command',u:'/supreme-command.php',i:'fa-star',c:'Sovereign State',k:'supreme command overview flag officer general'},
            {t:'Special Operations',u:'/spec-ops.php',i:'fa-crosshairs',c:'Sovereign State',k:'spec ops special operations socom missions operators'},
            {t:'Military Police',u:'/military-police.php',i:'fa-shield',c:'Sovereign State',k:'military police mp law enforcement patrol'},
            {t:'JAG Corps',u:'/jag.php',i:'fa-balance-scale',c:'Sovereign State',k:'jag judge advocate general legal attorney court appeals tribunal'},
            {t:'Space Command',u:'/space-command.php',i:'fa-rocket',c:'Sovereign State',k:'space command spacecom orbital satellites launches defense stations'},
            {t:'Signal Corps',u:'/signal-corps.php',i:'fa-tower-broadcast',c:'Sovereign State',k:'signal corps communications electronic warfare crypto networks relay'},
            {t:'War College',u:'/war-college.php',i:'fa-graduation-cap',c:'Sovereign State',k:'war college education programs papers assessments fellowship'},
            {t:'Research & Development',u:'/research.php',i:'fa-flask',c:'Sovereign State',k:'research development rnd labs projects breakthroughs tech tree'},
            {t:'State Media & Propaganda',u:'/propaganda.php',i:'fa-newspaper',c:'Sovereign State',k:'propaganda media publications campaigns press corps narrative'},
            {t:'Energy & Infrastructure',u:'/energy.php',i:'fa-bolt',c:'Sovereign State',k:'energy infrastructure grid datacenters services capacity budget'},
            {t:'Enlistment',u:'/enlist.php',i:'fa-user-plus',c:'Military',k:'enlist join recruit sign up apply military'},
            {t:'Leaderboard',u:'/leaderboard.php',i:'fa-trophy',c:'Military',k:'leaderboard rankings stats scores top soldiers'},
            {t:'Training Academy',u:'/training.php',i:'fa-dumbbell',c:'Military',k:'training courses certifications drills boot camp academy'},
            {t:'Decorations & Medals',u:'/decorations.php',i:'fa-medal',c:'Military',k:'decorations medals awards ribbons commendations honors'},
            {t:'War Games',u:'/war-games.php',i:'fa-chess',c:'Military',k:'war games exercises simulations maneuvers scenarios'},
            {t:'Supply & Logistics',u:'/supply.php',i:'fa-boxes-stacked',c:'Military',k:'supply logistics requisition inventory warehouse economy'},
            {t:'Military API & SDK',u:'/military-api.php',i:'fa-code',c:'Military',k:'military api sdk endpoints keys developers integration'},
            {t:'Officer Candidate School',u:'/officer-school.php',i:'fa-user-graduate',c:'Military',k:'ocs officer candidate school commission training leadership'},
            {t:'Cyber Operations (CYBERCOM)',u:'/cyber-ops.php',i:'fa-shield-halved',c:'Military',k:'cyber operations cybercom hacking defense firewall network'},
            {t:'MIL-NET Broadcasting',u:'/broadcasting.php',i:'fa-tower-broadcast',c:'Military',k:'broadcasting milnet radio transmit emergency network comms'},
            {t:'Arsenal & Armory',u:'/arsenal.php',i:'fa-gun',c:'Military',k:'arsenal armory weapons inventory stockpile munitions'},
            {t:'Veterans Affairs',u:'/veterans.php',i:'fa-ribbon',c:'Military',k:'veterans affairs benefits claims pension memorial service'},
            {t:'Nuclear Deterrence',u:'/nuclear-deterrence.php',i:'fa-radiation',c:'Military',k:'nuclear deterrence launch codes icbm warheads defcon'}
        ];
        function openCmd(){
