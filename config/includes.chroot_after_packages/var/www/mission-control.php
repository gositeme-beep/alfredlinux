...
// Owner-only
if (empty($_SESSION['email']) || $_SESSION['email'] !== 'root@gmail.com') {
        ...
        <div class="mc-panel active" id="panel-overview">
            ...
            <div class="mc-card" style="margin-top:8px;">
                ...
                <div class="mc-quick-grid">
                    ...
                    <a class="mc-quick-item" href="/alfred-ide/"><i class="fas fa-code" style="color:var(--mc-green);"></i> Alfred IDE</a>
        ...
        <div class="mc-panel" id="panel-ecosystem">
            ...
            <div class="mc-grid-3" id="ecosystem-grid">
                ...
                $ecosystemItems = [
                    ...
                    ['Alfred IDE', 'fas fa-code', '--mc-green', '/alfred-ide/', 'Official browser IDE'],
