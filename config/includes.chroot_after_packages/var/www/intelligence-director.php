...
$page_canonical = 'https://root.com/intelligence-director';
...
<div class="intel-wrap">
        ...
        <div class="intel-grid" style="margin-top:16px">
            <div class="intel-card">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:6px;font-size:.78rem">
                    ...
                    <div><span class="channel-dot active"></span> SMS</div>
                    ...
                    <div><span class="channel-dot active"></span> Email</div>
                    <div><span class="channel-dot active"></span> Voice AI</div>
                </div>
            </div>
            <div class="intel-card">
                <h3><i class="fas fa-brain" style="color:var(--purple)"></i> AI Infrastructure</h3>
                <div style="font-size:.78rem;margin-top:8px">
                    <div style="margin-bottom:4px"><span class="badge badge-green">PRIMARY</span> Alfred Sonnet 4</div>
                    <div style="margin-bottom:4px"><span class="badge badge-blue">BACKUP 1</span> Free Tier llama-3.3-70b</div>
                    <div style="margin-bottom:4px"><span class="badge badge-blue">BACKUP 2</span> Alfred Mini gpt-4.1-mini</div>
                    <div style="margin-bottom:4px"><span class="badge badge-blue">BACKUP 3</span> Alfred Flash gemini-2.5-flash</div>
                    <div style="margin-bottom:4px"><span class="badge badge-blue">BACKUP 4</span> Alfred Rapid grok-3-mini</div>
                    <div><span class="badge badge-red">LOCAL</span> Local AI qwen2.5:3b (port 11434)</div>
                </div>
            </div>
            <div class="intel-card">
                ...
                <p>Sentinel + Cipher active. Veil Protocol armed. AI cascade: 6 providers + Local AI.</p>
            </div>
            <div class="intel-card">
    ...
    <div class="intel-panel" id="panel-channels">
        ...
        <div class="intel-grid">
            ...
            <div class="intel-card"><h3><i class="fas fa-comment-sms" style="color:var(--accent)"></i> SMS</h3><p>Inbound/outbound SMS. +1(807)798-2850.</p><p style="margin-top:6px"><span class="badge badge-green">API KEY</span> <span class="badge badge-green">FROM NUMBER</span></p></div>
            <div class="intel-card"><h3><i class="fas fa-phone" style="color:var(--gold)"></i> Voice AI</h3><p>Inbound: 1-833-GOSITEME. Outbound: auto-calls.</p><p style="margin-top:6px"><span class="badge badge-green">API KEY</span> <span class="badge badge-green">PHONE ID</span></p></div>
        </div>
    </div>
