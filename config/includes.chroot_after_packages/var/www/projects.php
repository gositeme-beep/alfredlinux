...
$projects = [
    ...
    ['cat'=>'product','title'=>'Alfred IDE','desc'=>'Official browser-based development workspace with Alfred built in','url'=>'/alfred-ide.php','icon'=>'fa-code','color'=>'#00e5ff','access'=>'auth'],
    ['cat'=>'product','title'=>'Veil Encrypted Comms','desc'=>'Post-quantum encrypted messaging — military-grade privacy','url'=>'/veil/','icon'=>'fa-shield-halved','color'=>'#8b5cf6','access'=>'auth'],
    ...
    ['cat'=>'business','title'=>'Live Demo','desc'=>'Real-time system stats — 50M+ agents, live data','url'=>'/live-demo.php','icon'=>'fa-play','color'=>'#00e5ff','access'=>'public'],
...
<div class="pf-wrap">
    ...
    <div class="pf-quick" id="pf-quick">
        ...
        <a href="/alfred-ide.php" class="pf-quick-card"><i class="fas fa-code" style="color:#00e5ff"></i><span>Alfred IDE</span></a>
