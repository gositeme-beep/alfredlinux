...
$page_description = 'Veil by GoSiteMe: end-to-end encrypted messaging with Kyber-1024 post-quantum encryption, AI agents, voice/video calls, P2P payments, and more. The communications platform built for what\'s next.';
