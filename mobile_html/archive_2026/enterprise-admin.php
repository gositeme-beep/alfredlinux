...
<link rel="canonical" href="https://gositeme.com/enterprise-admin.php">
        ...
        <div class="ea-card">
          ...
          <div class="ea-card-body">
            ...
            <div class="ea-settings-card">
              ...
              <div class="ea-form-group"><label>ACS URL</label><input type="text" class="ea-input" value="https://gositeme.com/api/enterprise.php?action=sso/callback" readonly onclick="this.select()"></div>
              <div class="ea-form-group"><label>Entity ID</label><input type="text" class="ea-input" value="https://gositeme.com/enterprise" readonly onclick="this.select()"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="ea-section" id="sec-whitelabel" aria-label="White label settings">
        <div class="ea-card">
          ...
          <div class="ea-card-body">
            ...
            <div class="ea-settings-card">
              <h3>Custom Domain</h3>
              <p>Serve Alfred from your own domain. CNAME your subdomain to <code style="color:var(--al-accent-light)">enterprise.gositeme.com</code>.</p>
