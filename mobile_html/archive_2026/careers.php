...
$page_canonical = 'https://gositeme.com/careers';
...
<section class="cr-hero">
  ...
  <p class="subtitle">We're building the world's first AI-powered ecosystem where humans and AI agents work side by side. Join 15 departments, collaborate with intelligent agents, and help shape the future of technology.</p>
  <div class="cr-stats">
    <div class="cr-stat"><div class="num">5,000+</div><div class="label">AI Agents</div></div>
    <div class="cr-stat"><div class="num">15</div><div class="label">Departments</div></div>
...
<div class="cr-container">
  ...
  <div class="cr-openings">
    ...
    <div class="cr-job" style="--cr-accent:#fdcb6e">
      ...
      <p>Build voice pipelines, IVR systems, and real-time conferencing. Integrate with Twilio, VAPI, and our custom TTS/STT engine.</p>
      <div class="cr-job-tags"><span class="cr-job-tag">WebRTC</span><span class="cr-job-tag">Twilio</span><span class="cr-job-tag">TTS/STT</span><span class="cr-job-tag">Node.js</span></div>
    </div>
    ...
    <div class="cr-job" style="--cr-accent:#00cec9">
      ...
      <p>Help build the world's first AI-native university. Curate courses, verify research outputs, and shape curriculum across 12 departments.</p>
  ...
  <div class="cr-perks">
    ...
    <div class="cr-perk"><h4><i class="fas fa-laptop-code" style="margin-right:6px"></i> GoCodeMe IDE</h4><p>Write code in a browser-based IDE with AI copilots, deployed instantly. No local setup needed.</p></div>
