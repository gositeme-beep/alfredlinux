 ...
 * Product page: features, post-quantum encryption, downloads
 */
$page_title       = 'Veil — Private. Quantum-Proof. Intelligent. | GoSiteMe';
$page_description = 'Veil by GoSiteMe: end-to-end encrypted messaging with Kyber-768 post-quantum encryption, AI agents, voice/video calls, P2P payments, and more. The communications platform built for what\'s next.';
$page_canonical   = 'https://gositeme.com/post-quantum';
$noGlobalMain = true;
...
<section class="v-divider">
    <div class="v-stats">
        ...
        <div class="v-stat">
            <div class="v-stat-val">Kyber-768</div>
        ...
        <div class="v-stat">
            <div class="v-stat-val">1,220+</div>
...
<section class="v-section v-divider" id="features">
    <div class="v-showcase">
        ...
        <div class="v-showcase-text">
            ...
            <p>
                Veil is the first SMB communications platform with <strong>Kyber-768 hybrid post-quantum encryption</strong>.
                Every message, call, and file uses a dual key-exchange — ECDH P-256 + Kyber-768 — combined via HKDF.
...
<section class="v-section">
    <div class="v-showcase reverse">
        ...
        <div class="v-showcase-text">
            <h3><span>24 AI Agents.</span> 1,220+ Tools.</h3>
            <p>
...
<section class="v-section v-divider">
    ...
    <div class="v-features">
        <div class="v-feat">
            ...
            <p>Kyber-768 + ECDH hybrid. NIST FIPS 203. Every message, call, and file. Zero external dependencies.</p>
        </div>
        <div class="v-feat">
        ...
        <div class="v-feat">
            ...
            <h3>AI Agents</h3>
            <p>24 specialized agents with 1,220+ tools. Legal, medical, finance, DevOps — summon in any chat.</p>
        </div>
        <div class="v-feat">
        ...
        <table class="v-compare">
            ...
            <tbody>
                <tr class="v-hl">
                    ...
                    <td class="v-yes"><i class="fas fa-check-circle"></i> Kyber-768</td>
                ...
                <tr>
                    ...
                    <td class="v-yes"><i class="fas fa-check-circle"></i> 24 agents</td>
                    <td class="v-no"><i class="fas fa-times-circle"></i></td>
                    <td class="v-no"><i class="fas fa-times-circle"></i></td>
                    <td class="v-no"><i class="fas fa-times-circle"></i></td>
...
<section class="v-section v-divider" id="download" style="text-align:center;">
    ...
    <div class="v-dl-grid">
        <div class="v-dl-card">
            ...
            <a href="/downloads/Alfred-Browser.apk" class="v-btn v-btn-green" id="android-dl-btn">
        ...
        <div class="v-dl-card">
            ...
            <h3>Desktop</h3>
            <p>Integrated with GoCodeMe IDE. All platforms.</p>
            <ul class="v-dl-features">
                <li><i class="fas fa-check"></i> Windows, macOS, Linux</li>
                <li><i class="fas fa-check"></i> GoCodeMe IDE integration</li>
...
<section class="v-section v-divider">
    ...
    <div class="v-accordion">
        <div class="v-acc-item">
            ...
            <div class="v-acc-body">
                <div class="v-acc-body-inner">
                    ...
                    AI agents, P2P payments, and group collaboration — all protected by Kyber-768 hybrid post-quantum encryption.
        ...
        <div class="v-acc-item">
            ...
            <div class="v-acc-body">
                <div class="v-acc-body-inner">
                    ...
                    mean encrypted data captured today can be cracked once quantum computers mature. Veil uses Kyber-768
        ...
        <div class="v-acc-item">
            ...
            <div class="v-acc-body">
                <div class="v-acc-body-inner">
                    Yes. The entire Kyber-768 implementation (<code>comms-pqc.js</code>) is 654 lines of readable, unminified
