...
<section class="is-section">
    ...
    <div class="is-threats">
        ...
        <div class="is-threat">
            ...
            <p>An adversary takes control of gositeme.com or meta-dome.com, redirecting visitors.</p>
        </div>
        <div class="is-response">
            <div class="is-label-green">Response</div>
        ...
        <div class="is-threat">
            ...
            <p>Anthropic, Groq, or other AI providers go down.</p>
        </div>
        <div class="is-response">
            <div class="is-label-green">Response</div>
            <h4>4-tier cascade with local fallback</h4>
            <p>Anthropic → Groq → Together AI → Ollama (local). If all external providers fail, local Ollama handles requests. Agent engines don't use external AI at all — they use local logic.</p>
        </div>
    </div>
</section>
