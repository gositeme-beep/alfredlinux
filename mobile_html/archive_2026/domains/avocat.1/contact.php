    ...
    <div class="contact-grid">
        ...
        <div class="contact-info">
            <div class="contact-card">
                ...
                <p>Alfred is available 24/7 right here on this page. Click the chat icon in the bottom-right corner to get instant help with accounts, hosting, domains, billing, and 1,220+ other tasks.</p>
            </div>
            <div class="contact-card">
