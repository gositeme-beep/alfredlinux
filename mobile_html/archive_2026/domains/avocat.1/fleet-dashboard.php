...
$page_canonical = 'https://gositeme.com/fleet-dashboard.php';
...
{"@context":"https://schema.org","@type":"SoftwareApplication","name":"Alfred Fleet Command","applicationCategory":"BusinessApplication","operatingSystem":"Web","url":"https://gositeme.com/fleet-dashboard.php","description":"Launch and manage AI agent fleets with Alfred Fleet Command. Real-time swarm orchestration, parallel task execution, and intelligent agent coordination.","featureList":"5000 Agent Fleet, 10 Domain Orchestration, Agent Messaging Bus, Smart Task Routing, Session Management, Performance Metrics, Real-Time Monitoring, Fleet Analytics, CSV Export","offers":{"@type":"Offer","price":"0","priceCurrency":"USD","description":"Included with GoSiteMe hosting plans"},"creator":{"@type":"Organization","name":"GoSiteMe","url":"https://gositeme.com"}}
</script>
<!-- Schema.org: WebPage -->
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","name":"Alfred Fleet Command — AI Swarm Orchestration","description":"Launch and manage AI agent fleets with real-time swarm orchestration, parallel task execution, and intelligent agent coordination.","url":"https://gositeme.com/fleet-dashboard.php","isPartOf":{"@type":"WebSite","name":"GoSiteMe","url":"https://gositeme.com"}}
</script>
