...
<div class="hr-wrap">
    ...
    <div class="hr-ask" id="hrAskSection">
        ...
        <div class="hr-ask-login">
            ...
            <a href="/login.php?redirect=/health-research"><i class="fas fa-sign-in-alt"></i> Sign In to Ask</a> &nbsp;or&nbsp; <a href="/login.php?action=register&redirect=/health-research"><i class="fas fa-user-plus"></i> Create Free Account</a>
        </div>
        <?php endif; ?>
    </div>
