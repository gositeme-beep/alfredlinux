...
$page_canonical = 'https://gositeme.com/emergency-kit';
        ...
        <div class="ek-section">
            ...
            <div class="ek-grid" style="grid-template-columns: repeat(auto-fit, minmax(240px, 1fr));">
                ...
                <div class="ek-card">
                    ...
                    <p>AES-256-GCM + Kyber-768 post-quantum encryption on all mesh communications. Even relay nodes can't read your messages.</p>
                </div>
                <div class="ek-card">
