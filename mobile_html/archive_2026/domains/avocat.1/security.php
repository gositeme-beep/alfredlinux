...
<section class="sec-hero">
    ...
    <div class="sec-badges">
        ...
        <span class="sec-badge"><i class="fas fa-atom"></i> Post-Quantum (Kyber-768)</span>
...
<section class="sec-section">
    ...
    <div class="sec-pillars">
        ...
        <div class="sec-pillar">
            ...
            <p>Kyber-768 hybrid key exchange protects communications against future quantum computing threats. Classical ECDH + Kyber lattice-based KEM — both must be broken simultaneously.</p>
        </div>
        <!-- Veil Fortress -->
        <div class="sec-pillar">
            <div class="sec-icon" style="background:rgba(248,113,113,.12);color:#f87171;"><i class="fas fa-layer-group"></i></div>
            <h3>Veil Fortress</h3>
            <p>10-layer encryption stack combining post-quantum Kyber-768 + Dilithium signatures, Double Ratchet forward secrecy, hash chains, key commitment, and steganographic obfuscation.</p>
        </div>
        <!-- Access Control -->
        <div class="sec-pillar">
...
<section class="sec-section">
    ...
    <div class="sec-veil-stack">
        ...
        <div class="sec-veil-layer">
            ...
            <div>
                <div class="sec-vl-title">Kyber-768 KEM <span class="sec-vl-tag sec-vl-pq">Post-Quantum</span></div>
                <div class="sec-vl-desc">NIST-selected lattice-based Key Encapsulation Mechanism. Generates shared secrets resistant to both classical and quantum attacks. 768-dimensional module lattice over polynomial ring.</div>
            </div>
        </div>
        <!-- Layer 2 -->
        <div class="sec-veil-layer">
            ...
            <div>
                ...
                <div class="sec-vl-desc">Elliptic Curve Diffie-Hellman on the NIST P-256 curve. Provides classical-strength key agreement; combined with Kyber-768 so both must be broken simultaneously.</div>
            </div>
        </div>
        <!-- Layer 3 -->
        <div class="sec-veil-layer">
    ...
    <div class="sec-table-wrap">
        <table class="sec-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>Post-quantum encryption (Kyber-768)</td>
                    <td class="check"><i class="fas fa-check"></i></td>
                    <td class="check"><i class="fas fa-check"></i></td>
                    <td class="check"><i class="fas fa-check"></i></td>
                    <td class="check"><i class="fas fa-check"></i></td>
...
<section class="sec-section">
    ...
    <div class="sec-faq sec-accordion">
        ...
        <div class="sec-acc-item">
            ...
            <div class="sec-acc-body"><div class="sec-acc-body-inner">
                <p>Yes. All data is encrypted at rest using AES-256 and in transit using TLS 1.3. API tokens and secrets are hashed with SHA-256 before storage — we never store them in plain text. Communications through Alfred AI are additionally protected by our <strong>Veil Fortress</strong> 10-layer encryption stack, which includes post-quantum Kyber-768 + Dilithium signatures, Double Ratchet forward secrecy, and steganographic obfuscation.</p>
            </div></div>
        </div>
        ...
        <div class="sec-acc-item">
            ...
            <div class="sec-acc-body"><div class="sec-acc-body-inner">
                <p>Veil Fortress is our proprietary 10-layer encryption protocol. Unlike standard TLS which uses a single encryption layer, Veil Fortress wraps every message in 10 independent cryptographic layers: Kyber-768 KEM, ECDH P-256, AES-256-GCM, HKDF-SHA256, ECDSA P-256, Dilithium PQ Signatures, Double Ratchet, Hash Chains, Key Commitment, and Steganographic Obfuscation. An attacker must break all 10 simultaneously — compromising any single layer reveals nothing.</p>
            </div></div>
        </div>
