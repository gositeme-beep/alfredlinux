...
$page_canonical = 'https://gositeme.com/integrations';
...
<span class="code-keyword">const</span> response = <span class="code-keyword">await</span> <span class="code-func">fetch</span>(<span class="code-string">'https://gositeme.com/api/alfred-command.php'</span>, {
