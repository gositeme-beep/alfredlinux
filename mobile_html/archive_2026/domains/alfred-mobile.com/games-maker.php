...
<div class="gm-page">
    ...
    <div class="gm-features">
        ...
        <div class="gm-feature">
            ...
            <h3>Full IDE</h3>
            <p>GoCodeMe integration — full code editor with debugging, preview, and Git</p>
        </div>
    </div>
...
(function() {
    ...
    window.createProject = async function() {
        ...
        // Create a GoCodeMe workspace for this project
        ...
        try {
            ...
            if (resp.ok) {
                ...
                if (data.workspace_url) {
                    ...
                    alert('Project created! Check your GoCodeMe dashboard.');
                    window.location.href = '/middleware/dashboard';
                }
            } else {
                const err = await resp.json().catch(() => ({}));
                alert(err.error || 'Failed to create project. Please try from GoCodeMe directly.');
                window.location.href = '/middleware/dashboard';
            }
        } catch (err) {
            alert('Failed to connect. Opening GoCodeMe dashboard...');
            window.location.href = '/middleware/dashboard';
        }
    };
