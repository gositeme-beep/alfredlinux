 ...
 * ═══════════════════════════════════════════════════════
 * Create and manage projects using the Editor or GoCodeMe IDE.
...
$page_canonical = 'https://gositeme.com/project-creator';
    ...
    <div class="pc-panel active" id="panel-create">
        <div class="pc-form">
            ...
            <select id="pc-type">
                ...
                <option value="gocodeme">GoCodeMe IDE Workspace</option>
            </select>
    ...
    window.createProject = async function() {
        ...
        try {
            if (type === 'editor') {
                ...
                if (res.ok) {
                    status('GoCodeMe workspace "' + escapeHtml(name) + '" created with ' + template + ' template!', 'success');
                } else {
