...
$page_og_description = 'Pulse social network. Veil encrypted messaging. 13,000+ AI tools. 50M+ AI agents. 14 VR worlds. Voice AI. Crypto payments. One ecosystem — from $15/mo.';
$page_twitter_description = 'Pulse social network · Veil encrypted chat · 13,000+ AI tools · 50M+ agents · 14 VR worlds · Voice AI. From $15/mo.';
$preload_hero = true;
$noGlobalMain = true;
...
<?php echo json_encode([
    ...
    'sameAs' => [],
    'description' => 'AI platform with Pulse social network, Veil encrypted messaging, 13,000+ AI tools, 50M+ AI agents, 14 VR worlds, Voice AI, and crypto payments.',
    'contactPoint' => [
        '@type' => 'ContactPoint',
...
<?php echo json_encode([
    ...
    'itemListElement' => [
        ...
        ['@type' => 'ListItem', 'position' => 2, 'item' => ['@type' => 'SoftwareApplication', 'name' => 'Veil — Encrypted Messaging', 'url' => 'https://gositeme.com/post-quantum.php', 'applicationCategory' => 'CommunicationApplication', 'description' => 'End-to-end encrypted messaging with Kyber-1024 post-quantum cryptography.']],
        ['@type' => 'ListItem', 'position' => 3, 'item' => ['@type' => 'SoftwareApplication', 'name' => 'Alfred AI', 'url' => 'https://gositeme.com/alfred.php', 'applicationCategory' => 'DeveloperApplication', 'description' => '50M+ AI agents, 13,000+ tools, 17 AI engines.']],
