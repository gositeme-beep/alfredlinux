...
$page_canonical = 'https://gositeme.com/sdks';
...
<script type="application/ld+json">
{
  ...
  "codeRepository": "https://github.com/gositeme",
...
<section class="sdk-features">
    ...
    <div class="sdk-features-grid">
        ...
        <div class="sdk-feature-card">
            ...
            <p>Discover 13,000+ tools across Native, MCP, External MCP (870+ servers), Composio (850+ apps), VAPI, and Marketplace providers at runtime.</p>
        </div>
        <div class="sdk-feature-card">
            <div class="sdk-feature-icon" style="background:rgba(253,121,168,0.12); color:var(--al-pink);">
        ...
        <div class="sdk-feature-card">
            ...
            <h3>Creative AI</h3>
            <p>Generate images (FLUX, DALL-E), video (Kling), music (MusicGen), and speech (ElevenLabs, F5-TTS) through a unified API.</p>
        </div>
        <div class="sdk-feature-card">
            <div class="sdk-feature-icon" style="background:rgba(9,132,227,0.12); color:var(--al-blue);">
...
const composioTools = await alfred.tools.discover('composio');
console.log(`Composio: ${composioTools.data.length} tools across 850+ apps`);

// Native (170) + MCP (807) + External MCP (1,200+) + Composio (11,000+) + VAPI (85) + Marketplace
    ...
    <div class="sdk-cards-grid">
        <div class="sdk-card">
            ...
            <div class="sdk-card-links">
                ...
                <a href="https://github.com/gositeme/alfred-node-sdk"><i class="fab fa-github"></i> GitHub</a>
            </div>
        </div>
        ...
        <div class="sdk-card">
            ...
            <div class="sdk-card-links">
                <a href="/docs/api-reference"><i class="fas fa-book"></i> API Docs</a>
                <a href="/docs/getting-started"><i class="fas fa-rocket"></i> Getting Started</a>
                <a href="https://github.com/gositeme/alfred-python-sdk"><i class="fab fa-github"></i> GitHub</a>
            </div>
        </div>
        ...
        <div class="sdk-card">
            ...
            <div class="sdk-card-links">
                <a href="/docs/api-reference"><i class="fas fa-book"></i> API Docs</a>
                <a href="/docs/getting-started"><i class="fas fa-rocket"></i> Getting Started</a>
                <a href="https://github.com/gositeme/alfred-php-sdk"><i class="fab fa-github"></i> GitHub</a>
            </div>
        </div>
    </div>
</section>
