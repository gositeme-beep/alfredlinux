...
<div class="inner">
	...
	<div id="portfolio_filter_wrapper" class="masonry gallery three_cols portfolio-content section content clearfix wide" data-columns="3" data-gutter="0" data-filter="<?php echo esc_attr($filter); ?>" data-next-action="photography_portfolio_grid" data-type="masonry" data-layout="wide" data-page-id="<?php echo esc_attr($current_page_id); ?>">
	...
	<div class="element grid classic3_cols masonry <?php echo esc_attr(photography_get_hover_effect('portfolio')); ?> <?php echo esc_attr($portfolio_item_set); ?>" data-type="<?php echo esc_attr($portfolio_item_set); ?>">
		...
		<div class="one_third gallery3 static filterable gallery_type animated<?php echo esc_attr($key+1); ?> portfolio_type <?php echo esc_attr($tg_portfolio_grid_info_style); ?>" data-id="post-<?php echo esc_attr($key+1); ?>">
			<?php 
			...
			?>		
				<?php
						...
						case 'External Link':
							$portfolio_link_url = get_post_meta($portfolio_ID, 'portfolio_link_url', true);
					?>
					<a <?php echo photography_portfolio_link_target(); ?> href="<?php echo esc_url($portfolio_link_url); ?>" <?php echo photography_get_progressive_attr($image_id, $small_image_url[0], $mobile_image_url[0], true); ?>>
						<img src="<?php echo esc_url(photography_get_progressive_preview_image($image_id, 'photography-gallery-masonry')); ?>" alt="<?php echo esc_attr(get_the_title()); ?>" class="preview"/>
					...
					<a data-rel="photography_portfolio_<?php echo esc_attr($current_page_id); ?>"  href="<?php echo esc_url($portfolio_mp4_url); ?>" data-src="<?php echo esc_url($portfolio_mp4_url); ?>" <?php echo photography_get_portfolio_lightbox_caption_attr(get_the_title(), $poster_image_url[0]); ?> <?php echo photography_get_progressive_attr($image_id, $small_image_url[0], $mobile_image_url[0], true, 'lightbox_vimeo'); ?>>
						<img src="<?php echo esc_url(photography_get_progressive_preview_image($image_id, 'photography-gallery-masonry')); ?>" alt="<?php echo esc_attr(get_the_title()); ?>" data-options="width:900, height:506" class="preview" />
						<div id="portfolio_desc_<?php echo esc_attr($portfolio_ID); ?>" class="portfolio_title">
        					<div class="table">
        						<div class="cell">
						            <h5><?php echo get_the_title(); ?></h5>
