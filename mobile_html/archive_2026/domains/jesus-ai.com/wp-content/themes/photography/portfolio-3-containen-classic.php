...
<div class="inner">
	...
	<div id="portfolio_filter_wrapper" class="masonry gallery three_cols portfolio-content section content clearfix" data-columns="3" data-gutter="30" data-filter="<?php echo esc_attr($filter); ?>" data-next-action="photography_portfolio_classic" data-type="grid" data-layout="contain" data-page-id="<?php echo esc_attr($current_page_id); ?>">
