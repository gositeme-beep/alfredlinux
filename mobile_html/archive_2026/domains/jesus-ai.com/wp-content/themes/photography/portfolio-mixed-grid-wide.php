<?php
/**
 * Template Name: Portfolio Mixed Grid Wide
...
<div class="inner">
	...
	<div id="portfolio_filter_wrapper" class="portfolio_mixed_filter_wrapper gallery three_cols mixed_grid wide portfolio-content section content clearfix" data-columns="3" data-gutter="0" data-filter="<?php echo esc_attr($filter); ?>" data-next-action="photography_portfolio_mixed_grid" data-type="grid" data-layout="wide" data-page-id="<?php echo esc_attr($current_page_id); ?>">
