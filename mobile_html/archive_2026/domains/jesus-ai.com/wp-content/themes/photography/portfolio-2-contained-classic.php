...
<div class="inner">
	...
	<div id="portfolio_filter_wrapper" class="masonry gallery two_cols portfolio-content section content clearfix" data-columns="2" data-gutter="30" data-filter="<?php echo esc_attr($filter); ?>" data-next-action="photography_portfolio_classic" data-type="grid" data-layout="contain" data-page-id="<?php echo esc_attr($current_page_id); ?>">
	...
	<?php
		...
		if (have_posts()) : while (have_posts()) : the_post();
			...
			if(has_post_thumbnail($portfolio_ID, 'large'))
			{
			    ...
			    $mobile_image_url = wp_get_attachment_image_src($image_id, 'photography-gallery-grid', true);
	...
	?>
	<div class="element grid classic2_cols masonry <?php echo esc_attr(photography_get_hover_effect('portfolio')); ?> <?php echo esc_attr($portfolio_item_set); ?>" data-type="<?php echo esc_attr($portfolio_item_set); ?>">
	
		<div class="one_half gallery2 classic static filterable gallery_type animated<?php echo esc_attr($key+1); ?> <?php echo esc_attr($tg_portfolio_grid_info_style); ?>" data-id="post-<?php echo esc_attr($key+1); ?>">
		<?php 
