...
require_once WF301_PLUGIN_DIR . 'interface/tab_scanner.php';
...
require_once WF301_PLUGIN_DIR . 'libs/linkhero.php';
...
class WF301
{
    ...
    static function init()
    {
        ...
        if (is_admin()) {
            ...
            add_filter('install_plugins_table_api_args_featured', array('WF301_admin', 'featured_plugins_tab'));
