...
namespace AIOSEO\Plugin\Addon\LocalBusiness {
	...
	final class LocalBusiness {
		...
		public function registerStyles() {
			aioseoLocalBusiness()->assets->registerCss( 'business-info.css', [], 'src/assets/scss/business-info.scss' );
			aioseoLocalBusiness()->assets->registerCss( 'opening-hours.css', [], 'src/assets/scss/opening-hours.scss' );
		}
