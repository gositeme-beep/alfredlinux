...
class Aiomatic_Query {
    ...
    public function __construct( $prompt = '', $maxTokens = 16, $model = 'text-davinci-003', $temperature = 0.8, $stop = null, $env = '', $mode = 'completion', $apiKey = null, $session = null, $maxResults = 1, $image_size = '512x512' ) {
        $this->prompt = $prompt;
