...
module.exports = async (port, host, argv) => {
    try {
        ...
        await load(require('@theia/ai-claude-code/lib/node/claude-code-backend-module'));
        await load(require('@theia/ai-code-completion/lib/node/ai-code-completion-backend-module'));
        await load(require('@theia/ai-openai/lib/node/openai-backend-module'));
        await load(require('@theia/ai-codex/lib/node/codex-backend-module'));
        await load(require('@theia/ai-copilot/lib/node/copilot-backend-module'));
        ...
        await load(require('@theia/ai-ide/lib/node/backend-module'));
        await load(require('@theia/ai-llamafile/lib/node/llamafile-backend-module'));
        await load(require('@theia/ai-mcp-server/lib/node/mcp-backend-module'));
        ...
        await load(require('@theia/ai-scanoss/lib/node/ai-scanoss-backend-module'));
        await load(require('@theia/ai-terminal/lib/node/ai-terminal-backend-module'));
        await load(require('@theia/ai-vercel-ai/lib/node/vercel-ai-backend-module'));
        await load(require('@theia/collaboration/lib/node/collaboration-backend-module'));
        ...
        await load(require('@theia/getting-started/lib/node/getting-started-backend-module'));
