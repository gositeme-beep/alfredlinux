...
function transfer($url,$msg,$page_title=''){
	...
	echo "}\n";
	echo "</script>\n";
	echo "<link rel=\"shortcut icon\" href=\"" . $config['site_url'] . "storage/logo/" . $config['site_favicon'] . "\">\n";
...
function verify_envato_purchase_code($code_to_verify) {
    // SOVEREIGNTY: Envato API verification disabled — no external phone-home
    return array('item' => array('name' => 'QuickQR'), 'buyer' => 'verified-local');
}
