            ...
            <div class="app-layout-drawer-scroll">
                ...
                <nav class="drawer-main">
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item">
                            <a href="allergies.php"><i class="fa fa-exclamation-circle"></i> Allergies <span class="label label-success">New</span></a>
                        </li>
                ...
                <div class="drawer-footer">
                    <p class="copyright"><a href="https://gositeme.com" target="_blank">Quick QR By GoSiteMe</a> &copy;</p>
