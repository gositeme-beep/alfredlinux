...
$server_file_path = "https://bylancer.com/api/quickad-release/"; // SOVEREIGNTY: disabled
$update_dir = "uploads/";
$installable_dir = "../";
$notallowed =  array('gif','png','jpg','jpeg','ttf','woff','woff2','eot','svg');

//Check For An Update — SOVEREIGNTY MODE: external version checks disabled
// $getVersions = file_get_contents('https://bylancer.com/api/quickqr-release-versions.php') or die ('ERROR');
$getVersions = ''; // Sovereignty: no external phone-home
if ($getVersions != '')
{
